...
Namespace My
    ...
    Partial Friend Class MyApplication
        ...
        Protected Overrides Sub OnCreateMainForm()
            ...
            ' Navigate up the directory tree to find CVB.vbproj
            While currentDir IsNot Nothing
                Dim vbprojFile = currentDir.GetFiles("CVB.vbproj")
            ...
            ' Create MainForm with the project file path
            Me.MainForm = New CVB.MainForm(projectFilePath)
        End Sub
