...
Public Class DepthColorizer_Basics : Inherits TaskCVBParent
    Public Sub New()
...
Public Class DepthColorizer_CPP : Inherits TaskCVBParent
    Public Sub New()
        cPtr = Depth_Colorizer_Open()
...
Public Class DepthColorizer_Mean : Inherits TaskCVBParent
