...
Public Class Options
    ...
    Private Sub OKButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OKButton.Click
        'cvbprogram.mainUI.cvbsettingsio.settings.showBatchConsole = showBatchConsole.Checked
        'cvbprogram.mainUI.cvbsettingsio.settings.snap640 = Snap640.Checked
        'cvbprogram.mainUI.cvbsettingsio.settings.snap320 = Snap320.Checked
        'cvbprogram.mainUI.cvbsettingsio.settings.snapCustom = SnapCustom.Checked
