...
Public Class Palette_Basics : Inherits TaskCVBParent
...
Public Class Palette_Color : Inherits TaskCVBParent
...
Public Class Palette_LinearPolar : Inherits TaskCVBParent
...
Public Class Palette_Reduction : Inherits TaskCVBParent
...
Public Class Palette_DrawTest : Inherits TaskCVBParent
...
Public Class Palette_Gradient : Inherits TaskCVBParent
...
Public Class Palette_DepthColorMap : Inherits TaskCVBParent
...
Public Class Palette_RGBDepth : Inherits TaskCVBParent
...
Public Class Palette_Layout2D : Inherits TaskCVBParent
    Public Sub New()
...
Public Class Palette_LeftRightImages : Inherits TaskCVBParent
    Public Sub New()
    ...
    End Sub
End Class
Public Class Palette_TaskColors : Inherits TaskCVBParent
    Dim direction = 1
    Public Sub New()
...
Public Class Palette_Create : Inherits TaskCVBParent
...
Public Class Palette_Variable : Inherits TaskCVBParent
...
Public Class Palette_RandomColorMap : Inherits TaskCVBParent
    Public gradientColorMap As New cv.Mat
...
Public Class Palette_CustomColorMap : Inherits TaskCVBParent
...
Public Class Palette_GrayToColor : Inherits TaskCVBParent
    Public Sub New()
...
Public Class Palette_Bin4Way : Inherits TaskCVBParent
...
Public Class Palette_Random : Inherits TaskCVBParent
    Public colorMap As cv.Mat
    Public Sub New()
...
Public Class Palette_LoadColorMap : Inherits TaskCVBParent
    Public whitebackground As Boolean
...
Public Class Palette_RandomColors : Inherits TaskCVBParent
    Public whitebackground As Boolean
...
Public Class Palette_RandomWithBlack : Inherits TaskCVBParent
    Public whitebackground As Boolean
    Public colorMap As New cv.Mat
    Public Sub New()
        desc = "Apply the different color maps in OpenCV"
