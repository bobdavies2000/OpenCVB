...
Public Class AddWeighted_Accumulate : Inherits TaskCVBParent
...
Public Class AddWeighted_Basics : Inherits TaskCVBParent
...
Public Class AddWeighted_DepthAccumulate : Inherits TaskCVBParent
    Dim options As New Options_AddWeighted
    Public Sub New()
...
Public Class AddWeighted_InfraRed : Inherits TaskCVBParent
    Public Sub New()
...
Public Class AddWeighted_Edges : Inherits TaskCVBParent
...
Public Class AddWeighted_LeftRight : Inherits TaskCVBParent
    Public Sub New()
