Public Class TreeviewForm
    ...
    Public Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        Dim algorithm_ms = New List(Of Single)(myTask.algorithm_ms)
        Static saveCount As Integer
        If myTask.callTrace.Count <> saveCount Or optionsChanged Then
            saveCount = myTask.callTrace.Count
            updateTree(New List(Of String)(myTask.callTrace))
        ...
        For i = 0 To algorithm_ms.Count - 1
            ...
            If i >= myTask.algorithmNames.Count Then Exit For
            Dim str = Format(algorithm_ms(i), "00.0%") + " " + myTask.algorithmNames(i)
            If myTask.displayObjectName.Length > 0 Then
                If str.Contains(myTask.displayObjectName) Then percentStr = str
            End If
            If myTask.algorithmNames(i).Contains("waitingForInput") Then
                saveWaitTime = str + "  <<<<<<<<<< "
            Else
    ...
    Private Sub TreeView1_AfterSelect(sender As Object, e As TreeViewEventArgs) Handles TreeView1.AfterSelect
        ...
        myTask.displayObjectName = split(0)
    End Sub
