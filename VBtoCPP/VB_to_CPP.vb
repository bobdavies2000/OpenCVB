...
Public Class VB_to_CPP
    ...
    Private Sub PrepareCPP_Click(sender As Object, e As EventArgs) Handles PrepareCPP.Click
        ...
        For i = 0 To split.Count - 1
            ...
            line = line.Replace("task.gOptions.FrameHistory.Value", "task->frameHistoryCount")
            line = line.Replace("task.gOptions.PixelDiffThreshold.Value", "task->pixelDiffThreshold")
            line = line.Replace("initRandomRect(", "task->initRandomRect(")
            line = line.Replace("validateRect(", "task->validateRect(")
            line = line.Replace("task.gOptions.UseKalman.Checked", "task->useKalman")
            line = line.Replace("task.gOptions.HistBinSlider.Value", "task->histogramBins")
            ...
            line = line.Replace("task.gOptions.GridSize.value", "task->gridSize")
