...
Namespace VBClasses
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For y = 0 To dst2.Height - 1 Step options.granularity
                For x = 0 To dst2.Width - 1 Step options.granularity
                    ...
                    DrawCircle(dst3, New cv.Point(CInt(x), CInt(y)), tsk.DotSize + 1, color)
                Next
            Next
            ...
            For i = 0 To trainMat.Rows - 1
                ...
                DrawCircle(dst2, pt, tsk.DotSize + 2, color)
                DrawCircle(dst3, pt, tsk.DotSize + 2, color)
            Next
        End Sub
        Public Overloads Sub Dispose() Implements IDisposable.Dispose
            If svm IsNot Nothing Then svm.Dispose()
    ...
    Public Class NR_SVM_ReuseBasics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To svm.points.Count - 1
                ...
                DrawCircle(dst2, svm.points(i), tsk.DotSize, color)
                DrawCircle(dst3, svm.points(i), tsk.DotSize, color)
            Next
        End Sub
    End Class
    ...
    Public Class NR_SVM_ReuseRandom : Inherits TaskParent
        ...
        Public Sub New()
            OptionParent.FindSlider("Granularity").Value = 15
            tsk.drawRect = New cv.Rect(dst2.Cols / 4, dst2.Rows / 4, dst2.Cols / 2, dst2.Rows / 2)
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If tsk.heartBeat Then
                ...
                For i = 0 To svm.options.sampleCount - 1
                    ...
                    DrawCircle(dst2, pt, tsk.DotSize, If(res = 1, cv.Scalar.Blue, cv.Scalar.Green))
                Next
