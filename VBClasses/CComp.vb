...
Namespace VBClasses
    Public Class CComp_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            dst2 = atask.gray.Threshold(options.threshold, 255, cv.ThresholdTypes.BinaryInv) '  + cv.ThresholdTypes.Otsu
    ...
    Public Class NR_CComp_Shapes : Inherits TaskParent
        ...
        Public Sub New()
            Dim filePath As String = atask.homeDir + "Data/Shapes.png"
    ...
    Public Class CComp_Stats : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standaloneTest() Then dst2 = atask.gray.Threshold(options.light, 255, cv.ThresholdTypes.BinaryInv)

            Dim stats As New cv.Mat
            Dim centroidRaw As New cv.Mat
            numberOfLabels = atask.gray.ConnectedComponentsWithStats(dst1, stats, centroidRaw)
            ...
            For i = 0 To Math.Min(256, stats.Rows) - 1
                ...
                index.Add(i)
                colors.Add(atask.vecColors(colors.Count))
