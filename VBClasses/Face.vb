...
Namespace VBClasses
    Public Class NR_Face_Haar_LBP : Inherits TaskParent
        ...
        Public Sub New()
            haarCascade = New cv.CascadeClassifier(tsk.homeDir + "Data/haarcascade_frontalface_default.xml")
            lbpCascade = New cv.CascadeClassifier(tsk.homeDir + "Data/lbpcascade_frontalface.xml")
    ...
    Public Class NR_Face_Haar_Alt : Inherits TaskParent
        Dim haarCascade As cv.CascadeClassifier
        Public Sub New()
            haarCascade = New cv.CascadeClassifier(tsk.homeDir + "Data/haarcascade_frontalface_alt.xml")
