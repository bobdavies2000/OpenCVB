...
Public Class Face_Haar_LBP : Inherits TaskParent
    ...
    Public Sub New()
        haarCascade = New cv.CascadeClassifier(algTask.homeDir + "Data/haarcascade_frontalface_default.xml")
        lbpCascade = New cv.CascadeClassifier(algTask.homeDir + "Data/lbpcascade_frontalface.xml")
...
Public Class Face_Haar_Alt : Inherits TaskParent
    Dim haarCascade As cv.CascadeClassifier
    Public Sub New()
        haarCascade = New cv.CascadeClassifier(algTask.homeDir + "Data/haarcascade_frontalface_alt.xml")
