...
Partial Class OptionsGlobal
    ...
    Private Sub InitializeComponent()
        ...
        ' DotSizeSlider
        ' 
        DotSizeSlider.Location = New Point(230, 196)
        ...
        DotSizeLabel.Size = New Size(0, 30)
        DotSizeLabel.TabIndex = 8
        ' 
        ' Label7
        ' 
        Label7.AutoSize = True
        Label7.Location = New Point(48, 196)
        Label7.Name = "Label7"
        ...
        ' LineWidth
        ' 
        LineWidth.Location = New Point(230, 116)
        ...
        LineThicknessAmount.Location = New Point(780, 116)
        ...
        DebugCheckBox.Text = "DebugCheckbox - taskA.gOptions.DebugChecked - use for testing"
        ...
        CrossHairs.Location = New Point(9, 71)
        ...
        ' DepthGroupBox
        ' 
        DepthGroupBox.Controls.Add(ShowSplash)
