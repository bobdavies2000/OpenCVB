...
Namespace VBClasses
    Public Class Hist3D_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            hCloud.dst2.SetTo(0, taskAlg.noDepthMask)

            hCloud.dst2.CopyTo(dst2, taskAlg.depthmask)
    ...
    Public Class Hist3D_RedColor : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskAlg.redList.oldrclist.Count > 0 Then dst2(taskAlg.oldrcD.rect).SetTo(white, taskAlg.oldrcD.mask)
        End Sub
    End Class
    ...
    Public Class Hist3D_DepthWithMask : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            If standaloneTest() Then
                fore.Run(src)
                depthMask = fore.dst2 Or taskAlg.noDepthMask
            End If
    ...
    Public Class Hist3D_Pixel : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            cv.Cv2.CalcHist({src}, {0, 1, 2}, New cv.Mat, histogram, 3, {bins, bins, bins}, taskAlg.rangesBGR)
    ...
    Public Class Hist3D_PixelCells : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For Each rc In taskAlg.redList.oldrclist
                cv.Cv2.CalcBackProject({src(rc.rect)}, {0, 1, 2}, pixel.histogram, dst2(rc.rect), taskAlg.rangesBGR)
            Next
