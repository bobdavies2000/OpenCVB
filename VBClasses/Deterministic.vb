...
Namespace VBClasses
    ...
    Public Class Deterministic_MotionMask : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Static lastFrame As cv.Mat = taskA.color.Clone
            Dim dst1 = lastFrame.Clone
            src.CopyTo(dst1, taskA.motionRGB.motionMask)
            deter.Run(dst1)
    ...
    Public Class NR_Deterministic_BackProject : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If saveMouseMove <> taskA.mouseMovePoint Then
                saveMouseMove = taskA.mouseMovePoint
                dst1.SetTo(0)
            End If
            ...
            Dim mm = GetMinMax(taskA.gray, deter.dst3)
