...
Namespace VBClasses
    ...
    Public Class NR_LUT_Sliders : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Dim gray = If(src.Channels() = 1, src, tsk.gray)
    ...
    Public Class NR_LUT_RGBDepth : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            lut.Run(tsk.depthRGB.CvtColor(cv.ColorConversionCodes.BGR2GRAY))
    ...
    Public Class NR_LUT_Depth32f : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            lut.Run(tsk.pcSplit(2).Normalize(255).ConvertScaleAbs(255))
            dst2 = lut.dst2 * 255 / lut.classCount
    ...
    Public Class NR_LUT_Custom : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If tsk.optionsChanged Or tsk.heartBeat Then
