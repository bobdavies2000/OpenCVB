...
Namespace VBClasses
    Public Class Binarize_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Else
                dst2 = tsk.gray.Threshold(meanScalar(0), 255, thresholdType)
            End If
        End Sub
    End Class
    ...
    Public Class NR_Binarize_OTSU : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            binarize.meanScalar = cv.Cv2.Mean(tsk.gray)
    ...
    Public Class NR_Binarize_Niblack_Sauvola : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            options.Run()
            CvXImgProc.NiblackThreshold(tsk.gray, dst0, 255, cv.ThresholdTypes.Binary, 5, 0.5, LocalBinarizationMethods.Niblack)
            dst2 = dst0.CvtColor(cv.ColorConversionCodes.GRAY2BGR)
            CvXImgProc.NiblackThreshold(tsk.gray, dst0, 255, cv.ThresholdTypes.Binary, 5, 0.5, LocalBinarizationMethods.Sauvola)
    ...
    Public Class NR_Binarize_Wolf_Nick : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            CvXImgProc.NiblackThreshold(tsk.gray, dst2, 255, cv.ThresholdTypes.Binary, 5, 0.5, LocalBinarizationMethods.Wolf)
            CvXImgProc.NiblackThreshold(tsk.gray, dst3, 255, cv.ThresholdTypes.Binary, 5, 0.5, LocalBinarizationMethods.Nick)
        End Sub
    End Class
    ...
    Public Class Binarize_Simple : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            meanScalar = cv.Cv2.Mean(tsk.gray)
