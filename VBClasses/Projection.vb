...
Namespace VBClasses
    Public Class Projection_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            If standalone Then
                ...
                redCellInput = taskAlg.redList.oldrclist
            End If
            ...
            If taskAlg.heartBeat Then
                ...
                Dim depthCount = taskAlg.pcSplit(2).CountNonZero
            ...
            If showRectangles Then
                For i = 0 To oldrclist.Count - 1
                    dst2.Rectangle(oldrclist(i).rect, taskAlg.highlight, taskAlg.lineWidth)
                Next
            End If
    ...
    Public Class Projection_ObjectIsolate : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If options.index < top.objects.objectList.Count Then
                ...
                dst0 = taskAlg.pointCloud.InRange(lower, upper)

                dst1.SetTo(0)
                taskAlg.pointCloud.CopyTo(dst1, dst0)
                side.Run(dst1)
    ...
    Public Class Projection_Object : Inherits TaskParent
        ...
        Public Sub New()
            taskAlg.gOptions.DebugSlider.Value = 0 ' pick the biggest object...
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Dim index = taskAlg.gOptions.DebugSlider.Value
            If index < top.objects.objectList.Count Then
                ...
                Dim mask = taskAlg.pointCloud.InRange(lower, upper)

                Dim rc = top.objects.oldrclist(taskAlg.gOptions.DebugSlider.Value + 1) ' the biggest by default...
                dst0.SetTo(0)
                ...
                dst1.SetTo(0)
                taskAlg.pointCloud.CopyTo(dst1, mask)
                side.Run(dst1)
                dst2 = side.dst2
                labels(2) = side.labels(2)
            End If
    ...
    Public Class Projection_Cell : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            dst0.SetTo(0)
            taskAlg.pointCloud(rc.rect).CopyTo(dst0(rc.rect), rc.mask)
    ...
    Public Class Projection_Derivative : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            heat.Run(taskAlg.pointCloud)
            dst2 = heat.dst2
            dst3 = heat.dst3
            labels(2) = heat.labels(2)
            labels(3) = heat.labels(3)

            Dim pc As New cv.Mat(taskAlg.pointCloud.Size, cv.MatType.CV_32FC3, 0)
            taskAlg.pointCloud.CopyTo(pc, dst1)
    ...
    Public Class Projection_ViewTop : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            objects.redCellInput = taskAlg.redList.oldrclist
            objects.dst2 = taskAlg.redList.dst2
            objects.labels(2) = taskAlg.redList.labels(2)
    ...
    Public Class Projection_HistSide : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            cv.Cv2.CalcHist({src}, taskAlg.channelsSide, New cv.Mat, histogram, 2, taskAlg.bins2D, taskAlg.rangesSide)
    ...
    Public Class Projection_HistTop : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            If src.Type <> cv.MatType.CV_32FC3 Then src = taskAlg.pointCloud
            cv.Cv2.CalcHist({src}, taskAlg.channelsTop, New cv.Mat, histogram, 2, taskAlg.bins2D, taskAlg.rangesTop)
