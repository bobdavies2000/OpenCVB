...
Namespace VBClasses
    ...
    Public Class ImageOffset_SliceH : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standalone And algTask.mouseMovePoint.X = 0 And algTask.mouseMovePoint.Y = 0 Then
            ...
            For i = 0 To 2
                ...
                plot.minY = Choose(i + 1, -algTask.xRange, -algTask.yRange, 0)
                plot.maxY = Choose(i + 1, algTask.xRange, algTask.yRange, algTask.MaxZmeters)
                plot.Run(src)
            ...
            algTask.color.Line(p1, p2, algTask.highlight, algTask.lineWidth)
