...
Namespace VBClasses
    ...
    Public Class ImageOffset_SliceH : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standalone And taskAlg.mouseMovePoint.X = 0 And taskAlg.mouseMovePoint.Y = 0 Then
            ...
            For i = 0 To 2
                ...
                plot.minY = Choose(i + 1, -taskAlg.xRange, -taskAlg.yRange, 0)
                plot.maxY = Choose(i + 1, taskAlg.xRange, taskAlg.yRange, taskAlg.MaxZmeters)
                plot.Run(src)
            ...
            taskAlg.color.Line(p1, p2, taskAlg.highlight, taskAlg.lineWidth)
