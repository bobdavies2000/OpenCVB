...
Namespace VBClasses
    Public Class Hough_Basics : Inherits TaskParent
        ...
        Public Shared Sub houghShowLines(dst As cv.Mat, segments() As cv.LineSegmentPolar, desiredCount As Integer)
            For i = 0 To Math.Min(segments.Length, desiredCount) - 1
                ...
                dst.Line(pt1, pt2, cv.Scalar.Red, atask.lineWidth + 1, atask.lineType, 0)
            Next
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standaloneTest() Then
                ...
                For i = 0 To Math.Min(probSegments.Length, options.lineCount) - 1
                    ...
                    dst3.Line(line.P1, line.P2, cv.Scalar.Red, atask.lineWidth + 2, atask.lineType)
                Next
    ...
    Public Class NR_Hough_Sudoku : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            dst2 = cv.Cv2.ImRead(atask.homeDir + "opencv/Samples/Data/sudoku.png").Resize(dst2.Size)
            dst3 = dst2.Clone
            hough.Run(dst2)
    ...
    Public Class NR_Hough_Circles : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To cFound.Length - 1
                ...
                dst3.Circle(pt, cFound(i).Radius, foundColor, 5, atask.lineType)
            Next
    ...
    Public Class Hough_Featureless : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            ReDim noDepthCount(atask.gridRects.Count - 1)
            ReDim roiColor(atask.gridRects.Count - 1)
            ...
            labels(3) = "Of the " + CStr(atask.gridRects.Count) + " grid elements, " + CStr(regionCount) + " had no edge or hough features present"
        End Sub
    End Class
    ...
    Public Class Hough_LaneFinder : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If atask.optionsChanged Then
                ...
                mask.FillConvexPoly(pList, white, atask.lineType)
            End If
            dst1 = mask.Clone
            ...
            For i = 0 To segments.Length - 1
                ...
                vbc.DrawLine(dst3, segments(i).P1, segments(i).P2, atask.highlight)
            Next
        End Sub
    End Class
