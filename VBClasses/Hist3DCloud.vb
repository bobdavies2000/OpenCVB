...
Namespace VBClasses
    Public Class Hist3Dcloud_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            cv.Cv2.CalcHist({src}, {0, 1, 2}, maskInput, histogram, 3, {bins, bins, bins}, taskAlg.rangesCloud)
            ...
            cv.Cv2.CalcBackProject({src}, {2}, histogram, dst2,
                                   {taskAlg.rangesCloud(taskAlg.rangesCloud.Count - 1)})
    ...
    Public Class Hist3Dcloud_DepthSplit : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            For i = 0 To 2
                hist(i).Run(taskAlg.pcSplit(i))
                mats1.mat(i) = hist(i).dst2.Clone

                If i = 0 Then taskAlg.channels = {0, 1}
                If i = 1 Then taskAlg.channels = {0, 2}
                If i = 2 Then taskAlg.channels = {1, 2}
                hist2d(i).Run(taskAlg.pointCloud)
    ...
    Public Class Hist3Dcloud_Highlights : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskAlg.heartBeat Then maskval += 1
