...
Namespace VBClasses
    Public Class Erode_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standaloneTest() Then
                dst3 = taskAlg.depthRGB.Erode(options.element, Nothing, options.iterations)
    ...
    Public Class Erode_DepthSeed : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            cv.Cv2.Erode(taskAlg.pcSplit(2), dst0, erode.options.element)
            dst0 = taskAlg.pcSplit(2) - dst0
            dst3 = dst0.LessThan(options.flatDepth).ToMat
            dst1 = taskAlg.pcSplit(2).GreaterThan(0).ToMat
            dst1.SetTo(0, taskAlg.pcSplit(2).GreaterThan(taskAlg.MaxZmeters))
            dst3 = dst3 And dst1
            dst2.SetTo(0)
            taskAlg.depthRGB.CopyTo(dst2, dst3)
        End Sub
    End Class
