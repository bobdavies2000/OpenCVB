...
Namespace VBClasses
    Public Class BlurMotion_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If options.showDirection Then dst2.Line(pt1, pt2, cv.Scalar.Yellow, taskAlg.lineWidth + 3, taskAlg.lineType)
        End Sub
    End Class
    ...
    Public Class BlurMotion_Deblur : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskAlg.heartBeat Then mblur.options.redoCheckBox.Checked = True
