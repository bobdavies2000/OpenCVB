...
Namespace VBClasses
    Public Class Quadrant_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            dst1.SetTo(0)
            dst1.Line(taskAlg.lineGravity.p1, taskAlg.lineGravity.p2, 255, 1, cv.LineTypes.Link8)
            dst1.Line(taskAlg.lineHorizon.p1, taskAlg.lineHorizon.p2, 255, 1, cv.LineTypes.Link8)
