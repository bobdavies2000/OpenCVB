...
Namespace VBClasses
    Public Class SLR_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If algTask.firstPass And standalone Then
    ...
    Public Class SLR_PlotTest : Inherits TaskParent
        ...
        Public Sub getData(ByRef x As List(Of Double), ByRef y As List(Of Double))
            Dim filePath As String = algTask.homeDir + "/Data/real_data.txt"
    ...
    Public Class SLR_Trends : Inherits TaskParent
        ...
        Public Sub connectLine(i As Integer, dst As cv.Mat)
            ...
            dst.Line(lastPoint, p1, cv.Scalar.Yellow, algTask.lineWidth + 1, algTask.lineType)
            lastPoint = p1
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
