...
Namespace VBClasses
    Public Class Bin3Way_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            mats.mat(0) = tsk.gray.InRange(0, firstThird - 1)         ' darkest
            mats.mat(1) = tsk.gray.InRange(lastThird, 255)            ' lightest
            mats.mat(2) = tsk.gray.InRange(firstThird, lastThird - 1) ' other
