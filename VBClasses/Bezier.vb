...
Namespace VBClasses
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To points.Count - 4 Step 3
                For j = 0 To 100
                    ...
                    If j > 0 Then dst2.Line(p1, p2, taskA.highlight, taskA.lineWidth, taskA.lineWidth)
                    p1 = p2
                Next
            Next
    ...
    Public Class NR_Bezier_Example : Inherits TaskParent
        ...
        Public points() As cv.Point = {New cv.Point(taskA.DotSize, taskA.DotSize), New cv.Point(dst2.Width / 6, dst2.Width / 6),
                                   New cv.Point(dst2.Width * 3 / 4, dst2.Height / 2),
                                   New cv.Point(dst2.Width - taskA.DotSize * 2, dst2.Height - taskA.DotSize * 2)}
        Public Sub New()
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To 100 - 1
                ...
                If i > 0 Then dst2.Line(p1, p2, taskA.highlight, taskA.lineWidth, taskA.lineWidth)
                p1 = p2
            Next

            For i = 0 To points.Count - 1
                DrawCircle(dst2, points(i), taskA.DotSize + 2, white)
            Next

            dst2.Line(points(0), points(1), white, taskA.lineWidth, taskA.lineWidth)
            dst2.Line(points(2), points(3), white, taskA.lineWidth, taskA.lineWidth)
        End Sub
    End Class
End Namespace