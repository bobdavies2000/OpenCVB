...
Namespace VBClasses
    ...
    Public Class NR_FLANN_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If options.reuseData = False Or taskA.frameCount < 2 Or taskA.mouseClickFlag Then random.Run(src) ' fill result1 with random points in x and y range of the image.
            ...
            For i = 0 To features.Rows - 1
                ...
                DrawCircle(dst2, pt, taskA.DotSize, cv.Scalar.Blue)
            Next

            If options.reuseData = False Or taskA.optionsChanged Or taskA.mouseClickFlag Then
            ...
            Using nnIndex As New cv.Flann.Index(features, New cv.Flann.KDTreeIndexParams(matchCount))
                ...
                For i = 0 To options.queryCount - 1
                    ...
                    For j = 0 To matchCount - 1
                        ...
                        End If
                    Next
                    DrawCircle(dst2, pt1, taskA.DotSize, cv.Scalar.Red)
                Next
            End Using
