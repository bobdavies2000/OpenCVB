    ...
    Public Class ContourPlane_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For Each contour In taskAlg.contours.contourList
                Dim depth = taskAlg.pcSplit(2)(contour.rect).Mean(contour.mask)
