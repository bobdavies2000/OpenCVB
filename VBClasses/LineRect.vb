...
Namespace VBClasses
    Public Class LineRect_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standalone And taskAlg.heartBeat Then
                dst2.SetTo(0)
    ...
    Public Class LineRect_CenterNeighbor : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For Each lp In taskAlg.lines.lpList
                ...
                Dim index As Integer = taskAlg.gridMap.Get(Of Integer)(center.Y, center.X)
                Dim nabeList = taskAlg.grid.gridNeighbors(index)
                Dim foundObjectLine As Boolean = False
                For i = 1 To nabeList.Count - 1
                    Dim brick1 = taskAlg.bricks.brickList(nabeList(i))
                    If brick1.depth = 0 Then Continue For
                    For j = i + 1 To nabeList.Count - 1
                        Dim brick2 = taskAlg.bricks.brickList(nabeList(j))
