...
Namespace VBClasses
    Public Class Puzzle_Basics : Inherits TaskParent
        ...
        End Sub
        Shared Function Shuffle(Of T)(collection As IEnumerable(Of T)) As List(Of T)
            Dim r As New Random()
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To scrambled.Count - 1
                ...
                Dim gr2 = scrambled(i)
                If gRect.Width = task.gridWH And gRect.Height = task.gridWH And
                           gr2.Width = task.gridWH And gr2.Height = task.gridWH Then dst2(gr2) = src(gRect)
            Next
        End Sub
    End Class
    ...
    Public Class XR_Puzzle_SolverDynamic : Inherits TaskParent
