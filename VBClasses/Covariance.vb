...
Namespace VBClasses
    Public Class Covariance_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standaloneTest() Then
                ...
                dst3.Circle(lastCenter, 5, taskAlg.highlight, taskAlg.lineWidth + 1, taskAlg.lineType)
                dst3.Line(center, lastCenter, cv.Scalar.Red, taskAlg.lineWidth + 1, taskAlg.lineType)
                lastCenter = center
    ...
    Public Class Covariance_Images : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            If taskAlg.optionsChanged Then taskAlg.gray.ConvertTo(last32f, cv.MatType.CV_32F)
            dst2 = taskAlg.gray
