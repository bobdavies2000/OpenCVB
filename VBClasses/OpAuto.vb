...
Namespace VBClasses
    ...
    Public Class OpAuto_Peaks2D : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standaloneTest() Then
                heatmap.Run(src)
                dst2 = If(taskAlg.toggleOn, heatmap.dst2, heatmap.dst3)
                src = If(taskAlg.toggleOn, heatmap.dst0.Clone, heatmap.dst1.Clone)
            End If
            ...
            For i = 0 To clusterPoints.Count - 1
                ...
                DrawCircle(dst2, pt, taskAlg.DotSize * 3, white)
            Next
        End Sub
    End Class
