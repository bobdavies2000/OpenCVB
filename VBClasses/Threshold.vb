...
Public Class Threshold_OTSUBad : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        If rc IsNot Nothing Then
            ...
            Dim median As Double = Threshold(tmp, rc.mask, 0, 255, ThresholdTypes.Otsu)
            labels(3) = median.ToString(fmt3) + " separates the cell into 2 regions based on depth."
        End If
    End Sub
End Class
...
Public Class Threshold_KMeans : Inherits TaskParent
    Dim redC As New RedC_Basics
