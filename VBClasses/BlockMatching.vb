...
Namespace VBClasses
    Public Class BlockMatching_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            blockMatch.ROI1 = New cv.Rect(0, 0, taskAlg.leftView.Width, taskAlg.leftView.Height)
            blockMatch.ROI2 = New cv.Rect(0, 0, taskAlg.leftView.Width, taskAlg.leftView.Height)
            ...
            dst3 = taskAlg.rightView.Resize(src.Size())
        End Sub
        Public Sub Close()
