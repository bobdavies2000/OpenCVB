...
Namespace VBClasses
    Public Class BlockMatching_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            blockMatch.ROI1 = New cv.Rect(0, 0, tsk.leftView.Width, tsk.leftView.Height)
            blockMatch.ROI2 = New cv.Rect(0, 0, tsk.leftView.Width, tsk.leftView.Height)
            ...
            dst3 = tsk.rightView.Resize(src.Size())
        End Sub
