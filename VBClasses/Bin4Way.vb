...
Namespace VBClasses
    Public Class Bin4Way_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            Static index As Integer = taskAlg.gridMap.Get(Of Integer)(taskAlg.clickPoint.Y, taskAlg.clickPoint.X)
            index = taskAlg.gridMap.Get(Of Integer)(taskAlg.clickPoint.Y, taskAlg.clickPoint.X)
            Dim roiSave = If(index < taskAlg.gridRects.Count, taskAlg.gridRects(index), New cv.Rect)

            If taskAlg.optionsChanged Then index = 0
            ...
            Dim counts(3, taskAlg.gridRects.Count) As Integer
            ...
            For i = 0 To counts.GetUpperBound(0)
                For j = 0 To taskAlg.gridRects.Count - 1
                    Dim roi = taskAlg.gridRects(j)
                    ...
                    means(j).Add(taskAlg.gray(roi).Mean(tmp)(0))
            ...
            Dim bump = 3
            Dim ratio = dst2.Height / taskAlg.gridRects(0).Height
            For i = 0 To matList.Count - 1
            ...
            dst1.Rectangle(roiSave, white, taskAlg.lineWidth)
            taskAlg.color.Rectangle(roiSave, white, taskAlg.lineWidth)
        End Sub
    End Class
    ...
    Public Class Bin4Way_Unstable1 : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            dst3 = diff.dst2
            If taskAlg.heartBeat Then labels(3) = "There are " + CStr(dst3.CountNonZero) + " unstable pixels"
        End Sub
    End Class
    ...
    Public Class Bin4Way_UnstableEdges : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskAlg.gOptions.DebugCheckBox.Checked = False Then dst3.SetTo(0, dst1)
        End Sub
    End Class
    ...
    Public Class Bin4Way_UnstablePixels : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To pts.Count - 1 Step 2
                Dim val = taskAlg.gray.Get(Of Byte)(pts(i + 1), pts(i))
            ...
            If taskAlg.heartBeat Then labels(3) = "There are " + CStr(dst2.CountNonZero) + " unstable pixels"
        End Sub
    End Class
    ...
    Public Class Bin4Way_SplitValley : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskAlg.heartBeat Then valley.Run(taskAlg.gray)

            mats.mat(0) = taskAlg.gray.InRange(0, valley.valleys(1) - 1)
            mats.mat(1) = taskAlg.gray.InRange(valley.valleys(1), valley.valleys(2) - 1)
            mats.mat(2) = taskAlg.gray.InRange(valley.valleys(2), valley.valleys(3) - 1)
            mats.mat(3) = taskAlg.gray.InRange(valley.valleys(3), 255)
    ...
    Public Class Bin4Way_SplitGaps : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = Math.Min(mats.mat.Count, unstable.gapValues.Count) - 1 To 0 Step -1
                mats.mat(i) = taskAlg.gray.InRange(unstable.gapValues(i), lastVal)
            ...
            dst2 = mats.dst2
            dst3 = mats.dst3
            If taskAlg.heartBeat Then labels(1) = "There are " + CStr(dst1.CountNonZero) + " unstable pixels"
        End Sub
    End Class
    ...
    Public Class Bin4Way_RegionsLeftRight : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            binaryRight.Run(taskAlg.rightView)
    ...
    Public Class Bin4Way_Regions1 : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Dim topColor = cv.Cv2.Mean(taskAlg.gray, mask)(0)
            Dim botColor = cv.Cv2.Mean(taskAlg.gray, Not mask)(0)
            mats.mat(0) = taskAlg.gray.InRange(0, botColor)
            mats.mat(1) = taskAlg.gray.InRange(botColor, midColor)
            mats.mat(2) = taskAlg.gray.InRange(midColor, topColor)
            mats.mat(3) = taskAlg.gray.InRange(topColor, 255)
    ...
    Public Class Bin4Way_BasicsRed : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To quartiles.Count - 1
                ...
                dst3.Line(New cv.Point(offset, 0), New cv.Point(offset, dst3.Height), white, taskAlg.lineWidth, taskAlg.lineWidth)
            Next

            mats.mat(0) = taskAlg.gray.InRange(0, quartiles(0) - 1)
            mats.mat(1) = taskAlg.gray.InRange(quartiles(0), quartiles(1) - 1)
            mats.mat(2) = taskAlg.gray.InRange(quartiles(1), quartiles(2) - 1)
            mats.mat(3) = taskAlg.gray.InRange(quartiles(2), 255)
    ...
    Public Class Bin4Way_SplitMean : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskAlg.heartBeat Then
                ...
                topColor = cv.Cv2.Mean(taskAlg.gray, mask)(0)
                botColor = cv.Cv2.Mean(taskAlg.gray, Not mask)(0)
            End If
