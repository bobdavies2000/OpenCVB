...
Namespace VBClasses
    Public Class Bin4Way_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            Static index As Integer = taskA.gridMap.Get(Of Integer)(taskA.clickPoint.Y, taskA.clickPoint.X)
            index = taskA.gridMap.Get(Of Integer)(taskA.clickPoint.Y, taskA.clickPoint.X)
            Dim grSave = If(index < taskA.gridRects.Count, taskA.gridRects(index), New cv.Rect)

            If taskA.optionsChanged Then index = 0
            ...
            Dim counts(3, taskA.gridRects.Count) As Integer
            ...
            For i = 0 To counts.GetUpperBound(0)
                For j = 0 To taskA.gridRects.Count - 1
                    ...
                    means(j).Add(taskA.gray(gr).Mean(tmp)(0))
            ...
            Dim bump = 3
            Dim ratio = dst2.Height / taskA.gridRects(0).Height
            For i = 0 To matList.Count - 1
            ...
            dst1.Rectangle(grSave, white, taskA.lineWidth)
            taskA.color.Rectangle(grSave, white, taskA.lineWidth)
        End Sub
    End Class
    ...
    Public Class NR_Bin4Way_Unstable1 : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            dst3 = diff.dst2
            If taskA.heartBeat Then labels(3) = "There are " + CStr(dst3.CountNonZero) + " unstable pixels"
        End Sub
    End Class
    ...
    Public Class Bin4Way_UnstableEdges : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskA.gOptions.DebugCheckBox.Checked = False Then dst3.SetTo(0, dst1)
        End Sub
    End Class
    ...
    Public Class NR_Bin4Way_UnstablePixels : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To pts.Count - 1 Step 2
                Dim val = taskA.gray.Get(Of Byte)(pts(i + 1), pts(i))
            ...
            If taskA.heartBeat Then labels(3) = "There are " + CStr(dst2.CountNonZero) + " unstable pixels"
        End Sub
    End Class
    ...
    Public Class NR_Bin4Way_SplitValley : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskA.heartBeat Then valley.Run(taskA.gray)

            mats.mat(0) = taskA.gray.InRange(0, valley.valleys(1) - 1)
            mats.mat(1) = taskA.gray.InRange(valley.valleys(1), valley.valleys(2) - 1)
            mats.mat(2) = taskA.gray.InRange(valley.valleys(2), valley.valleys(3) - 1)
            mats.mat(3) = taskA.gray.InRange(valley.valleys(3), 255)
    ...
    Public Class NR_Bin4Way_SplitGaps : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = Math.Min(mats.mat.Count, unstable.gapValues.Count) - 1 To 0 Step -1
                mats.mat(i) = taskA.gray.InRange(unstable.gapValues(i), lastVal)
            ...
            dst2 = mats.dst2
            dst3 = mats.dst3
            If taskA.heartBeat Then labels(1) = "There are " + CStr(dst1.CountNonZero) + " unstable pixels"
        End Sub
    End Class
    ...
    Public Class NR_Bin4Way_RegionsLeftRight : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            binaryRight.Run(taskA.rightView)
    ...
    Public Class NR_Bin4Way_Regions1 : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Dim topColor = cv.Cv2.Mean(taskA.gray, mask)(0)
            Dim botColor = cv.Cv2.Mean(taskA.gray, Not mask)(0)
            mats.mat(0) = taskA.gray.InRange(0, botColor)
            mats.mat(1) = taskA.gray.InRange(botColor, midColor)
            mats.mat(2) = taskA.gray.InRange(midColor, topColor)
            mats.mat(3) = taskA.gray.InRange(topColor, 255)
    ...
    Public Class Bin4Way_SplitMean : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskA.heartBeat Then
                ...
                topColor = cv.Cv2.Mean(taskA.gray, mask)(0)
                botColor = cv.Cv2.Mean(taskA.gray, Not mask)(0)
            End If
