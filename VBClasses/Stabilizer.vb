...
Namespace VBClasses
    Public Class Stabilizer_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            Static lpLast As lpData = taskAlg.lineLongest

            Dim lp = taskAlg.lineLongest
            If lp.pE1 = lpLast.pE1 And lp.pE2 = lpLast.pE2 Or taskAlg.lineLongestChanged Then
                dst2 = src
                If taskAlg.lineLongestChanged Then lpLast = taskAlg.lineLongest
            Else
