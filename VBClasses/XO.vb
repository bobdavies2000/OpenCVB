...
Public Class XO_OpenGL_Pyramid : Inherits TaskParent
    Public Sub New()
        task.ogl.oglFunction = Comm.oCase.drawPyramid ' all the work is done inside the switch statement in XO_OpenGL_Functions.
...
Public Class XO_OpenGL_DrawCube : Inherits TaskParent
    Public Sub New()
        task.ogl.oglFunction = Comm.oCase.drawCube
...
Public Class XO_OpenGL_FlatStudy2 : Inherits TaskParent
    ...
    Public Sub New()
        task.ogl.oglFunction = Comm.oCase.drawFloor
...
Public Class XO_OpenGL_FlatStudy3 : Inherits TaskParent
    ...
    Public Sub New()
        task.ogl.oglFunction = Comm.oCase.floorStudy
        labels = {"", "", "", ""}
...
Public Class XO_OpenGL_Sierpinski : Inherits TaskParent
    Public Sub New()
        task.ogl.oglFunction = Comm.oCase.sierpinski
...
Public Class XO_OpenGL_Contours : Inherits TaskParent
    ...
    Public options As New Options_OpenGLFunctions
    Public Sub New()
        task.ogl.oglFunction = Comm.oCase.drawCells
...
Public Class XO_OpenGL_Density2D : Inherits TaskParent
    ...
    Public Sub New()
        ...
        desc = "Create a mask showing which pixels are close to each other and display the task.results.."
    End Sub
    Public Overrides Sub RunAlg(src As cv.Mat)
        dense.Run(src)
        dst2.SetTo(0)
...
Public Class XO_OpenGL_HistDepth3D : Inherits TaskParent
    ...
    Public Sub New()
        task.ogl.oglFunction = Comm.oCase.Histogram3D
...
Public Class XO_OpenGL_Regions : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        task.ogl.oglFunction = Comm.oCase.quadBasics ' only the first case needs something else.
        task.ogl.pointCloudInput = New cv.Mat()
...
Public Class XO_OpenGL_Profile : Inherits TaskParent
    ...
    Public Sub New()
        ...
        ogl.oglFunction = Comm.oCase.pcPointsAlone
...
Public Class XO_OpenGL_ProfileRC : Inherits TaskParent
    ...
    Public Sub New()
        ...
        OptionParent.FindSlider("OpenGL Point Size").Value = 10
        task.ogl.oglFunction = Comm.oCase.pcPointsAlone
...
Public Class XO_OpenGL_PCpoints : Inherits TaskParent
    ...
    Public Sub New()
        task.ogl.oglFunction = Comm.oCase.pcPoints
        OptionParent.FindSlider("OpenGL Point Size").Value = 10
...
Public Class XO_OpenGL_VerticalOrHorizontal : Inherits TaskParent
    ...
    Public Sub New()
        ...
        task.ogl.oglFunction = Comm.oCase.drawLineAndCloud
...
Public Class XO_OpenGL_Tiles : Inherits TaskParent
    ...
    Public Sub New()
        task.ogl.oglFunction = Comm.oCase.drawTiles
...
Public Class XO_OpenGL_QuadBricks : Inherits TaskParent
    ...
    Public Sub New()
        task.ogl.oglFunction = Comm.oCase.minMaxBlocks
...
Public Class XO_FeatureLine_Basics : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        dst2.Line(task.lineGravity.pX1, task.lineGravity.pX2, task.highlight, task.lineWidth, task.lineType)
    End Sub
End Class
...
Public Class XO_TrackLine_BasicsOld : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        Else
            ...
            Dim deltaX1 = Math.Abs(task.gravityIMU.pX1.X - lpInput.pX1.X)
            Dim deltaX2 = Math.Abs(task.gravityIMU.pX2.X - lpInput.pX2.X)
...
Public Class XO_Gravity_Basics1 : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        If stillPresent Then
            ...
            Dim deltaX1 = Math.Abs(task.lineGravity.pX1.X - RGBcandidate.pX1.X)
            Dim deltaX2 = Math.Abs(task.lineGravity.pX2.X - RGBcandidate.pX2.X)
...
Public Class XO_Line_ExtendLineTest : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        If task.heartBeat Then
            ...
            Dim lp = New lpData(p1, p2)
            dst2 = src
            DrawLine(dst2, lp.pX1, lp.pX2, task.highlight)
...
Public Class XO_Line_ExtendAll : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        lpList.Clear()
        For Each lp In task.lines.lpList
            DrawLine(dst3, lp.pX1, lp.pX2, task.highlight)
            lpList.Add(New lpData(lp.pX1, lp.pX2))
        Next
    End Sub
End Class
...
Public Class XO_Line_Intercepts : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        For Each lp In task.lines.lpList
            ...
            If lp.pX1.X = 0 Then leftIntercepts.Add(saveP1.Y, index)
            If lp.pX1.Y = 0 Then topIntercepts.Add(saveP1.X, index)
            If lp.pX1.X = dst2.Width Then rightIntercepts.Add(saveP1.Y, index)
            If lp.pX1.Y = dst2.Height Then botIntercepts.Add(saveP1.X, index)

            If lp.pX2.X = 0 Then leftIntercepts.Add(saveP2.Y, index)
            If lp.pX2.Y = 0 Then topIntercepts.Add(saveP2.X, index)
            If lp.pX2.X = dst2.Width Then rightIntercepts.Add(saveP2.Y, index)
            If lp.pX2.Y = dst2.Height Then botIntercepts.Add(saveP2.X, index)
            index += 1
        Next
...
Public Class XO_Line_GravityToLongest : Inherits TaskParent
    ...
    End Sub
    Public Overrides Sub RunAlg(src As cv.Mat)
        Dim gravityDelta As Single = task.lineGravity.pX1.X - task.lineGravity.pX2.X
...
Public Class XO_Line_RawEPLines : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        For Each lp In tmplist
            Dim x1 = CInt(lp.pX1.X)
            Dim y1 = CInt(lp.pX1.Y)
            Dim x2 = CInt(lp.pX2.X)
            Dim y2 = CInt(lp.pX2.Y)
            For j = lp.index + 1 To tmplist.Count - 1
                If CInt(tmplist(j).pX1.X) <> x1 Then Continue For
                If CInt(tmplist(j).pX1.Y) <> y1 Then Continue For
                If CInt(tmplist(j).pX2.X) <> x2 Then Continue For
                If CInt(tmplist(j).pX2.Y) <> y2 Then Continue For
        ...
        lpList.Clear()
        For Each lp In tmplist
            If removeList.Contains(lp.index) = False Then lpList.Add(New lpData(lp.pX1, lp.pX2))
        Next
...
Public Class XO_MotionCam_MultiLine : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        For Each lpIn In lpLast
            ...
            DrawCircle(dst2, New cv.Point(CInt(lp.pX1.X), CInt(lp.pX1.Y)), white)
            DrawCircle(dst2, New cv.Point(CInt(lp.pX2.X), CInt(lp.pX2.Y)), white)
        Next
...
Public Class XO_MotionCam_SideApproach : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        Dim lpList = task.lines.lpList
        For Each lp In lpList
            If lp.pX1.X = 0 Then left.Add(lp.pX1.Y, lp.index)
            If lp.pX1.Y = 0 Then top.Add(lp.pX1.X, lp.index)
            If lp.pX2.X = 0 Then left.Add(lp.pX2.Y, lp.index)
            If lp.pX2.Y = 0 Then top.Add(lp.pX2.X, lp.index)

            If lp.pX1.X = dst2.Width Then right.Add(lp.pX1.X, lp.index)
            If lp.pX1.Y = dst2.Height Then bottom.Add(lp.pX1.X, lp.index)
            If lp.pX2.X = dst2.Width Then right.Add(lp.pX2.Y, lp.index)
            If lp.pX2.Y = dst2.Height Then bottom.Add(lp.pX2.X, lp.index)
        Next
...
Public Class XO_MotionCam_Measure : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        deltaX1 = vec.pX1.X - vecLast.pX1.x
        deltaY1 = vec.pX1.Y - vecLast.pX1.Y

        deltaX2 = vec.pX2.X - vecLast.pX2.x
        deltaY2 = vec.pX2.Y - vecLast.pX2.Y
