...
Namespace VBClasses
    ...
    Public Class GridRect_Sorted : Inherits TaskParent
        ...
        Public Sub New()
            ...
            desc = "Sort the r's by the sum of their bgr stdev's to find the least volatile regions"
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            options.Run()
    ...
    Public Class NR_GridRect_CorrelationMotion : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            labels(2) = CStr(gather.rects.Count) + " of " + CStr(task.gridRects.Count) + " r's had above average standard deviation."
    ...
    Public Class NR_GridRect_LowStdevCorrelation : Inherits TaskParent
        ...
        Public Sub New()
            desc = "Display the correlation coefficients for r's with low standard deviation."
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            options.Run()
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Else
                ...
                Else
                    ...
                    dst1.SetTo(0)
                    DrawCircle(dst1, r.TopLeft, task.DotSize, task.highlight)
    ...
    Public Class GridRect_Canny : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For Each r In bricks.brickList
                If dst3(r.rect).CountNonZero Then src(r.rect).CopyTo(dst2(r.rect))
            Next
        End Sub
    End Class
