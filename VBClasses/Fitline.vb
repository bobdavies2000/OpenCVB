...
Public Class XR_FitLine_Lines : Inherits TaskParent
    ...
    Public Sub New()
        ...
        labels(3) = "FitLine_BasicsOld_TA contour input - if they overlap, a trendline will be found."
...
Public Class XR_FitLine_Example2D : Inherits TaskParent
...
Public Class XR_FitLine_Grid : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        For Each rect In task.gridRects
            If CountNonZero(dst2(rect)) >= 5 Then
                nZero.Run(dst2(rect))
                ...
                Line(dst3(rect), fitline.lp.p1, fitline.lp.p2, 255, task.lineWidth, task.lineType)
            End If
        Next
    End Sub
End Class
...
Public Class XR_FitLine_Simple : Inherits TaskParent
    Public Sub New()
