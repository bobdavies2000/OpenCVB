...
Namespace VBClasses
    ...
    Public Class NR_FitLine_Lines : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            If Not taskA.heartBeatLT Then Exit Sub
            options.Run()
    ...
    Public Class NR_FitLine_Simple3D : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standalone Then
                ...
                If taskA.firstPass Then OptionParent.FindSlider("Random Pixel Count").Value = 200
                random.Run(src)
                dst2.SetTo(0)
                ptList.Clear()
            ...
            dst2.Circle(center, taskA.DotSize + 2, cv.Scalar.Blue, -1)
        End Sub
    End Class
    ...
    Public Class NR_FitLine_Example2D : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            dst2.Circle(fitLine.center, taskA.DotSize + 2, cv.Scalar.Blue, -1)
        End Sub
    End Class
    ...
    Public Class NR_FitLine_Basics3D : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            If standalone Then
                ...
                ptList.Clear()
                For Each pt In noisyLine.PointList
                    DrawCircle(dst2, New cv.Point2f(pt.X, pt.Y), taskA.DotSize, taskA.highlight)
                    ptList.Add(pt)
                Next
            End If
            ...
            dst2.Circle(New cv.Point2f(line.X1, line.Y1), taskA.DotSize + 2, cv.Scalar.Blue, -1)
        End Sub
    End Class
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For Each rect In taskA.gridRects
                If dst2(rect).CountNonZero >= 5 Then
                    ...
                    dst3(rect).Line(fitline.lp.p1, fitline.lp.p2, 255, taskA.lineWidth, taskA.lineType)
                End If
            Next
        End Sub
    End Class
