...
Public Class Cloud_Spin : Inherits TaskParent
...
Public Class Cloud_Spin2 : Inherits TaskParent
    Dim spin As New Cloud_Spin
...
Public Class Cloud_XRangeTest : Inherits TaskParent
    Dim split2 As New Cloud_ReduceSplit2
    Public Sub New()
...
Public Class Cloud_YRangeTest : Inherits TaskParent
    Dim split2 As New Cloud_ReduceSplit2
    Public Sub New()
