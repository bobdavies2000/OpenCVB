...
Namespace VBClasses
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            If task.optionsChanged Or classifier Is Nothing Then
                ...
                Select Case task.fOptions.Color8USource.Text
                    ...
                    Case "EdgeLine_Basics_TA"
                        If colorMethods(index) Is Nothing Then colorMethods(index) = New EdgeLine_Basics_TA
    ...
    Public Class Color8U_Bricks : Inherits TaskParent
        ...
        Public Sub New()
            ...
            desc = "Attach a color8u class to each r."
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            bricks.run(src)
            dst0 = task.leftView
            ...
            For Each r As brickData In bricks.brickList
                If r.rRect.Width > 0 Then
                    dst2(r.lRect).CopyTo(dst1(r.rRect))
                    r.colorClass = color8u.dst2.Get(Of Byte)
                    count += 1
                End If
            Next
