    ...
    Public Class NR_TextureFlow_Bricks : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To knn.neighbors.Count - 1
                dst3.Line(knn.trainInput(i), knn.trainInput(knn.neighbors(i)(1)), 255, tsk.lineWidth, tsk.lineType)
                dst3.Line(knn.trainInput(i), knn.trainInput(knn.neighbors(i)(2)), 255, tsk.lineWidth, tsk.lineType)
            Next
