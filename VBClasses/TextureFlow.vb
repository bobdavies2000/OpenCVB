    ...
    Public Class TextureFlow_Bricks : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To knn.neighbors.Count - 1
                dst3.Line(knn.trainInput(i), knn.trainInput(knn.neighbors(i)(1)), 255, taskAlg.lineWidth, taskAlg.lineType)
                dst3.Line(knn.trainInput(i), knn.trainInput(knn.neighbors(i)(2)), 255, taskAlg.lineWidth, taskAlg.lineType)
            Next
