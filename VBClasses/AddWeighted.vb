...
Namespace VBClasses
    ...
    Public Class AddWeighted_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standalone Then src2 = taskAlg.depthRGB
    ...
    Public Class AddWeighted_DepthAccumulate : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            cv.Cv2.AccumulateWeighted(taskAlg.pcSplit(2) * 1000, dst2, options.accumWeighted, New cv.Mat)
        End Sub
    End Class
    ...
    Public Class AddWeighted_InfraRed : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            dst2 = ShowAddweighted(dst1, taskAlg.depthRGB, labels(3))
        End Sub
    End Class
    ...
    Public Class AddWeighted_LeftRight : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            dst2 = ShowAddweighted(taskAlg.rightView, taskAlg.leftView, labels(2))
        End Sub
    End Class
End Namespace