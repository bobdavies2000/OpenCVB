...
Namespace VBClasses
    ...
    Public Class AddWeighted_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standalone Then src2 = atask.depthRGB
    ...
    Public Class NR_AddWeighted_DepthAccumulate : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            cv.Cv2.AccumulateWeighted(atask.pcSplit(2) * 1000, dst2, options.accumWeighted, New cv.Mat)
        End Sub
    End Class
    ...
    Public Class NR_AddWeighted_InfraRed : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            dst2 = ShowAddweighted(dst1, atask.depthRGB, labels(3))
        End Sub
    End Class
    ...
    Public Class NR_AddWeighted_LeftRight : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            dst2 = ShowAddweighted(atask.rightView, atask.leftView, labels(2))
        End Sub
    End Class
End Namespace