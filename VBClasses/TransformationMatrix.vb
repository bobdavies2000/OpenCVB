...
Namespace VBClasses
    Public Class TransformationMatrix_Basics : Inherits TaskParent
        ...
        Public Sub New()
            If taskAlg.Settings.cameraName.StartsWith("StereoLabs") Then
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskAlg.transformationMatrix IsNot Nothing Then
                Dim t = taskAlg.transformationMatrix
                ...
                For i = 0 To topLocations.Count - 1
                    ...
                    If pt.X > 0 And pt.X < dst2.Width And pt.Z > 0 And pt.Z < src.Height Then
                        DrawCircle(dst2, New cv.Point(pt.X, pt.Z), taskAlg.DotSize + 2, cv.Scalar.Yellow)
                    End If

                    If pt.Z > 0 And pt.Z < dst2.Width And pt.Y > 0 And pt.Y < src.Height Then
                        DrawCircle(dst3, New cv.Point(pt.Z, pt.Y), taskAlg.DotSize + 2, cv.Scalar.Yellow)
                    End If
                Next
