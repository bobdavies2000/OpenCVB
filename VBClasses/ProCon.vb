...
Namespace VBClasses
    Public Class ProCon_Basics : Inherits TaskParent
        ...
        Public Sub Consumer()
            While 1
                If tsk.MainUI_Algorithm.traceName <> traceName Then Exit While
                If tsk.frameCount < 0 Then Exit While
                SyncLock mutex
                    head = success(head)
    ...
    Public Class NR_ProCon_Variation : Inherits TaskParent
        ...
        Public Sub New()
            ...
            procon.terminateProducer = True ' we don't need a 2 producer tsk.  RunVB below provides the second thread.
