...
Public Class XR_Vector_Magnitude : Inherits TaskParent
    Public Sub New()
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        Dim coordinates As Mat = Mat.FromPixelData(1, 4, MatType.CV_32F, cVector)
        Dim diff_x = coordinates.Col(0) - coordinates.Col(2)
        Dim diff_y = coordinates.Col(1) - coordinates.Col(3)

        ' sqrt((x2 - x1)^2 + (y2 - y1)^2)
        Dim euclidean_distance As New Mat
        ...
        ' abs(x2 - x1) + abs(y2 - y1)
        Dim points1 = coordinates(Range.All(), New Range(0, 2))
        Dim points2 = coordinates(Range.All(), New Range(2, 4))
        Dim other_manhattan_distance As New Mat
