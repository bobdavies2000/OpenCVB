    ...
    Public Overrides sub RunAlg(src As cv.Mat)
        ...
        If options.xmlCheck Then
            ...
            If fileinfo.Exists Then
                FileCopy(CurDir() + "/RetinaDefaultParameters.xml", algTask.homeDir + "data/RetinaDefaultParameters.xml")
                startInfo.FileName = "wordpad.exe"
                startInfo.Arguments = algTask.homeDir + "Data/RetinaDefaultParameters.xml"
        ...
        If saveUseLogSampling <> options.useLogSampling Or samplingFactor <> options.sampleFactor Then
            ...
            If algTask.testAllRunning = False Then cPtr = Retina_Basics_Open(src.Rows, src.Cols, options.useLogSampling, samplingFactor)
        End If
        Dim handleMagno = GCHandle.Alloc(magnoData, GCHandleType.Pinned)
        Dim handleSrc = GCHandle.Alloc(dataSrc, GCHandleType.Pinned)
        Dim imagePtr As IntPtr = 0
        If algTask.testAllRunning = False Then
