...
Namespace VBClasses
    Public Class RedCC_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Static picTag As Integer = taskAlg.mousePicTag
    ...
    Public Class RedCC_BasicsOld : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            rcList = New List(Of rcData)(taskAlg.redColor.rcList)
            rcMap = taskAlg.redColor.rcMap
    ...
    Public Class RedCC_CellHistogram : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            SetTrueText(taskAlg.rcD.displayCell, 1)
