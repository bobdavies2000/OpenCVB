...
Namespace VBClasses
    ...
    Public Class Options_MatchShapes : Inherits OptionParent
        ...
        Public Sub New()
            ...
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("Min Size % of image size", 0, 20, taskAlg.cols * taskAlg.rows / 100)
            End If
        End Sub
        Public Sub Run()
            ...
            maxYdelta = ySlider.Value * taskAlg.rows / 100
            minSize = minSlider.value * taskAlg.cols * taskAlg.rows / 100
            ...
            If taskAlg.optionsChanged Then
                ...
                For i = 0 To frm.check.Count - 1
                    ...
                    If nextRadio.Checked Then
                        Dim photo As New FileInfo(taskAlg.homeDir + "Data\Prokudin\" + nextRadio.Text)
    ...
    Public Class Options_MinMaxNone : Inherits OptionParent
        ...
        End Sub
        Public Sub Run()
            Static frm As Object = FindFrm(traceName + " Radio Buttons")
    ...
    Public Class Options_SymmetricalShapes : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("Radius 1", 1, taskAlg.rows / 2, taskAlg.rows / 4)
                sliders.setupTrackBar("Radius 2", 1, taskAlg.rows / 2, taskAlg.rows / 8)
        ...
        Public Sub Run()
            ...
            If demoCheck.Checked Then
                If taskAlg.frameCount Mod 30 = 0 Then
                    ...
                    fillColor = taskAlg.scalarColors(taskAlg.frameCount Mod 256)
                End If
                If taskAlg.frameCount Mod 37 = 0 Then symCheck.Checked = Not symCheck.Checked
                If taskAlg.frameCount Mod 222 = 0 Then fillCheck.Checked = Not fillCheck.Checked
                If taskAlg.frameCount Mod 77 = 0 Then regularCheck.Checked = Not regularCheck.Checked
                If taskAlg.frameCount Mod 100 = 0 Then reverseCheck.Checked = Not reverseCheck.Checked
                rotateAngle += 1
            End If
    ...
    Public Class Options_DrawArc : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                sliders.setupTrackBar("Clearance from image edge (margin size)", 5, taskAlg.cols / 8, saveMargin * 16)
            End If
    ...
    Public Class Options_KLT : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            If deleteCheck.Checked Or taskAlg.heartBeat Then
    ...
    Public Class Options_FPoly : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            taskAlg.polyCount = pointSlider.Value
    ...
    Public Class Options_Random : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                sliders.setupTrackBar("Random Pixel Count", 1, taskAlg.cols * taskAlg.rows, 20)
            End If
        End Sub
        Public Sub Run()
    ...
    Public Class Options_Warp : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            Dim a(,) As Double = {{1, 0, -taskAlg.cols / 2},
                                {0, 1, -taskAlg.rows / 2},
                                {0, 0, 0},
                                {0, 0, 1}}
            ...
            Dim b(,) As Double = {{f, 0, taskAlg.cols / 2, 0},
                                {0, f, taskAlg.rows / 2, 0},
                                {0, 0, 1, 0}}
    ...
    Public Class Options_Translation : Inherits OptionParent
        ...
        Public Sub New()
            ...
            If taskAlg.settings.cameraName = "Intel(R) RealSense(TM) Depth Camera 435i" Then
                leftShift = 1
                rightShift = 2
            End If
            If sliders.Setup(traceName) Then
        ...
        Public Sub Run()
            ...
            leftTrans = taskAlg.cols * leftSlider.value / 100
            rightTrans = taskAlg.cols * rightSlider.value / 100
        End Sub
    End Class
    ...
    Public Class Options_Intercepts : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            For selectedIntercept = 0 To 3
                mouseMovePoint = Choose(selectedIntercept + 1, taskAlg.mouseMovePoint.X, taskAlg.mouseMovePoint.X, taskAlg.mouseMovePoint.Y, taskAlg.mouseMovePoint.Y)
    ...
    Public Class Options_ForeGround : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            depthPerRegion = taskAlg.MaxZmeters / numberOfRegions
        End Sub
    End Class
    ...
    Public Class Options_Flood : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("Step Size", 1, taskAlg.cols / 2, stepSize)
            End If
            If FindFrm(traceName + " CheckBoxes") Is Nothing Then
                check.Setup(traceName)
        ...
        Public Sub Run()
            ...
            Select Case findRadioText(frm.check)
                ...
                Case "Use Initialized Labels"
                    If taskAlg.optionsChanged Then kMeansFlag = cv.KMeansFlags.PpCenters Else kMeansFlag = cv.KMeansFlags.UseInitialLabels
            End Select
    ...
    Public Class Options_Gif : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            If taskAlg.firstPass Or taskAlg.optionsChanged Then
                frmCheck.Left = taskAlg.gOptions.Width / 2
                frmCheck.top = taskAlg.gOptions.Height / 2
                frmRadio.left = taskAlg.gOptions.Width * 2 / 3
                frmRadio.top = taskAlg.gOptions.Height * 2 / 3
            End If

            If dst0Radio.Checked Then taskAlg.gifCaptureIndex = 0
            If dst1Radio.Checked Then taskAlg.gifCaptureIndex = 1
            If dst2Radio.Checked Then taskAlg.gifCaptureIndex = 2
            If dst3Radio.Checked Then taskAlg.gifCaptureIndex = 3
            If Opencvwindow.Checked Then taskAlg.gifCaptureIndex = 4
            If OpenGLwindow.Checked Then taskAlg.gifCaptureIndex = 5
            If EntireScreen.Checked Then taskAlg.gifCaptureIndex = 6
    ...
    Public Class Options_IMU : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("IMU_Basics: Alpha X100", 0, 100, taskAlg.IMU_AlphaFilter * 100)
        ...
        Public Sub Run()
            ...
            taskAlg.IMU_AlphaFilter = alphaSlider.value / 100
    ...
    Public Class Options_Boundary : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("Distance to next Peak (pixels)", 2, taskAlg.cols / 10, peakDistance)
            End If
        End Sub
        Public Sub Run()
    ...
    Public Class Options_Spectrum : Inherits OptionParent
        ...
        Public Function buildDepthRanges(input As cv.Mat, typeSpec As String)
            ...
            mask.SetTo(0, taskAlg.noDepthMask(rc.rect))
        ...
        End Function
        Public Sub Run()
            If taskAlg.firstPass Then taskAlg.redList.Run(taskAlg.color)
            ...
            If taskAlg.firstPass Then
                frmSliders.Left = taskAlg.gOptions.Width / 2
                frmSliders.top = taskAlg.gOptions.Height / 2
            End If
        End Sub
    End Class
    ...
    Public Class Options_Complexity : Inherits OptionParent
        ...
        Public Sub New()
            Dim fnames = Directory.GetFiles(taskAlg.homeDir + "Complexity")
            filenames = fnames.ToList
            Dim latestFile = Directory.GetFiles(taskAlg.homeDir + "Complexity").OrderByDescending(
        ...
        Public Sub Run()
            ...
            For i = 0 To frm.check.count - 1
                If frm.check(i).checked Then
                    filename = New FileInfo(taskAlg.homeDir + "Complexity/" + frm.check(i).text)
                    plotColor = Choose((i + 1) Mod 4, cv.Scalar.White, cv.Scalar.Red, cv.Scalar.Green, cv.Scalar.Yellow)
                    Exit For
                End If
            Next
            If taskAlg.firstPass Then
                frm.Left = taskAlg.gOptions.Width / 2
                frm.top = taskAlg.gOptions.Height / 2
            End If
        End Sub
    End Class
    ...
    Public Class Options_Classifier : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then sliders.setupTrackBar("Random Samples", 10, taskAlg.cols * taskAlg.rows, sampleCount)
    ...
    Public Class Options_Threshold : Inherits OptionParent
        ...
        End Sub
        Public Sub Run()
            If taskAlg.firstPass Then  ' special case!  Can't run it in constructor or measurements fail...
    ...
    Public Class Options_ThresholdAll : Inherits OptionParent
        ...
        Public Sub Run()
            If taskAlg.firstPass Then  ' special case!  Can't run it in constructor or measurements fail...
                gradient.Run(taskAlg.color.Clone)
                dst2 = gradient.dst2
            End If
    ...
    Public Class Options_DFT : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                sliders.setupTrackBar("DFT B Filter - Radius", 1, taskAlg.rows, radius)
                sliders.setupTrackBar("DFT B Filter - Order", 1, taskAlg.rows, order)
            End If
            If radio.Setup(traceName) Then
    ...
    Public Class Options_OpenGL_Duster : Inherits OptionParent
        ...
        Public Sub New()
            If FindFrm(traceName + " CheckBox Options") Is Nothing Then
                ...
                check.addCheckBox("Use taskAlg.pointCloud")
            End If
        End Sub
        Public Sub Run()
            Static colorCheck = FindCheckBox("Display cluster colors")
            Static cloudCheck = FindCheckBox("Use taskAlg.pointCloud")
    ...
    Public Class Options_AsciiArt : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            hStep = taskAlg.rows \ hSlider.value
            wStep = taskAlg.cols \ wSlider.value
    ...
    Public Class Options_BlurTopo : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            kernelSize = nextPercent \ 100 * taskAlg.cols Or 1
        End Sub
    End Class
    ...
    Public Class Options_BrightnessContrast : Inherits OptionParent
        ...
        Public Sub New()
            ...
            Dim betaDefault = -100
            If taskAlg.settings.cameraName = "Oak-D camera" Then
                alphaDefault = 500
                betaDefault = 0
            End If
            If taskAlg.settings.cameraName = "Intel(R) RealSense(TM) Depth Camera 435i" Then alphaDefault = 1500
            If sliders.Setup(traceName) Then
    ...
    Public Class Options_EmaxInputClusters : Inherits OptionParent
        ...
        Public emaxCellSize As Integer = taskAlg.workRes.Width \ 3
        Public Sub New()
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("EMax Cell Size", 1, taskAlg.workRes.Width, emaxCellSize)
            End If
        End Sub
        Public Sub Run()
    ...
    Public Class Options_BackProject2D : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            If taskAlg.mouseClickFlag Then rowRadio.checked = Not rowRadio.checked
    ...
    Public Class Options_DNN : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            superResModelFileName = taskAlg.homeDir + "Data/DNN_SuperResModels/"
            Static frm = FindFrm(traceName + " Radio Buttons")
            Dim index = findRadioIndex(frm.check)
    ...
    Public Class Options_Edges3 : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("Input pixel difference", 0, 50, If(taskAlg.cols = 640, gapdiff, 20))
            End If
        End Sub
        Public Sub Run()
    ...
    Public Class Options_Images : Inherits OptionParent
        ...
        Public Sub New()
            ...
            dirName = taskAlg.homeDir + "Images/train"
            ...
            fileNameForm.filename.Text = taskAlg.settings.Image_Basics_Name
            If fileNameForm.filename.Text = "" Then fileNameForm.filename.Text = taskAlg.homeDir + "Images/train/2092.jpg"
        ...
        Public Sub Run()
            ...
            If (taskAlg.heartBeat And imageSeries) Or fullsizeImage Is Nothing Then nextCheck.checked = True
    ...
    Public Class Options_Kalman_VB : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            If matrix.Count > 0 Then
                Const MAX_INPUT = 20
                matrix(taskAlg.frameCount Mod MAX_INPUT) = kalmanInput
    ...
    Public Class Options_LeftRight : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("Slice Height", 1, (taskAlg.rows - 10) / 2, sliceHeight)
            End If
        End Sub
        Public Sub Run()
    ...
    Public Class Options_Palette : Inherits OptionParent
        ...
        Public Sub New()
            radius = taskAlg.cols / 2
            If (sliders.Setup(traceName)) Then
                sliders.setupTrackBar("Color transitions", 1, 255, transitions)
                sliders.setupTrackBar("Convert And Scale", 0, 100, convertScale)
                sliders.setupTrackBar("LinearPolar radius", 0, taskAlg.cols, radius)
            End If
            Dim dirInfo = New DirectoryInfo(taskAlg.homeDir + "Data")
    ...
    Public Class Options_Pendulum : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            If taskAlg.firstPass Then check.Box(0).Checked = True
    ...
    Public Class Options_PlyFormat : Inherits OptionParent
        ...
        Public Sub New()
            fileNameForm = New OptionsFileName
            fileNameForm.OpenFileDialog1.InitialDirectory = taskAlg.homeDir + "temp"
            fileNameForm.OpenFileDialog1.FileName = "*.*"
            fileNameForm.OpenFileDialog1.CheckFileExists = False
            fileNameForm.OpenFileDialog1.Filter = "ply (*.ply)|*.ply|All files (*.*)|*.*"
            fileNameForm.OpenFileDialog1.FilterIndex = 1
            fileNameForm.filename.Text = taskAlg.settings.plyFileName
            If fileNameForm.filename.Text = "" Then fileNameForm.filename.Text = taskAlg.homeDir + "temp\pointcloud.ply"
        ...
        End Sub
        Public Sub Run()
            If taskAlg.firstPass Then fileNameForm.Left = taskAlg.gOptions.Width / 3
    ...
    Public Class Options_Draw : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("Merge rectangles within X pixels", 0, taskAlg.cols, If(taskAlg.cols = 1280, proximity * 2, proximity))
            End If
    ...
    Public Class Options_Stabilizer : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("Width of input to matchtemplate", 10, taskAlg.cols - pad, width)
                sliders.setupTrackBar("Height of input to matchtemplate", 10, taskAlg.rows - pad, height)
    ...
    Public Class Options_Stitch : Inherits OptionParent
        ...
        Public Sub New()
            width = taskAlg.cols / 2
            height = taskAlg.rows / 2
            If sliders.Setup(traceName) Then
                sliders.setupTrackBar("Number of random images", 10, 50, 10)
                sliders.setupTrackBar("Rectangle width", taskAlg.cols / 4, taskAlg.cols - 1, width)
                sliders.setupTrackBar("Rectangle height", taskAlg.rows / 4, taskAlg.rows - 1, height)
            End If
        End Sub
        Public Sub Run()
    ...
    Public Class Options_Transform : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("Rotation center X", 1, taskAlg.cols, taskAlg.cols / 2)
                sliders.setupTrackBar("Rotation center Y", 1, taskAlg.rows, taskAlg.rows / 2)
            End If
            If check.Setup(traceName) Then
    ...
    Public Class Options_Video : Inherits OptionParent
        ...
        Public Sub New()
            fileInfo = New FileInfo(taskAlg.homeDir + "Data\CarsDrivingUnderBridge.mp4")
            fileNameForm = New OptionsFileName
            fileNameForm.OpenFileDialog1.InitialDirectory = taskAlg.homeDir + "Data\"
            fileNameForm.OpenFileDialog1.FileName = "*.mp4"
            fileNameForm.OpenFileDialog1.CheckFileExists = False
            fileNameForm.OpenFileDialog1.Filter = "video files (*.mp4)|*.mp4|All files (*.*)|*.*"
            fileNameForm.OpenFileDialog1.FilterIndex = 1
            fileNameForm.filename.Text = taskAlg.settings.VideoFileName
    ...
    Public Class Options_WarpPerspective : Inherits OptionParent
        ...
        Public Sub New()
            width = taskAlg.cols - 50
            height = taskAlg.rows - 50
            angle = 0
            If sliders.Setup(traceName) Then
                sliders.setupTrackBar("Warped Width", 0, taskAlg.cols, width)
                sliders.setupTrackBar("Warped Height", 0, taskAlg.rows, height)
    ...
    Public Class Options_ColorMethod : Inherits OptionParent
        Public Sub New()
            If FindFrm(traceName + " CheckBox Options") Is Nothing Then
                check.Setup(traceName)
                For Each alg In taskAlg.featureOptions.colorMethods
    ...
    Public Class Options_ML : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            If taskAlg.frameCount < 100 Or taskAlg.optionsChanged Then frm.left = taskAlg.gOptions.Width / 2 + 10
        End Sub
    End Class
    ...
    Public Class Options_DerivativeBasics : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            rect1 = New cv.Rect(0, 0, taskAlg.cols - offsetX, taskAlg.rows - offsetY)
            rect2 = New cv.Rect(offsetX, offsetY, taskAlg.cols - offsetX, taskAlg.rows - offsetY)
        End Sub
    End Class
    ...
    Public Class Options_Grid : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                sliders.setupTrackBar("brick Width", 1, taskAlg.cols, width)
                sliders.setupTrackBar("brick Height", 1, taskAlg.rows, height)
            End If
        End Sub
        Public Sub Run()
    ...
    Public Class Options_MinArea : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            For i = 0 To numPoints - 1
                pt.X = msRNG.Next(taskAlg.cols / 2 - minSize, taskAlg.cols / 2 + minSize)
                pt.Y = msRNG.Next(taskAlg.rows / 2 - minSize, taskAlg.rows / 2 + minSize)
                srcPoints.Add(pt)
            Next
        End Sub
    End Class
    ...
    Public Class Options_FAST : Inherits OptionParent
        ...
        Public Sub New()
            If check.Setup(traceName) Then
                ...
                check.Box(0).Checked = True
            End If
            If taskAlg.cols >= 640 Then FASTthreshold = 30
            If sliders.Setup(traceName) Then
    ...
    Public Class Options_Features : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                If taskAlg.cols <= 336 Then minDistance = 10 ' small image, small distances
        ...
        Public Sub Run()
            ...
            taskAlg.depthDiffMeters = diffSlider.value / 1000
            minDistance = minSlider.value
        End Sub
    End Class
    ...
    Public Class Options_RedCloud : Inherits OptionParent
        ...
        Sub New()
            ...
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("Reduction Target", 1, 1000, taskAlg.reductionTarget)
            End If
        End Sub
        Public Sub Run()
            Static redSlider = FindSlider("Reduction Target")
            Dim lastTarget = taskAlg.reductionTarget
            taskAlg.reductionTarget = redSlider.value
            If lastTarget <> taskAlg.reductionTarget Then taskAlg.optionsChanged = False
    ...
    Public Class Options_HistPointCloud : Inherits OptionParent
        ...
        Public Sub New()
            If sliders.Setup(traceName) Then
                ...
                sliders.setupTrackBar("Histogram X bins", 1, taskAlg.cols, xBins)
                sliders.setupTrackBar("Histogram Y bins", 1, taskAlg.rows, yBins)
        ...
        Public Shared Sub setupCalcHist()
            ...
            Select Case taskAlg.settings.cameraName
                Case "Intel(R) RealSense(TM) Depth Camera 435i"
                    If taskAlg.workRes.Height = 480 Or taskAlg.workRes.Height = 240 Or taskAlg.workRes.Height = 120 Then
                        taskAlg.xRange = 1.38
                        taskAlg.yRange = 1.0
                    Else
                        taskAlg.xRange = 2.5
            ...
            taskAlg.xRangeDefault = taskAlg.xRange
            taskAlg.yRangeDefault = taskAlg.yRange

            taskAlg.sideCameraPoint = New cv.Point(0, taskAlg.workRes.Height \ 2)
            taskAlg.topCameraPoint = New cv.Point(taskAlg.workRes.Width \ 2, 0)

            taskAlg.channelsTop = {2, 0}
            taskAlg.channelsSide = {1, 2}

            taskAlg.rangesTop = New cv.Rangef() {New cv.Rangef(0.1, taskAlg.MaxZmeters + 0.1),
                                              New cv.Rangef(-taskAlg.xRange, taskAlg.xRange)}
            taskAlg.rangesSide = New cv.Rangef() {New cv.Rangef(-taskAlg.yRange, taskAlg.yRange),
                                               New cv.Rangef(0.1, taskAlg.MaxZmeters + 0.1)}

            taskAlg.sideCameraPoint = New cv.Point(0, CInt(taskAlg.workRes.Height / 2))
            taskAlg.topCameraPoint = New cv.Point(taskAlg.workRes.Width \ 2, 0)

            taskAlg.projectionThreshold = 3 ' ProjectionThresholdBar.Value
            taskAlg.channelCount = 1
            taskAlg.channelIndex = 0
            ...
            taskAlg.rangesCloud = New cv.Rangef() {New cv.Rangef(rx.Item0, rx.Item1), New cv.Rangef(ry.Item0, ry.Item1),
                                                New cv.Rangef(rz.Item0, rz.Item1)}

            Select Case taskAlg.reductionName
                Case "X Reduction"
                    taskAlg.ranges = New cv.Rangef() {New cv.Rangef(rx.Item0, rx.Item1)}
                    taskAlg.channels = {0}
                    taskAlg.histBinList = {taskAlg.histogramBins}
                Case "Y Reduction"
                    taskAlg.ranges = New cv.Rangef() {New cv.Rangef(ry.Item0, ry.Item1)}
                    taskAlg.channels = {1}
                    taskAlg.histBinList = {taskAlg.histogramBins}
                Case "Z Reduction"
                    taskAlg.ranges = New cv.Rangef() {New cv.Rangef(rz.Item0, rz.Item1)}
                    taskAlg.channels = {2}
                    taskAlg.histBinList = {taskAlg.histogramBins}
                Case "XY Reduction"
                    taskAlg.ranges = New cv.Rangef() {New cv.Rangef(rx.Item0, rx.Item1), New cv.Rangef(ry.Item0, ry.Item1)}
                    taskAlg.channelCount = 2
                    taskAlg.channels = {0, 1}
                    taskAlg.histBinList = {taskAlg.histogramBins, taskAlg.histogramBins}
                Case "XZ Reduction"
                    taskAlg.ranges = New cv.Rangef() {New cv.Rangef(rx.Item0, rx.Item1), New cv.Rangef(rz.Item0, rz.Item1)}
                    taskAlg.channelCount = 2
                    taskAlg.channels = {0, 2}
                    taskAlg.channelIndex = 1
                    taskAlg.histBinList = {taskAlg.histogramBins, taskAlg.histogramBins}
                Case "YZ Reduction"
                    taskAlg.ranges = New cv.Rangef() {New cv.Rangef(ry.Item0, ry.Item1), New cv.Rangef(rz.Item0, rz.Item1)}
                    taskAlg.channelCount = 2
                    taskAlg.channels = {1, 2}
                    taskAlg.channelIndex = 1
                    taskAlg.histBinList = {taskAlg.histogramBins, taskAlg.histogramBins}
                Case "XYZ Reduction"
                    taskAlg.ranges = New cv.Rangef() {New cv.Rangef(rx.Item0, rx.Item1), New cv.Rangef(ry.Item0, ry.Item1), New cv.Rangef(rz.Item0, rz.Item1)}
                    taskAlg.channelCount = 3
                    taskAlg.channels = {0, 1, 2}
                    taskAlg.channelIndex = 2
                    taskAlg.histBinList = {taskAlg.histogramBins, taskAlg.histogramBins, taskAlg.histogramBins}
            End Select
        End Sub
        Public Sub Run()
            ...
            Static frm = FindFrm(traceName + " Radio Buttons")
            taskAlg.reductionName = frm.check(findRadioIndex(frm.check)).Text
        End Sub
    End Class
    ...
    Public Class Options_History : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            taskAlg.frameHistoryCount = histSlider.value
        End Sub
    End Class
