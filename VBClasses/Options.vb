...
Namespace VBClasses
    ...
    Public Class Options_AsciiArt : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            hStep = CInt(algTask.rows / hSlider.value)
            wStep = CInt(algTask.cols / wSlider.value)
    ...
    Public Class Options_BlurTopo : Inherits OptionParent
        ...
        Public Sub Run()
            ...
            kernelSize = CInt(nextPercent / 100 * algTask.cols) Or 1
        End Sub
    End Class
    ...
    Public Class Options_EmaxInputClusters : Inherits OptionParent
        ...
        Public emaxCellSize As Integer = CInt(algTask.workRes.Width / 3)
        Public Sub New()
            If sliders.Setup(traceName) Then
    ...
    Public Class Options_HistPointCloud : Inherits OptionParent
        ...
        Public Shared Sub setupCalcHist()
            ...
            algTask.topCameraPoint = New cv.Point(CInt(algTask.workRes.Width / 2), 0)
