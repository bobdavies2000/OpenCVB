...
Public Class OptionsContainer
    ...
    Public Sub layoutOptions(normalRequest As Boolean)
        Dim w = taskAlg.Settings.allOptionsWidth
        ...
        For Each title In optionsTitle
            ...
            If frm IsNot Nothing Then
                ...
                If normalRequest And sidelineOptions And taskAlg.Settings.ShowAllOptions = False Then
                ...
                Else
                    If title.Contains("OpenFile") Then
                        frm.SetDesktopLocation(0, taskAlg.gOptions.Top + 350)
                    End If
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        ...
        taskAlg.featureOptions.BringToFront()
        taskAlg.gOptions.BringToFront()
        taskAlg.gOptions.BringToFront()
    End Sub
    ...
    Private Sub OptionsContainer_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        For Each title In hiddenOptions
            ...
            Next
        Next
        taskAlg.gOptions.Close()
        taskAlg.featureOptions.Close()
        taskAlg.treeView.Close()
        If taskAlg.sharpGL IsNot Nothing Then taskAlg.sharpGL.Close()
        GC.Collect()
    End Sub
    Private Sub OptionsContainer_ResizeEnd(sender As Object, e As EventArgs) Handles Me.ResizeEnd
        If positionedFromSettings Then
            taskAlg.Settings.allOptionsLeft = Me.Left
            taskAlg.Settings.allOptionsTop = Me.Top
            taskAlg.Settings.allOptionsWidth = Me.Width
            taskAlg.Settings.allOptionsHeight = Me.Height
        End If
    End Sub
