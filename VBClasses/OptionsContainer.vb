...
Public Class OptionsContainer
    ...
    Public Sub layoutOptions(normalRequest As Boolean)
        Dim w = tsk.Settings.allOptionsWidth
        ...
        For Each title In optionsTitle
            ...
            If frm IsNot Nothing Then
                ...
                If normalRequest And sidelineOptions And tsk.Settings.ShowAllOptions = False Then
                ...
                Else
                    If title.Contains("OpenFile") Then
                        frm.SetDesktopLocation(0, tsk.gOptions.Top + 350)
                    End If
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        ...
        tsk.featureOptions.BringToFront()
        tsk.gOptions.BringToFront()
        tsk.gOptions.BringToFront()
    End Sub
    ...
    Private Sub OptionsContainer_ResizeEnd(sender As Object, e As EventArgs) Handles Me.ResizeEnd
        If positionedFromSettings Then
            tsk.Settings.allOptionsLeft = Me.Left
            tsk.Settings.allOptionsTop = Me.Top
            tsk.Settings.allOptionsWidth = Me.Width
            tsk.Settings.allOptionsHeight = Me.Height
        End If
    End Sub
