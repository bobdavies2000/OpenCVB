...
Namespace VBClasses
    Public Class Font_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Dim hersheyFont = Choose(atask.frameCount Mod 7 + 1, cv.HersheyFonts.HersheyComplex, cv.HersheyFonts.HersheyComplexSmall, cv.HersheyFonts.HersheyDuplex,
            ...
            Dim hersheyName = Choose(atask.frameCount Mod 7 + 1, "HersheyComplex", "HersheyComplexSmall", "HersheyDuplex", "HersheyPlain", "HersheyScriptComplex",
            ...
            For i = 1 To 1
                ...
                cv.Cv2.PutText(dst2, msg, New cv.Point(10, 30 + i * 30),
                               hersheyFont, size, white, atask.lineWidth, atask.lineType)
                If standalone Then
                    Dim hersheyFontItalics = hersheyFont + cv.HersheyFonts.Italic
                    cv.Cv2.PutText(dst3, hersheyName + " " + Format(size, fmt1), New cv.Point(10, 30 + i * 30), hersheyFontItalics, size, white, atask.lineWidth, atask.lineType)
                End If
            Next
        End Sub
    End Class
    ...
    Public Class NR_Font_FlowMsgs : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Dim maxLines = 31
            If atask.workres.height = 720 Or atask.workres.height = 360 Or atask.workres.height = 180 Then maxLines = 23
