...
Namespace VBClasses
    ...
    Public Class EMax_Centers : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To emax.centers.Count - 1
                DrawCircle(dst2, emax.centers(i), taskAlg.DotSize + 1, taskAlg.highlight)
                If i < lastCenters.Count Then
                    DrawCircle(dst2, lastCenters(i), taskAlg.DotSize + 2, cv.Scalar.Black)
                End If
            Next
    ...
    Public Class EMax_InputClusters : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskAlg.optionsChanged Then grid.Run(dst2)
            ...
            For i = 0 To regionCount * options.samplesPerRegion - 1
                ...
                DrawCircle(dst2, ePt, taskAlg.DotSize + 2, taskAlg.highlight)
            Next
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To dst2.Rows - 1
                For j = 0 To dst2.Cols - 1
                    ...
                    Dim c = taskAlg.vecColors(response)
                    DrawCircle(dst2, New cv.Point(j, i), taskAlg.DotSize, c)
                Next
            Next
        End Sub
        Public Sub Close()
