...
Namespace VBClasses
    Public Class QRcode_Basics : Inherits TaskParent
        ...
        Public Sub New()
            Dim fileInfo = New FileInfo(taskAlg.homeDir + "data/QRcode1.png")
            If fileInfo.Exists Then qrInput1 = cv.Cv2.ImRead(fileInfo.FullName)
            fileInfo = New FileInfo(taskAlg.homeDir + "Data/QRCode2.png")
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskAlg.frameCount \ 50 Mod 2 = 0 Then
            ...
            For i = 0 To box.Length - 1
                dst2.Line(box(i), box((i + 1) Mod 4), cv.Scalar.Red, taskAlg.lineWidth + 2, taskAlg.lineType)
            Next
