...
Module Externs
    ...
    End Function
    <DllImport(("CPP_Native.dll"), CallingConvention:=CallingConvention.Cdecl)>
    Public Function EdgeLineSimple_RunCPP(cPtr As IntPtr, dataPtr As IntPtr, rows As Int32, cols As Int32, lineWidth As Integer) As IntPtr
    End Function
    ...
    <DllImport(("CPP_Native.dll"), CallingConvention:=CallingConvention.Cdecl)> Public Function TrackOpenCV_Open(trackType As Integer) As IntPtr
    End Function
    <DllImport(("CPP_Native.dll"), CallingConvention:=CallingConvention.Cdecl)> Public Function TrackOpenCV_Close(cPtr As IntPtr) As IntPtr
    End Function
    <DllImport(("CPP_Native.dll"), CallingConvention:=CallingConvention.Cdecl)>
    Public Function TrackOpenCV_Run(cPtr As IntPtr, bgrPtr As IntPtr, rows As Integer, cols As Integer,
    ...
    <DllImport(("CPP_Native.dll"), CallingConvention:=CallingConvention.Cdecl)>
    Public Function RedCloudMask_Open() As IntPtr
    End Function
    <DllImport(("CPP_Native.dll"), CallingConvention:=CallingConvention.Cdecl)>
    Public Function RedCloudMask_Close(cPtr As IntPtr) As IntPtr
    End Function
    <DllImport(("CPP_Native.dll"), CallingConvention:=CallingConvention.Cdecl)>
    Public Function RedCloudMask_Rects(cPtr As IntPtr) As IntPtr
    End Function

    <DllImport(("CPP_Native.dll"), CallingConvention:=CallingConvention.Cdecl)>
    Public Function RedCloudMask_Count(cPtr As IntPtr) As Integer
    End Function
    <DllImport(("CPP_Native.dll"), CallingConvention:=CallingConvention.Cdecl)>
    Public Function RedCloudMask_Run(cPtr As IntPtr, dataPtr As IntPtr, maskPtr As IntPtr,
                                             rows As Integer, cols As Integer) As IntPtr
    End Function
