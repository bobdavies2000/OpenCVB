...
Namespace VBClasses
    Public Class Texture_Basics : Inherits TaskParent
        ...
        Public Sub New()
            atask.gOptions.GridSlider.Value = Math.Min(dst2.Width \ 8, atask.gOptions.GridSlider.Maximum)
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            If standaloneTest() Or src.Channels() <> 1 Then
                ...
                dst3.SetTo(cv.Scalar.Yellow, atask.gridMask)
            Else
                dst2 = src
            End If
