...
Namespace VBClasses
    ...
    Public Class Image_Series : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            ' options.fileInputName = new fileinfo(taskA.homeDir + "Images/train/103041.jpg")
    ...
    Public Class Image_RedCloudColor : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Dim mask = taskA.redList.rcMap.InRange(0, 0)
    ...
    Public Class NR_Image_Icon : Inherits TaskParent
        ...
        Public Sub New()
            Dim filePath As String = taskA.homeDir + "/MainUI/Data/Magnify.png"
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Using fs As New FileStream(taskA.homeDir + "/MainUI/Data/test.ico", FileMode.OpenOrCreate)
                icon.Save(fs)
            End Using
            inputImage = Nothing
        End Sub
