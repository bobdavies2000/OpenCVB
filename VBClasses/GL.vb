...
Namespace VBClasses
    ...
    Public Class GL_BasicsLineMap : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            mapLine.Run(src)
            strOut = task.sharpGL.RunSharp(oCase.drawPointCloudRGB, mapLine.pointCloud)
            SetTrueText(strOut, 2)
        End Sub
    End Class
    ...
    Public Class XR_GL_MainForm : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            task.GLRequest = oCase.drawPointCloudRGB
    ...
    Public Class XR_GL_Line3DNoMotionInput : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            strOut = task.sharpGL.RunSharp(oCase.line3D, dst0)
    ...
    Public Class XR_GL_StructuredLines : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            strOut = task.sharpGL.RunSharp(oCase.line3D, dst0, dst1)
            SetTrueText(strOut, 2)
        End Sub
    End Class
    ...
    Public Class XR_GL_LinePoints3D : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            strOut = task.sharpGL.RunSharp(oCase.line3D, line3D.pointcloud, dst1)
            SetTrueText(strOut, 3)
        End Sub
    End Class
    ...
    Public Class GL_DisplayPC : Inherits TaskParent
        Shared ppx = task.calibData.leftIntrinsics.ppx
        Shared ppy = task.calibData.leftIntrinsics.ppy
        Shared fx = task.calibData.leftIntrinsics.fx
        Shared fy = task.calibData.leftIntrinsics.fy
    ...
    Public Class XR_GL_Line3D : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If task.toggleOn Then
                strOut = task.sharpGL.RunSharp(oCase.drawPointCloudRGB, line3d.dst2, line3d.dst3)
            Else
                strOut = task.sharpGL.RunSharp(oCase.drawPointCloudRGB, line3d.dst2, task.lines.dst2)
            End If
            SetTrueText(strOut, 2)
        End Sub
    End Class
    ...
    Public Class XR_GL_Line3D_Debug : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            strOut = task.sharpGL.RunSharp(oCase.drawPointCloudRGB, line3d.dst2, dst3)
            SetTrueText(strOut, 2)
        End Sub
    End Class
