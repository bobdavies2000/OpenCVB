...
Namespace VBClasses
    Public Class HullLine_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            lpList.Clear()
            dst2 = dst3.Clone
            Dim maxLines = atask.gOptions.DebugSlider.Value * 2
    ...
    Public Class HullLine_EdgePoints : Inherits TaskParent
        ...
        Public Shared Function EdgePointOffset(lpIn As lpData, offset As Integer) As lpData
            ...
            If lp.pE1.X >= atask.workRes.Width - 1 Then lp.pE1.X -= offset
            If lp.pE1.Y >= atask.workRes.Height - 1 Then lp.pE1.Y -= offset
            If lp.pE2.X >= atask.workRes.Width - 1 Then lp.pE2.X -= offset
            If lp.pE2.Y >= atask.workRes.Height - 1 Then lp.pE2.Y -= offset
            Return lp
        End Function
        Public Overrides Sub RunAlg(src As cv.Mat)
            hullLines.Run(src)
