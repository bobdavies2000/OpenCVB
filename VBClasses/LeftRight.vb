...
Namespace VBClasses
    ...
    Public Class LeftRight_CompareRaw : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            Dim r1 = New cv.Rect(0, options.sliceY, taskAlg.leftView.Width, options.sliceHeight)
            Dim r2 = New cv.Rect(0, 25, taskAlg.leftView.Width, options.sliceHeight)
            dst2.SetTo(0)
            taskAlg.leftView(r1).CopyTo(dst2(r2))

            r2.Y += options.sliceHeight
            taskAlg.rightView(r1).CopyTo(dst2(r2))
            dst3 = taskAlg.rightView
        End Sub
    End Class
    ...
    Public Class LeftRight_Palettized : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            dst2 = PaletteFull(taskAlg.leftView)
            dst3 = PaletteFull(taskAlg.rightView)
        End Sub
    End Class
    ...
    Public Class LeftRight_BRISK : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            brisk.Run(taskAlg.leftView)
            dst2 = brisk.dst2.Clone

            brisk.Run(taskAlg.rightView)
    ...
    Public Class LeftRight_Reduction : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            reduction.Run(taskAlg.leftView)
            dst2 = reduction.dst2.Clone

            reduction.Run(taskAlg.rightView)
    ...
    Public Class LeftRight_RGBAlignLeft : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            dst2 = taskAlg.leftView(rect).Resize(dst0.Size)
    ...
    Public Class LeftRight_ContourLeft : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            color8U.Run(taskAlg.leftView)
            taskAlg.contours.Run(color8U.dst2)
