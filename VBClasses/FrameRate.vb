...
Namespace VBClasses
    Public Class FrameRate_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            Static lastImages() As cv.Mat = {tsk.color.Clone, tsk.leftView.Clone,
                                             tsk.rightView.Clone, tsk.depthRGB.Clone}
            For i = 0 To frameCounts.Count - 1
                mats.mat(i) = Choose(i + 1, tsk.color, tsk.leftView, tsk.rightView, tsk.depthRGB).clone()
            ...
            If tsk.heartBeat Then
                ...
                For i = 0 To frameCounts.Count - 1
                    ...
                    strOut += Format(frameCounts(i), fmt0) + vbTab + " frameCount = " + CStr(tsk.frameCount) + vbCrLf
                Next
            End If
            SetTrueText(strOut, 3)
            mats.Run(emptyMat)
            dst2 = mats.dst2
            lastImages = {tsk.color.Clone, tsk.leftView.Clone, tsk.rightView.Clone, tsk.depthRGB.Clone}
        End Sub
    End Class
