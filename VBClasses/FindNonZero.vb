...
Namespace VBClasses
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If standaloneTest() Then
                ...
                For i = 0 To ptMat.Rows - 1
                    DrawCircle(dst3, ptMat.Get(Of cv.Point)(0, i), tsk.DotSize, white)
                Next
    ...
    Public Class NR_FindNonZero_SoloPoints : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If tsk.heartBeat Then labels(2) = $"There were {soloPoints.Count} points found"
        End Sub
    End Class
    ...
    Public Class NR_FindNonZero_Line3DWorld : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = 0 To ptList.Count - 1
                Dim pt = ptList(i)
                Dim testvec = tsk.pointCloud.Get(Of cv.Vec3f)(pt.Y, pt.X)
