...
Namespace VBClasses
    Public Class Flood_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            End If
            dst1 = taskAlg.redList.dst1
            SetTrueText(taskAlg.redList.strOut, 3)
        End Sub
    End Class
    ...
    Public Class Flood_CellStatsPlot : Inherits TaskParent
        Public Sub New()
            taskAlg.gOptions.setHistogramBins(1000)
    ...
    Public Class Flood_ContainedCells : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = taskAlg.redList.oldrclist.Count - 1 To 0 Step -1
                Dim rc = taskAlg.redList.oldrclist(i)
                Dim nabs As New List(Of Integer)
                Dim contains As New List(Of Integer)
                For j = 0 To taskAlg.redList.oldrclist.Count - 1
                    Dim rcBig = taskAlg.redList.oldrclist(j)
    ...
    Public Class Flood_Tiers : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            Dim tier = taskAlg.gOptions.DebugSlider.Value
    ...
    Public Class Flood_Motion : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            If taskAlg.heartBeat Then
                ...
                cellMap = taskAlg.redList.rcMap.Clone
    ...
    Public Class Flood_Minimal : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskAlg.mouseClickFlag Then
                ...
                dst1.Rectangle(rect, 255, taskAlg.lineWidth)
            End If
        End Sub
    End Class
