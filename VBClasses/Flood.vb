...
Namespace VBClasses
    Public Class Flood_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            End If
            dst1 = atask.redList.dst1
            SetTrueText(atask.redList.strOut, 3)
        End Sub
    End Class
    ...
    Public Class NR_Flood_CellStatsPlot : Inherits TaskParent
        Public Sub New()
            atask.gOptions.setHistogramBins(1000)
    ...
    Public Class Flood_ContainedCells : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            For i = atask.redList.oldrclist.Count - 1 To 0 Step -1
                Dim rc = atask.redList.oldrclist(i)
                Dim nabs As New List(Of Integer)
                Dim contains As New List(Of Integer)
                For j = 0 To atask.redList.oldrclist.Count - 1
                    Dim rcBig = atask.redList.oldrclist(j)
    ...
    Public Class NR_Flood_Tiers : Inherits TaskParent
        ...
        End Sub
        Public Overrides Sub RunAlg(src As cv.Mat)
            Dim tier = atask.gOptions.DebugSlider.Value
    ...
    Public Class NR_Flood_Minimal : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If atask.mouseClickFlag Then
                ...
                dst1.Rectangle(rect, 255, atask.lineWidth)
            End If
        End Sub
    End Class
    ...
    Public Class Flood_BasicsMask : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If atask.heartBeat Then labels(2) = $"{redC.rcList.Count} cells identified"
