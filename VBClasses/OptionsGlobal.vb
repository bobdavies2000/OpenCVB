...
Public Class OptionsGlobal
    ...
    Private Sub OptionsGlobal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ShowAllOptions.Checked = tsk.Settings.ShowAllOptions

        tsk.DotSize = 1
        tsk.cvFontThickness = 1
        tsk.brickSize = 8
        tsk.DotSize = 1
        tsk.lineWidth = 1
        Select Case tsk.workRes.Width
            Case 1920
                tsk.cvFontSize = 3.5
                tsk.cvFontThickness = 4
                tsk.DotSize = 5
                tsk.lineWidth = 5
                tsk.brickSize = 36
            Case 1280
                tsk.cvFontSize = 2.5
                tsk.cvFontThickness = 2
                tsk.DotSize = 5
                tsk.lineWidth = 4
                tsk.brickSize = 24
            Case 960
    ...
    Private Sub LineType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles LineType.SelectedIndexChanged
        ...
        Select Case LineType.Text
            Case "AntiAlias"
                tsk.lineType = cv.LineTypes.AntiAlias
            Case "Link4"
                tsk.lineType = cv.LineTypes.Link4
            Case "Link8"
                tsk.lineType = cv.LineTypes.Link8
        End Select
    End Sub
    ...
    Private Sub MaxDepth_ValueChanged(sender As Object, e As EventArgs) Handles MaxDepthBar.ValueChanged
        ...
        tsk.MaxZmeters = MaxDepthBar.Value + 0.01
        tsk.optionsChanged = True
    End Sub
    ...
    Private Sub Palettes_SelectedIndexChanged_1(sender As Object, e As EventArgs) Handles Palettes.SelectedIndexChanged
        tsk.optionsChanged = True
        tsk.paletteIndex = mapNames.IndexOf(Palettes.Text)
    End Sub
    ...
    Private Sub ShowAllByDefault_CheckedChanged(sender As Object, e As EventArgs) Handles ShowAllOptions.CheckedChanged
        tsk.Settings.ShowAllOptions = ShowAllOptions.Checked
    End Sub
    ...
    Private Sub highlight_SelectedIndexChanged(sender As Object, e As EventArgs) Handles highlight.SelectedIndexChanged
        Select Case highlight.Text
            Case "Yellow"
                tsk.highlight = cv.Scalar.Yellow
            Case "Black"
                tsk.highlight = cv.Scalar.Black
            Case "White"
                tsk.highlight = cv.Scalar.White
            Case "Red"
                tsk.highlight = cv.Scalar.Red
        End Select
    End Sub
