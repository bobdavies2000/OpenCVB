...
Namespace VBClasses
    ...
    Public Class NR_RedCart_Basics : Inherits TaskParent
        Public prepData As New RedPrep_Core
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            lut = RedCart_Basics.countClasses(prepData.dst2.Clone, labels(2))
            lutList.Clear()
    ...
    Public Class NR_RedCart_Validate : Inherits TaskParent
        Dim redCart As New NR_RedCart_PrepY
        Public Sub New()
    ...
    Public Class NR_RedCart_CheckerBoardWall : Inherits TaskParent
        Public prepData As New RedPrep_Core
    ...
    Public Class NR_RedCart_PrepXOld : Inherits TaskParent
        Public prepData As New RedPrep_Core
        Public classCount As Integer
    ...
    Public Class NR_RedCart_PrepY : Inherits TaskParent
        Public prepData As New RedPrep_Core
        Public classCount As Integer
        Public Sub New()
    ...
    Public Class RedCart_PrepXYAlt : Inherits TaskParent
        Dim redX As New NR_RedCart_PrepX
        Dim redY As New NR_RedCart_PrepY
        Public Sub New()
            dst1 = New cv.Mat(dst1.Size, cv.MatType.CV_8U, 0)
    ...
    Public Class NR_RedCart_PrepX : Inherits TaskParent
        Public prepData As New RedPrep_Core
        Public classCount As Integer
        Public Sub New()
            OptionParent.findRadio("X Reduction").Checked = True
    ...
    Public Class RedCart_Debug : Inherits TaskParent
        Dim redCart As New NR_RedCart_Basics
        Public classCount As Integer
        Public Sub New()
            If standalone Then task.gOptions.displayDst1.Checked = True
