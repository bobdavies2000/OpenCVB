...
Namespace VBClasses
    ...
    Public Class Utility_Basics : Inherits TaskParent
        ...
        Public Shared Sub AddPlotScale(dst As Mat, minVal As Double, maxVal As Double, Optional lineCount As Integer = 3)
            ...
            Next
        End Sub
        Public Shared Function findCause(rcMap As Mat) As String
            ...
            Return findCause
        End Function
        Public Shared Function rcDataMatch(rc As rcData) As rcData
            'Dim r1 = rc.rect
            ...
            Return rc
        End Function
        Public Shared Function rcMatch(rc As rcData) As rcData
            'Dim r1 = rc.rect
        ...
        Public Shared Function selectMinCell(rcIndexMap As Mat, rcMap As Mat, rcList As List(Of rcData)) As String
            ...
            Else
                ...
                task.color(task.rcD.rect).SetTo(white, task.rcD.mask)
                dMsg = task.rcD.displayCell()
                myClickPoint = task.rcD.maxDist
            End If

            Return dMsg
        End Function
        Public Shared Function DelaunaySelect(rcMap As Mat, rcList As List(Of rcData)) As String
            Dim dMsg As String = ""
