...
Namespace VBClasses
    Public Class Pendulum_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If tsk.frameCount Mod 1000 = 0 Or tsk.optionsChanged Then
                dst2.SetTo(0)
                dst3.SetTo(0)
            End If
            ...
            vbc.DrawLine(dst2, center, p1, tsk.scalarColors(tsk.frameCount Mod 255))
            vbc.DrawLine(dst2, p1, p2, tsk.scalarColors(tsk.frameCount Mod 255))

            DrawCircle(dst3, p1, tsk.DotSize, tsk.scalarColors(tsk.frameCount Mod 255))
            DrawCircle(dst3, p2, tsk.DotSize, tsk.scalarColors(tsk.frameCount Mod 255))
        End Sub
    End Class
End Namespace