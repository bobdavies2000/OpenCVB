...
Namespace VBClasses
    Public Class Pendulum_Basics : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If taskA.frameCount Mod 1000 = 0 Or taskA.optionsChanged Then
                dst2.SetTo(0)
                dst3.SetTo(0)
            End If
            ...
            vbc.DrawLine(dst2, center, p1, taskA.scalarColors(taskA.frameCount Mod 255))
            vbc.DrawLine(dst2, p1, p2, taskA.scalarColors(taskA.frameCount Mod 255))

            DrawCircle(dst3, p1, taskA.DotSize, taskA.scalarColors(taskA.frameCount Mod 255))
            DrawCircle(dst3, p2, taskA.DotSize, taskA.scalarColors(taskA.frameCount Mod 255))
        End Sub
    End Class
End Namespace