...
Namespace VBClasses
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If inputPoints.Count > 4 Then
                ...
                If standaloneTest() Then
                    ...
                    Next
                    dst2.Ellipse(box, cv.Scalar.Green, tsk.lineWidth, tsk.lineType)
                End If
            End If
        End Sub
    End Class
    ...
    Public Class NR_FitEllipse_AMS_CPP : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If size.Width < tsk.lineWidth + 1 Or size.Height < tsk.lineWidth + 1 Then Exit Sub

            Dim box = New cv.RotatedRect(center, size, angle)
            dst2.Ellipse(box, cv.Scalar.Yellow, tsk.lineWidth, tsk.lineType)
        End Sub
    End Class
    ...
    Public Class NR_FitEllipse_RedCloud : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            ...
            If tsk.oldrcD.contour Is Nothing Then Exit Sub
            ...
            fitE.Run(src)
            dst3.SetTo(0)
            dst3(tsk.oldrcD.rect).SetTo(white, tsk.oldrcD.mask)
            DrawRect(dst3, tsk.oldrcD.rect, white)
            dst3(tsk.oldrcD.rect).Ellipse(fitE.box, cv.Scalar.Yellow, tsk.lineWidth, tsk.lineType)
        End Sub
    End Class
