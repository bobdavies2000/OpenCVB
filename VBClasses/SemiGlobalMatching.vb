...
Namespace VBClasses
    Public Class NR_SemiGlobalMatching_CPP : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            If tsk.frameCount < 10 Then Exit Sub
            ...
            'Marshal.Copy(tsk.leftView.Data, leftData, 0, leftData.Length)
            'Marshal.Copy(tsk.rightView.Data, rightData, 0, rightData.Length)
            ...
            '                                      tsk.leftView.Rows, tsk.leftView.Cols)
            'handleLeft.Free()
            'handleRight.Free()

            'Dim dst2 = New cv.Mat(tsk.leftView.Rows, tsk.leftView.Cols, cv.MatType.CV_8U, imagePtr)
