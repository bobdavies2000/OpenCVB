...
Namespace VBClasses
    Public Class SemiGlobalMatching_CPP : Inherits TaskParent
        ...
        Public Overrides Sub RunAlg(src As cv.Mat)
            If taskAlg.frameCount < 10 Then Exit Sub
            ...
            'Marshal.Copy(taskAlg.leftView.Data, leftData, 0, leftData.Length)
            'Marshal.Copy(taskAlg.rightView.Data, rightData, 0, rightData.Length)
            ...
            '                                      taskAlg.leftView.Rows, taskAlg.leftView.Cols)
            'handleLeft.Free()
            'handleRight.Free()
