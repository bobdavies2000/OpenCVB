...
Rectangle(dst2, rect, black, task.lineWidth)
        match.Run(rightView(searchRect))
        dst3 = rightView
        matchRect = match.newRect

Rectangle(dst3, searchRect, black, task.lineWidth)
        ...
        End If
        Rectangle(dst3, bestRect, white, task.lineWidth)
...
Public Class XR_Disparity_Edges : Inherits TaskParent
...
Public Class XR_Disparity_Inverse : Inherits TaskParent
    Public Sub New()
...
Public Class XR_Disparity_Color8u : Inherits TaskParent
