...
Public Class PointCloud_Basics : Inherits VBparent
    ...
    Public Sub Run(src As cv.Mat) ' Rank = 1
        ...
        setupSide.Run(views.dst2)
        dst2 = setupSide.dst2

        setupTop.Run(views.dst3)
        dst3 = setupTop.dst2
    End Sub
End Class
...
Public Class PointCloud_FrustrumTop : Inherits VBparent
    ...
    Public Sub Run(src As cv.Mat) ' Rank = 1
        frustrum.Run(src)
        topView.Run(frustrum.dst3)

        setupTop.Run(topView.dst2)
        dst2 = setupTop.dst2
    End Sub
End Class
...
Public Class PointCloud_FrustrumSide : Inherits VBparent
    ...
    Public Sub Run(src As cv.Mat) ' Rank = 1
        frustrum.Run(src)
        sideView.Run(frustrum.dst3)

        setupSide.Run(sideView.dst2)
        dst2 = setupSide.dst2
    End Sub
End Class
