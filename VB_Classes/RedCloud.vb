...
Public Class RedCloud_DelaunayGuidedFeatures : Inherits VB_Parent
    ...
    Dim redC As New RedCloud_Basics
    Dim goodList As New List(Of List(Of cv.Point2f))
    Public Sub New()
...
Public Class RedCloud_Flippers : Inherits VB_Parent
    ...
    Public Sub RunVB(src As cv.Mat)
        ...
        Static lastMap As cv.Mat = task.cellMap.Clone
        dst2.SetTo(0)
...
Public Class RedCloud_Delaunay : Inherits VB_Parent
    ...
    Public Sub RunVB(src As cv.Mat)
        delaunay.Run(src)
        dst1 = delaunay.dst2.CvtColor(cv.ColorConversionCodes.BGR2GRAY)
...
Public Class RedCloud_MaxDist_CPP_VB : Inherits VB_Parent
    ...
    Public Sub RunVB(src As cv.Mat)
        ...
        Dim rectData = New cv.Mat(classCount, 1, cv.MatType.CV_32SC4, RedCloudMaxDist_Rects(cPtr))
        Dim floodPointData = New cv.Mat(classCount, 1, cv.MatType.CV_32SC2, RedCloudMaxDist_FloodPoints(cPtr))
