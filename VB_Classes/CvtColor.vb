...
Public Class CvtColor_Basics : Inherits VB_Algorithm
...
Public Class CvtColor_Grayscale : Inherits VB_Algorithm
    Public Sub New()
...
Public Class CvtColor_Depth : Inherits VB_Algorithm
...
Public Class CvtColor_KMeans : Inherits VB_Algorithm
...
Public Class CvtColor_RedHue : Inherits VB_Algorithm
...
Public Class CvtColor_Complementary : Inherits VB_Algorithm
    Public Sub New()
...
' https://stackoverflow.com/questions/40233986/python-is-there-a-function-or-formula-to-find-the-complementary-colour-of-a-rgb
Public Class CvtColor_ComplementaryTest : Inherits VB_Algorithm
    Dim images As New Image_Basics
    Dim comp As New CvtColor_Complementary
    Public Sub New()
...
Public Class CvtColor_InRange : Inherits VB_Algorithm
    Public Sub New()
...
Public Class CvtColor_TopX_VB : Inherits VB_Algorithm
...
Public Class CvtColor_Common_VB : Inherits VB_Algorithm
...
Public Class CvtColor_Smoothing : Inherits VB_Algorithm
...
Public Class CvtColor_Denoise : Inherits VB_Algorithm
...
Public Class CvtColor_MotionFiltered : Inherits VB_Algorithm
    Dim colorClass As New CvtColor_Basics
    Public classCount As Integer
    Public Sub New()
        desc = "Prepare a CvtColor_Basics image using the task.motionRect"
    End Sub
    Public Sub RunVB(src As cv.Mat)
...
Public Class CvtColor_Hue : Inherits VB_Algorithm
    Public Sub New()
...
Public Class CvtColor_BlackAndWhite : Inherits VB_Algorithm
