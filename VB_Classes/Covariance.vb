...
Public Class Covariance_Basics : Inherits VB_Algorithm
...
Public Class Covariance_Test : Inherits VB_Algorithm
...
Public Class Covariance_Images : Inherits VB_Algorithm
    Dim covar As New Covariance_Basics
