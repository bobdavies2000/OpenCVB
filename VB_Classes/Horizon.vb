...
Public Class Horizon_Basics : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        If src.Type <> cv.MatType.CV_32F Then dst0 = task.gravityHorizon.PrepareDepthInput(1) Else dst0 = src
...
Public Class Horizon_ExternalTest : Inherits TaskParent
    ...
    End Sub
    Public Overrides Sub RunAlg(src As cv.Mat)
        dst0 = task.gravityHorizon.PrepareDepthInput(1)
        horizon.Run(dst0)
        dst2 = horizon.dst2
    End Sub
End Class
...
Public Class Horizon_BasicsNew : Inherits TaskParent
    Public points As New List(Of cv.Point)
    Dim resizeRatio As Integer = 1
    Public vec As New linePoints
    Public vecPresent As Boolean
