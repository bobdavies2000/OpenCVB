...
Public Class Texture_Basics : Inherits VB_Parent
    ...
    Public Sub RunAlg(src As cvb.Mat)
        If standaloneTest() Or src.Channels() <> 1 Then
            ...
            dst3.SetTo(cvb.Scalar.Yellow, task.gridMask)
        Else
            dst2 = src
        End If
...
Public Class OpenGL_TextureShuffle : Inherits VB_Parent
    ...
    Public tRect As cvb.Rect
    Public rgbaTexture As New cvb.Mat
    Public Sub New()
    ...
    Public Sub RunAlg(src As cvb.Mat)
        ...
        Dim alpha As New cvb.Mat(split(0).Size(), cvb.MatType.CV_8U, 1)
        Dim merged() As cvb.Mat = {split(2), split(1), split(0), alpha}
        cvb.Cv2.Merge(merged, rgbaTexture)
