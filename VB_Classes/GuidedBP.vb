...
Public Class GuidedBP_kTop : Inherits VB_Algorithm
    ...
    Public Sub New()
        ...
        desc = "Subdivide the OpAuto_XRange output using RedColor_Basics"
    End Sub
    Public Sub RunVB(src As cv.Mat)
        hist2d.Run(src)
...
Public Class GuidedBP_kSide : Inherits VB_Algorithm
    ...
    Public Sub New()
        ...
        colorC.showSelected = False
        labels(3) = "Back projection of the top view"
        desc = "Subdivide the GuidedBP_HistogramSide output using RedColor_Basics"
    End Sub
    Public Sub RunVB(src As cv.Mat)
        hist2d.Run(src)
...
Public Class GuidedBP_kCellStats : Inherits VB_Algorithm
    ...
    Public Sub New()
        stats.redC = New ReductionCloud_Basics
...
Public Class GuidedBP_DelaunayStats : Inherits VB_Algorithm
    ...
    Public Sub New()
        ...
        desc = "Compartmentalize the RedColor_Basics cells so they stay near the objects detected."
    End Sub
    Public Sub RunVB(src As cv.Mat)
        reduction.Run(src)
...
Public Class GuidedBP_Objects : Inherits VB_Algorithm
    ...
    Public Sub New()
        ...
        desc = "Create the input to RedColor_Basics combining color and GuidedBP_Hulls output"
    End Sub
    Public Sub RunVB(src As cv.Mat)
        kHist.Run(src)
...
Public Class GuidedBP_RedColorCloud : Inherits VB_Algorithm
    ...
    Public Sub New()
        ...
        desc = "Run RedColor_Basics on the output of GuidedBP_Points"
    End Sub
    Public Sub RunVB(src As cv.Mat)
        docBP.Run(src)
...
Public Class GuidedBP_RedColor : Inherits VB_Algorithm
    ...
    Public Sub New()
        stats.redC = New ReductionCloud_Basics
        labels = {"", "", "RedColor_Basics output", ""}
        desc = "Run RedColor_Basics on the output of GuidedBP_Basics after merging with task.color"
    End Sub
    Public Sub RunVB(src As cv.Mat)
        docBP.Run(src)
