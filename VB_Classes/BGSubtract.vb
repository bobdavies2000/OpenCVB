    ...
    Public Sub RunAlg(src As cvb.Mat)
        ...
        For i = 0 To threadCount - 1
            ...
            taskArray(i) = System.Threading.Tasks.Task.Factory.StartNew(
                Sub()
                    Dim roi = New cvb.Rect((section Mod xfactor) * width, height * Math.Floor(section / yfactor), width, height)
...
Public Class BGSubtract_GMG_KNN : Inherits TaskParent
    ...
    Dim options As New Options_BGSubtract
    Public Sub New()
        gmg = cvb.BackgroundSubtractorGMG.Create()
...
Public Class BGSubtract_MOG_RGBDepth : Inherits TaskParent
    ...
    Dim MOGRGB As cvb.BackgroundSubtractorMOG
    Public Sub New()
        MOGDepth = cvb.BackgroundSubtractorMOG.Create()
        MOGRGB = cvb.BackgroundSubtractorMOG.Create()
    ...
    Public Sub RunAlg(src As cvb.Mat)
        ...
        dst2 = grayMat.CvtColor(cvb.ColorConversionCodes.GRAY2BGR)
...
Public Class BGSubtract_MOG_Retina : Inherits TaskParent
    ...
    Public Sub RunAlg(src As cvb.Mat)
        ...
        dst2 = bgSub.dst2
        cvb.Cv2.Subtract(bgSub.dst2, retina.dst3, dst3)
    End Sub
End Class
...
Public Class BGSubtract_DepthOrColorMotion : Inherits TaskParent
    ...
    Public Sub RunAlg(src As cvb.Mat)
        ...
        dst2 = motion.dst2
        dst3 = motion.dst3
        Dim mask = dst2.CvtColor(cvb.ColorConversionCodes.BGR2GRAY).ConvertScaleAbs()
...
Public Class BGSubtract_Synthetic_CPP_VB : Inherits TaskParent
    ...
    Public Sub RunAlg(src As cvb.Mat)
        ...
        If imagePtr <> 0 Then dst2 = cvb.Mat.FromPixelData(dst2.Rows, dst2.Cols, cvb.MatType.CV_8UC3, imagePtr).Clone
    End Sub
    Public Sub Close()
