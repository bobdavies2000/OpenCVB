...
Public Class PhaseCorrelate_Basics : Inherits VB_Algorithm
...
Public Class PhaseCorrelate_BasicsTest : Inherits VB_Algorithm
...
Public Class PhaseCorrelate_Depth : Inherits VB_Algorithm
...
' https://docs.opencv.org/master/d7/df3/group__imgproc__motion.html
Public Class PhaseCorrelate_HanningWindow : Inherits VB_Algorithm
    Public Sub New()
