...
Public Class Histogram_TopData
    ...
    Public Sub Run()
        ...
        dst1 = histOutput.Flip(cv.FlipMode.X).Threshold(task.task.hist3DThreshold, 255, cv.ThresholdTypes.Binary).Resize(dst1.Size)
...
Public Class Histogram_SmoothTopView2D
    ...
    Public Sub Run()
        ...
        dst1 = topView.histOutput.Threshold(task.task.hist3DThreshold, 255, cv.ThresholdTypes.Binary)
...
Public Class Histogram_SmoothSideView2D
    ...
    Public Sub Run()
        ...
        dst1 = sideView.histOutput.Threshold(task.task.hist3DThreshold, 255, cv.ThresholdTypes.Binary)
        dst1.ConvertTo(dst1, cv.MatType.CV_8UC1)
...
Public Class Histogram_TopView2D
    ...
    Public Sub Run()
        ...
        histOutput = originalHistOutput.Threshold(task.task.hist3DThreshold, 255, cv.ThresholdTypes.Binary)
...
Public Class Histogram_SideView2D
    ...
    Public Sub Run()
        ...
        histOutput = originalHistOutput.Threshold(task.task.hist3DThreshold, 255, cv.ThresholdTypes.Binary).Resize(dst1.Size)
