    ...
    Public Sub plotHighlights(histOutput As cv.Mat, dst As cv.Mat, sideRun As Boolean)
        ...
        For i = 0 To pts.Count - 1
            ...
            If drawLines Then
                ...
                End If
                dst.Line(p1, p2, cv.Scalar.Yellow, task.lineWidth)
            Else
...
Public Class Histogram_Concentration : Inherits VBparent
    Public histC As New Histogram_ConcentrationPoints
    Public Sub New()
...
Public Class Histogram_ConcentrationPeak : Inherits VBparent
    Dim plot As New Plot_OverTime
    Dim dots As New Histogram_Concentration
    Dim mats As New Mat_4to1
    Public Sub New()
        plot.plotCount = 1
        plot.minScale = 0
...
Public Class Histogram_ConcentrationLines : Inherits VBparent
    ...
    Public Sub Run(src As cv.Mat) ' Rank = 1
        ...
        label2 = "Longest line = " + CStr(maxLength) + " pixels at " + CStr(peakRotation)
