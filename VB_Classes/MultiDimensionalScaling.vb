...
Public Class MultiDimensionScaling_Cities : Inherits VBparent
    ...
    Public Sub Run(src As cv.Mat) ' Rank = 1
        ...
        For c = 0 To size - 1
            ...
            dst2.Circle(CInt(x), CInt(y), task.dotSize + 3, cv.Scalar.Red, -1, task.lineType)
            ...
            dst2.PutText(cityName, textPos, cv.HersheyFonts.HersheySimplex, 0.5, cv.Scalar.White)
        Next
    End Sub
End Class
