...
Public Class Cell_Boundaries : Inherits VB_Algorithm
...
Public Class Cell_BoundaryTiers : Inherits VB_Algorithm
    Dim cells As New Cell_Boundaries
    Dim contours As New Contour_DepthTiers
    Public Sub New()
        dst2 = New cv.Mat(dst2.Size, cv.MatType.CV_8U, 0)
        desc = "Add the depth tiers to the color cell boundaries"
    End Sub
    Public Sub RunVB(src As cv.Mat)
        cells.Run(src)
        dst3 = cells.dst2
