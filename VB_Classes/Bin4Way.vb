...
Public Class Bin4Way_Basics : Inherits TaskParent
    ...
    Public Overrides sub RunAlg(src As cv.Mat)
        Static index = task.gcMap.Get(Of Integer)(task.ClickPoint.Y, task.ClickPoint.X)
        If task.mousePicTag = 1 Then index = task.gcMap.Get(Of Integer)(task.ClickPoint.Y, task.ClickPoint.X)
