...
Public Class Bin4Way_Basics : Inherits TaskParent
    ...
    Public Overrides sub RunAlg(src As cv.Mat)
        Static index As Integer = task.brickMap.Get(Of Single)(task.ClickPoint.Y, task.ClickPoint.X)
        If task.mousePicTag = 1 Then index = task.brickMap.Get(Of Single)(task.ClickPoint.Y, task.ClickPoint.X)
