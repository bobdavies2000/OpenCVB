...
Public Class TaskParent : Implements IDisposable
    ...
    Public Function gMatrixToStr(gMatrix As cvb.Mat) As String
        ...
        Return outStr
    End Function
    Public Function randomCellColor() As cvb.Vec3b
        Static msRNG As New System.Random
        Return New cvb.Vec3b(msRNG.Next(50, 240), msRNG.Next(50, 240), msRNG.Next(50, 240)) ' trying to avoid extreme colors... 
    End Function
    ...
    Public Sub SetTrueText(text As String, pt As cvb.Point, Optional picTag As Integer = 2)
        ...
        End If
    End Sub
    'Public Sub SetTrueText(text As String, pt As cvb.Point2f, Optional picTag As Integer = 2)
    '    If primaryAlg Then
    '        Dim str As New TrueText(text, New cvb.Point(CInt(pt.X), CInt(pt.Y)), picTag)
    '        trueData.Add(str)
    '    End If
    'End Sub
