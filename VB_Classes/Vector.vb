...
Public Class Vector_Magnitude : Inherits VB_Parent
    ...
    Public Sub RunAlg(src As cvb.Mat)
        ...
        Dim euclidean_distance As New cvb.Mat
        cvb.Cv2.Magnitude(diff_x, diff_y, euclidean_distance)
        strOut += "euclidean_distance = " + CStr(euclidean_distance.Get(Of Single)(0, 0)) + vbCrLf + vbCrLf

        Dim manhattan_distance = cvb.Cv2.Abs(diff_x) + cvb.Cv2.Abs(diff_y)
        ...
        ' abs(x2 - x1) + abs(y2 - y1)
        Dim points1 = coordinates(cvb.Range.All(), New cvb.Range(0, 2))
        Dim points2 = coordinates(cvb.Range.All(), New cvb.Range(2, 4))
        Dim other_manhattan_distance As New cvb.Mat
        cvb.Cv2.Absdiff(points1, points2, other_manhattan_distance)
