...
Public Class Vector_Magnitude : Inherits VBparent
    ...
    Public Sub Run(src As cv.Mat) ' Rank = 1
        ...
        setTrueText("p1 = (" + CStr(cVector(0)) + ", " + CStr(cVector(1)) + ")" + vbTab + " p2 = (" + CStr(cVector(2)) + ", " + CStr(cVector(3)) + ")", 10, 40)
        ...
        setTrueText("euclidean_distance = " + CStr(euclidean_distance.Get(Of Single)(0, 0)), 10, 80)

        Dim manhattan_distance = cv.Cv2.Abs(diff_x) + cv.Cv2.Abs(diff_y)
        setTrueText("manhattan_distance = " + CStr(manhattan_distance.ToMat.Get(Of Single)(0, 0)), 10, 120)
        ...
        setTrueText("other_manhattan_distance = " + CStr(other_manhattan_distance.Get(Of Single)(0, 0)), 10, 160)
    End Sub
End Class
