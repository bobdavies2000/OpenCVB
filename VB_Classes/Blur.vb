...
Public Class Blur_Basics : Inherits VBparent
    ...
    Public Sub Run(src As cv.Mat) ' Rank = 1
        ...
        If kernelSize > 0 Then
            ...
            If standalone Or task.intermediateActive Then cv.Cv2.GaussianBlur(task.RGBDepth, dst3, New cv.Size(kernelSize, kernelSize), 0, 0)
        Else
            dst2 = src
        End If
    End Sub
...
Public Class Blur_Gaussian : Inherits VBparent
    ...
    Public Sub Run(src As cv.Mat) ' Rank = 1
        ...
        If kernelSize > 0 Then
            ...
            If standalone Or task.intermediateActive Then CS_BlurGaussian.Run(task.RGBDepth, dst3, kernelSize)
        Else
            dst2 = src
        End If
    End Sub
...
Public Class Blur_Median_CS : Inherits VBparent
    ...
    Public Sub Run(src As cv.Mat) ' Rank = 1
        ...
        If kernelSize > 0 Then
            ...
            If standalone Or task.intermediateActive Then CS_BlurMedian.Run(task.RGBDepth, dst3, kernelSize)
        Else
            dst2 = src
        End If
    End Sub
...
Public Class Blur_Homogeneous : Inherits VBparent
    ...
    Public Sub Run(src As cv.Mat) ' Rank = 1
        ...
        If kernelSize > 0 Then
            ...
            If standalone Or task.intermediateActive Then dst3 = task.RGBDepth.Blur(New cv.Size(kernelSize, kernelSize), New cv.Point(-1, -1))
        Else
            dst2 = src
            dst3 = task.RGBDepth
        End If
...
Public Class Blur_Median : Inherits VBparent
    ...
    Public Sub Run(src As cv.Mat) ' Rank = 1
        ...
        If kernelSize > 0 Then
            ...
            If standalone Or task.intermediateActive Then cv.Cv2.MedianBlur(task.RGBDepth, dst3, kernelSize)
        Else
            dst2 = src
            dst3 = task.RGBDepth
        End If
