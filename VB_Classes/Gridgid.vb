...
Public Class Gridgid_Basics : Inherits VB_Parent
    ...
    Public Sub RunAlg(src As cvb.Mat)
        ...
        If standaloneTest() Then
            ...
            labels(2) = "Gridgid_Basics " + CStr(gridRects.Count) + " (" + CStr(task.gridRows) + "X" + CStr(task.gridCols) + ") " +
...
Public Class Gridgid_BasicsTest : Inherits VB_Parent
    Public Sub New()
        labels = {"", "", "Each grid element is assigned a value below", "The line is the diagonal for each roi.  Bottom might be a shortened roi."}
        If standaloneTest() Then desc = "Validation test for Gridgid_Basics algorithm"
    End Sub
    Public Sub RunAlg(src As cvb.Mat)
...
Public Class Gridgid_List : Inherits VB_Parent
    Public Sub New()
...
Public Class Gridgid_Rectangles : Inherits VB_Parent
    ...
    Public Sub RunAlg(src As cvb.Mat)
        ...
        If standaloneTest() Then
            task.color.CopyTo(dst2)
            dst2.SetTo(cvb.Scalar.White, task.gridMask)
            labels(2) = "Gridgid_Basics " + CStr(task.gridRects.Count) + " (" + CStr(tilesPerRow) + "X" + CStr(tilesPerCol) + ") " +
...
Public Class Gridgid_FPS : Inherits VB_Parent
...
Public Class Gridgid_Neighbors : Inherits VB_Parent
    Dim mask As New cvb.Mat
    Public Sub New()
        labels = {"", "", "Gridgid_Basics output", ""}
...
Public Class Gridgid_Special : Inherits VB_Parent
    ...
    Public Sub New()
        ...
        desc = "Grids are normally square.  Gridgid_Special allows grid elements to be rectangles.  Specify the Y size."
    End Sub
    Public Sub RunAlg(src As cvb.Mat)
        If task.optionsChanged Then
        ...
        If standaloneTest() Then
            ...
            labels(2) = "Gridgid_Basics " + CStr(gridRects.Count) + " (" + CStr(gridRows) + "X" + CStr(gridCols) + ") " +
...
Public Class Gridgid_QuarterRes : Inherits VB_Parent
    Public gridRects As New List(Of cvb.Rect)
...
Public Class Gridgid_MinMaxDepth : Inherits VB_Parent
...
Public Class Gridgid_TrackCenter : Inherits VB_Parent
...
Public Class Gridgid_ShowMap : Inherits VB_Parent
    Public Sub New()
