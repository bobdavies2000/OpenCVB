...
Public Class LineRect_CenterDepth : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        For Each lp In task.lpList
            ...
            Dim index1 = task.gridMap.Get(Of Integer)(pts.Item1.Y, pts.Item1.X)
            Dim index2 = task.gridMap.Get(Of Integer)(pts.Item2.Y, pts.Item2.X)
...
Public Class LineRect_CenterNeighbor : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        Dim depthLines As Integer, colorLines As Integer
        For Each lp In task.lpList
            Dim index = task.gridMap.Get(Of Integer)(lp.center.Y, lp.center.X)
