...
Public Class Quadrant_Basics : Inherits VB_Algorithm
    ...
    Public Sub RunVB(src As cv.Mat)
        Static p1 As New cv.Point, p2 As New cv.Point(dst2.Width - 1, 0), p3 As New cv.Point(0, dst2.Height - 1)
        Static p4 As New cv.Point(dst2.Width - 1, dst2.Height - 1), rect As New cv.Rect, mask As New cv.Mat
