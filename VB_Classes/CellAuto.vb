...
Public Class CellAuto_Basics : Inherits VB_Algorithm
...
Public Class CellAuto_Life : Inherits VB_Algorithm
...
Public Class CellAuto_LifeColor : Inherits VB_Algorithm
...
' http://ptgmedia.pearsoncmg.com/images/0672320665/downloads/The%20Game%20of%20Life.html
Public Class CellAuto_LifePopulation : Inherits VB_Algorithm
...
' https://mathworld.wolfram.com/ElementaryCellularAutomaton.html
Public Class CellAuto_Basics_MT : Inherits VB_Algorithm
...
' https://mathworld.wolfram.com/ElementaryCellularAutomaton.html
Public Class CellAuto_All256 : Inherits VB_Algorithm
    Dim cell As New CellAuto_Basics
    Public Sub New()
...
Public Class CellAuto_MultiPoint : Inherits VB_Algorithm
    Dim cell As New CellAuto_Basics
    Public Sub New()
