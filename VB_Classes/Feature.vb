    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        Select Case task.featureSource
            ...
            Case FeatureSrc.SobelMaxGrid
                Static sobelMax As New Feature_SobelMaxGrid
                sobelMax.Run(src)
...
Public Class Feature_SobelMaxGrid : Inherits TaskParent
...
Public Class Feature_SobelMax : Inherits TaskParent
    Dim sobel As New Edge_SobelQT
    Public features As New List(Of cv.Point)
    Public Sub New()
        dst1 = New cv.Mat(dst1.Size, cv.MatType.CV_8U, 255)
