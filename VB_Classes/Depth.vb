...
Public Class Depth_ErrorEstimate : Inherits TaskParent
    ...
    Public Overrides Sub RunAlg(src As cv.Mat)
        ...
        for each gc in task.gcList
            Dim testError = ErrorEstimate(gc.depth)
            dst1(gc.rect).SetTo(testError)
        Next
        ...
        SetTrueText(Format(ErrorEstimate(task.gcCell.depth), fmt3) + " estimated error" + vbCrLf + Format(task.gcCell.depth, fmt3) + "m",
