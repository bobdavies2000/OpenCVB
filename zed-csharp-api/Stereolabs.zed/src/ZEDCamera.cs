...
namespace sl
{
    ...
    public class Camera
    {
        ...
        */
        ...
        private static uint GetFpsForResolution(RESOLUTION currentResolution)
        {
            if (currentResolution == RESOLUTION.HD1080) return 30;
            else if (currentResolution == RESOLUTION.HD2K) return 15;
            else if (currentResolution == RESOLUTION.HD720) return 60;
            else if (currentResolution == RESOLUTION.VGA) return 100;
            return 30;
        }
        ...
        struct sl_initParameters
        {
            ...
            /// </summary>
            public sl.RESOLUTION CURResolution;
            /// <summary>
        ...
        public InitParameters GetInitParameters()
        {
            ...
            InitParameters parameters = new InitParameters()
            {
                ...
                resolution = sl_parameters.CURResolution,
        ...
        public static sl.ResolutionStruct GetResolution(RESOLUTION currentResolution)
        {
