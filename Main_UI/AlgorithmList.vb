...
Public Class algorithmList
	...
	If algorithmName = "EdgeLines_BasicsOld" Then return new EdgeLines_BasicsOld
	If algorithmName = "EdgeLines_GridCell" Then return new EdgeLines_GridCell
	If algorithmName = "EdgeLines_Image" Then return new EdgeLines_Image
	...
	If algorithmName = "GridROI_Basics" Then return new GridROI_Basics
	If algorithmName = "GridROI_Canny" Then return new GridROI_Canny
	If algorithmName = "GridROI_Color" Then return new GridROI_Color
	If algorithmName = "GridROI_ColorSplit" Then return new GridROI_ColorSplit
	If algorithmName = "GridROI_CorrelationMotion" Then return new GridROI_CorrelationMotion
	If algorithmName = "GridROI_LowStdev" Then return new GridROI_LowStdev
	If algorithmName = "GridROI_LowStdevCorrelation" Then return new GridROI_LowStdevCorrelation
	If algorithmName = "GridROI_LR" Then return new GridROI_LR
	If algorithmName = "GridROI_LRAll" Then return new GridROI_LRAll
	If algorithmName = "GridROI_LRClick" Then return new GridROI_LRClick
	If algorithmName = "GridROI_Sorted" Then return new GridROI_Sorted
	...
	If algorithmName = "RedColor_Largest" Then return new RedColor_Largest
