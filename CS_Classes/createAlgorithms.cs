...
namespace CS_Classes
{
	public class CSAlgorithmList
	{
		public CS_Parent createCSAlgorithm( string algorithmName, VB_Classes.VBtask task)
		{
			...
			if (algorithmName == "BackProject_Basics_CSKeyboard") return new BackProject_Basics_CSKeyboard(task);
			...
			if (algorithmName == "BackProject_Full_CSEqualized") return new BackProject_Full_CSEqualized(task);
			if (algorithmName == "BackProject_Full_CSLines") return new BackProject_Full_CSLines(task);
			...
			if (algorithmName == "BackProject2D_Filter_CSBoth") return new BackProject2D_Filter_CSBoth(task);
			if (algorithmName == "BackProject2D_Filter_CSSide") return new BackProject2D_Filter_CSSide(task);
			if (algorithmName == "BackProject2D_Filter_CSTop") return new BackProject2D_Filter_CSTop(task);
			...
			if (algorithmName == "Benford_JPEG_CS99") return new Benford_JPEG_CS99(task);
			if (algorithmName == "Benford_NormalizedImage_CS") return new Benford_NormalizedImage_CS(task);
			if (algorithmName == "Benford_NormalizedImage_CS99") return new Benford_NormalizedImage_CS99(task);
			...
			if (algorithmName == "BGSubtract_Basics_CS_QT") return new BGSubtract_Basics_CS_QT(task);
			...
			if (algorithmName == "BGSubtract_MOG_CS_Retina") return new BGSubtract_MOG_CS_Retina(task);
			if (algorithmName == "BGSubtract_MOG_CS_RGBDepth") return new BGSubtract_MOG_CS_RGBDepth(task);
			if (algorithmName == "BGSubtract_MOG2_CS") return new BGSubtract_MOG2_CS(task);
			if (algorithmName == "BGSubtract_MOG2_CS_QT") return new BGSubtract_MOG2_CS_QT(task);
			...
			if (algorithmName == "BGSubtract_Synthetic_CPP_CS") return new BGSubtract_Synthetic_CPP_CS(task);
			...
			if (algorithmName == "Bin4Way_UnstablePixels_CS1") return new Bin4Way_UnstablePixels_CS1(task);
			...
			if (algorithmName == "Cell_Basics_CSPlot") return new Cell_Basics_CSPlot(task);
			...
			if (algorithmName == "CellularAutomata_Life_CSColor") return new CellularAutomata_Life_CSColor(task);
			if (algorithmName == "CellularAutomata_Life_CSPopulation") return new CellularAutomata_Life_CSPopulation(task);
			...
			if (algorithmName == "Classifier_Bayesian_CSTest") return new Classifier_Bayesian_CSTest(task);
			...
			if (algorithmName == "Color8U_Complementary_CSTest") return new Color8U_Complementary_CSTest(task);
			...
			if (algorithmName == "Contour_General_CSWithOptions") return new Contour_General_CSWithOptions(task);
			...
			if (algorithmName == "Convex_RedCloud_CSDefects") return new Convex_RedCloud_CSDefects(task);
			if (algorithmName == "Corners_Basics_CS") return new Corners_Basics_CS(task);
			if (algorithmName == "Corners_Basics_CSCentroid") return new Corners_Basics_CSCentroid(task);
			if (algorithmName == "Corners_Basics_CSCentroids") return new Corners_Basics_CSCentroids(task);
			if (algorithmName == "Corners_Basics_CSStablePoints") return new Corners_Basics_CSStablePoints(task);
			...
			if (algorithmName == "Depth_PunchBlob_CSNew") return new Depth_PunchBlob_CSNew(task);
			...
			if (algorithmName == "Depth_StableMin_CSMax") return new Depth_StableMin_CSMax(task);
			...
			if (algorithmName == "Draw_Line_CSTest") return new Draw_Line_CSTest(task);
			...
			if (algorithmName == "Duster_Basics_CSY") return new Duster_Basics_CSY(task);
			...
			if (algorithmName == "Feature_Basics_CSNoFrills") return new Feature_Basics_CSNoFrills(task);
			...
			if (algorithmName == "Feature_Trace_CSDelaunay") return new Feature_Trace_CSDelaunay(task);
			...
			if (algorithmName == "FeaturePoly_Basics_CSOriginal") return new FeaturePoly_Basics_CSOriginal(task);
			...
			if (algorithmName == "FeaturePoly_Image_CSMask") return new FeaturePoly_Image_CSMask(task);
			if (algorithmName == "FeaturePoly_Image_CSNew") return new FeaturePoly_Image_CSNew(task);
			...
			if (algorithmName == "FeaturePoly_Perpendiculars_CSImage") return new FeaturePoly_Perpendiculars_CSImage(task);
			if (algorithmName == "FeaturePoly_Perpendiculars_CSTest") return new FeaturePoly_Perpendiculars_CSTest(task);
			if (algorithmName == "FeaturePoly_Plot_CS") return new FeaturePoly_Plot_CS(task);
			if (algorithmName == "FeaturePoly_Plot_CSWeighted") return new FeaturePoly_Plot_CSWeighted(task);
			...
			if (algorithmName == "FeatureROI_Color_CSSplit") return new FeatureROI_Color_CSSplit(task);
			...
			if (algorithmName == "FeatureROI_LowStdev_CSCorrelation") return new FeatureROI_LowStdev_CSCorrelation(task);
			if (algorithmName == "FeatureROI_LR_CS") return new FeatureROI_LR_CS(task);
			if (algorithmName == "FeatureROI_LR_CSAll") return new FeatureROI_LR_CSAll(task);
			if (algorithmName == "FeatureROI_LR_CSClick") return new FeatureROI_LR_CSClick(task);
			...
			if (algorithmName == "FitLine_Basics_CS3D") return new FitLine_Basics_CS3D(task);
			...
			if (algorithmName == "Flood_Basics_CSMask") return new Flood_Basics_CSMask(task);
			...
			if (algorithmName == "Flood_Motion_CS1") return new Flood_Motion_CS1(task);
			...
			if (algorithmName == "Fractal_Mandelbrot_CSZoom") return new Fractal_Mandelbrot_CSZoom(task);
			if (algorithmName == "Fractal_Mandelbrot_CSZoomColor") return new Fractal_Mandelbrot_CSZoomColor(task);
			if (algorithmName == "FrameRate_Basics_CS") return new FrameRate_Basics_CS(task);
			if (algorithmName == "FrameRate_Basics_CSGray") return new FrameRate_Basics_CSGray(task);
			...
			if (algorithmName == "Fuzzy_TrackerDepth_CSClick") return new Fuzzy_TrackerDepth_CSClick(task);
			...
			if (algorithmName == "Gravity_Basics_CSOriginal") return new Gravity_Basics_CSOriginal(task);
			...
			if (algorithmName == "Grid_Basics_CSTest") return new Grid_Basics_CSTest(task);
			...
			if (algorithmName == "Hist_Gotcha_CSFixed_CPP") return new Hist_Gotcha_CSFixed_CPP(task);
			...
			if (algorithmName == "Hist3D_Pixel_CSCells") return new Hist3D_Pixel_CSCells(task);
			if (algorithmName == "Hist3D_Pixel_CSClassify") return new Hist3D_Pixel_CSClassify(task);
			if (algorithmName == "Hist3D_Pixel_CSDiffMask") return new Hist3D_Pixel_CSDiffMask(task);
			if (algorithmName == "Hist3D_RedCloud_CS") return new Hist3D_RedCloud_CS(task);
			if (algorithmName == "Hist3D_RedCloud_CSGrid") return new Hist3D_RedCloud_CSGrid(task);
			...
			if (algorithmName == "Hist3Dcolor_Basics_CS_CPP") return new Hist3Dcolor_Basics_CS_CPP(task);
			...
			if (algorithmName == "History_Basics_CSDiff") return new History_Basics_CSDiff(task);
			if (algorithmName == "History_Basics_CSNoSaturation") return new History_Basics_CSNoSaturation(task);
			...
			if (algorithmName == "HistValley_Depth_CS1") return new HistValley_Depth_CS1(task);
			...
			if (algorithmName == "Horizon_Basics_CSAlt") return new Horizon_Basics_CSAlt(task);
			...
			if (algorithmName == "Horizon_FindNonZero_CSOld") return new Horizon_FindNonZero_CSOld(task);
			...
			if (algorithmName == "IMU_Basics_CSKalman") return new IMU_Basics_CSKalman(task);
			if (algorithmName == "IMU_Basics_CSWithOptions") return new IMU_Basics_CSWithOptions(task);
			if (algorithmName == "IMU_GMatrix_CS") return new IMU_GMatrix_CS(task);
			if (algorithmName == "IMU_GMatrix_CSWithOptions") return new IMU_GMatrix_CSWithOptions(task);
			...
			if (algorithmName == "KNN_Basics_CSOld") return new KNN_Basics_CSOld(task);
			...
			if (algorithmName == "KNN_Core_CS_CS") return new KNN_Core_CS_CS(task);
			if (algorithmName == "KNN_Core_CS_CS2DTest") return new KNN_Core_CS_CS2DTest(task);
			if (algorithmName == "KNN_Core_CS_CS3D") return new KNN_Core_CS_CS3D(task);
			...
			if (algorithmName == "KNN_Core4D_CSTest") return new KNN_Core4D_CSTest(task);
			if (algorithmName == "KNN_CoreN_CS") return new KNN_CoreN_CS(task);
			if (algorithmName == "KNN_CoreN_CSTest") return new KNN_CoreN_CSTest(task);
			...
			if (algorithmName == "LeftRight_Markers_CS1") return new LeftRight_Markers_CS1(task);
			...
			if (algorithmName == "Mat_Inverse_CS_4D") return new Mat_Inverse_CS_4D(task);
			...
			if (algorithmName == "Match_Basics_CSTest") return new Match_Basics_CSTest(task);
			...
			if (algorithmName == "Match_Point_CSs") return new Match_Point_CSs(task);
			...
			if (algorithmName == "MiniCloud_Rotate_CSAngle") return new MiniCloud_Rotate_CSAngle(task);
			if (algorithmName == "MiniCloud_Rotate_CSSinglePass") return new MiniCloud_Rotate_CSSinglePass(task);
			...
			if (algorithmName == "Motion_Basics_CS_QT") return new Motion_Basics_CS_QT(task);
			if (algorithmName == "Motion_Basics_CSQuarterRes") return new Motion_Basics_CSQuarterRes(task);
			...
			if (algorithmName == "MSER_Basics_CS1") return new MSER_Basics_CS1(task);
			if (algorithmName == "MSER_Basics_CS2") return new MSER_Basics_CS2(task);
			if (algorithmName == "MSER_Basics_CSNew") return new MSER_Basics_CSNew(task);
			...
			if (algorithmName == "OEX_BasicLinearTransforms_CSTrackBar") return new OEX_BasicLinearTransforms_CSTrackBar(task);
			...
			if (algorithmName == "OEX_PointPolygon_CS_demo") return new OEX_PointPolygon_CS_demo(task);
			...
			if (algorithmName == "OEX_Threshold_CS_Inrange") return new OEX_Threshold_CS_Inrange(task);
			...
			if (algorithmName == "OpAuto_Peaks2D_CSGrid") return new OpAuto_Peaks2D_CSGrid(task);
			...
			if (algorithmName == "OpenGL_Basics_CSMouse") return new OpenGL_Basics_CSMouse(task);
			if (algorithmName == "OpenGL_Basics_CSSliders") return new OpenGL_Basics_CSSliders(task);
			...
			if (algorithmName == "OpenGL_DrawHull_CSs") return new OpenGL_DrawHull_CSs(task);
			if (algorithmName == "OpenGL_Duster_CS") return new OpenGL_Duster_CS(task);
			if (algorithmName == "OpenGL_Duster_CSY") return new OpenGL_Duster_CSY(task);
			...
			if (algorithmName == "OpenGL_PCpoints_CSPlane") return new OpenGL_PCpoints_CSPlane(task);
			...
			if (algorithmName == "OpenGL_Profile_CSSweep") return new OpenGL_Profile_CSSweep(task);
			...
			if (algorithmName == "OpenGL_RedCloud_CSCell") return new OpenGL_RedCloud_CSCell(task);
			if (algorithmName == "OpenGL_RedCloud_CSSpectrum") return new OpenGL_RedCloud_CSSpectrum(task);
			...
			if (algorithmName == "OpenGL_Tessellate_CSRGB") return new OpenGL_Tessellate_CSRGB(task);
			...
			if (algorithmName == "OpenGL_Tiles_CSQuad") return new OpenGL_Tiles_CSQuad(task);
			...
			if (algorithmName == "Palette_Random_CSColorMap") return new Palette_Random_CSColorMap(task);
			...
			if (algorithmName == "PCA_NColor_CS_CPP") return new PCA_NColor_CS_CPP(task);
			if (algorithmName == "PCA_NColor_CSPalettize") return new PCA_NColor_CSPalettize(task);
			...
			if (algorithmName == "PhaseCorrelate_Basics_CSTest") return new PhaseCorrelate_Basics_CSTest(task);
			...
			if (algorithmName == "Plot_Basics_CS_CPP") return new Plot_Basics_CS_CPP(task);
			...
			if (algorithmName == "Plot_OverTime_CSFixedScale") return new Plot_OverTime_CSFixedScale(task);
			...
			if (algorithmName == "PointCloud_PCPoints_CSPlane") return new PointCloud_PCPoints_CSPlane(task);
			...
			if (algorithmName == "Puzzle_Solver_CSDynamic") return new Puzzle_Solver_CSDynamic(task);
			...
			if (algorithmName == "Random_Basics_CS3D") return new Random_Basics_CS3D(task);
			if (algorithmName == "Random_Basics_CS4D") return new Random_Basics_CS4D(task);
			if (algorithmName == "Random_CheckNormalDist_CS") return new Random_CheckNormalDist_CS(task);
			if (algorithmName == "Random_CheckNormalDist_CSSmoothed") return new Random_CheckNormalDist_CSSmoothed(task);
			...
			if (algorithmName == "Random_StaticTV_CSFaster") return new Random_StaticTV_CSFaster(task);
			if (algorithmName == "Random_StaticTV_CSFastSimple") return new Random_StaticTV_CSFastSimple(task);
			...
			if (algorithmName == "RedCloud_MaxDist_CS_CPP") return new RedCloud_MaxDist_CS_CPP(task);
			...
			if (algorithmName == "RedCloud_Tiers_CSBinarize") return new RedCloud_Tiers_CSBinarize(task);
			if (algorithmName == "RedCloud_TopX_CS") return new RedCloud_TopX_CS(task);
			if (algorithmName == "RedCloud_TopX_CSHulls") return new RedCloud_TopX_CSHulls(task);
			if (algorithmName == "RedCloud_TopX_CSNeighbors") return new RedCloud_TopX_CSNeighbors(task);
			...
			if (algorithmName == "RedTrack_GoodCell_CSInput") return new RedTrack_GoodCell_CSInput(task);
			if (algorithmName == "RedTrack_GoodCell_CSs") return new RedTrack_GoodCell_CSs(task);
			...
			if (algorithmName == "Rotate_Basics_CSQT") return new Rotate_Basics_CSQT(task);
			...
			if (algorithmName == "Rotate_Poly_CSQT") return new Rotate_Poly_CSQT(task);
			...
			if (algorithmName == "Stabilizer_Basics_CSRandomInput") return new Stabilizer_Basics_CSRandomInput(task);
			if (algorithmName == "Stabilizer_Basics_CSTest") return new Stabilizer_Basics_CSTest(task);
			...
			if (algorithmName == "Stable_Basics_CSCount") return new Stable_Basics_CSCount(task);
			...
			if (algorithmName == "Structured_CountSide_CSSum") return new Structured_CountSide_CSSum(task);
			...
			if (algorithmName == "Structured_MultiSlice_CSH") return new Structured_MultiSlice_CSH(task);
			if (algorithmName == "Structured_MultiSlice_CSLines") return new Structured_MultiSlice_CSLines(task);
			if (algorithmName == "Structured_MultiSlice_CSPolygon") return new Structured_MultiSlice_CSPolygon(task);
			if (algorithmName == "Structured_MultiSlice_CSV") return new Structured_MultiSlice_CSV(task);
			...
			if (algorithmName == "SuperPixel_Basics_CS_CPP") return new SuperPixel_Basics_CS_CPP(task);
			...
			if (algorithmName == "SVD_Example_CS2") return new SVD_Example_CS2(task);
			...
			if (algorithmName == "Swarm_Flood_CS2") return new Swarm_Flood_CS2(task);
			if (algorithmName == "Swarm_Flood_CS3") return new Swarm_Flood_CS3(task);
			...
			if (algorithmName == "Texture_Flow_CS_Depth") return new Texture_Flow_CS_Depth(task);
			if (algorithmName == "Texture_Flow_CS_Reduction") return new Texture_Flow_CS_Reduction(task);
			...
			if (algorithmName == "Threading_Test_CS1") return new Threading_Test_CS1(task);
			...
			if (algorithmName == "WarpAffine_Basics_CSQT") return new WarpAffine_Basics_CSQT(task);
			...
			if (algorithmName == "WarpAffine_Repeated_CSExample8") return new WarpAffine_Repeated_CSExample8(task);
			...
			if (algorithmName == "XPhoto_Bm3dDenoise_CSDepthImage") return new XPhoto_Bm3dDenoise_CSDepthImage(task);
			if (algorithmName == "XPhoto_Inpaint_CS") return new XPhoto_Inpaint_CS(task);
			if (algorithmName == "XPhoto_Inpaint_CS_CPP") return new XPhoto_Inpaint_CS_CPP(task);
