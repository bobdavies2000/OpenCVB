...
namespace CS_Classes
{
	public class CSAlgorithmList
	{
		public CS_Parent createCSAlgorithm( string algorithmName, VB_Classes.VBtask task)
		{
			...
			if (algorithmName == "CS_OpenGL_TextureShuffle") return new CS_OpenGL_TextureShuffle(task);
			...
			if (algorithmName == "CS_Resize_Basics") return new CS_Resize_Basics(task);
			if (algorithmName == "CS_Resize_Preserve") return new CS_Resize_Preserve(task);
			if (algorithmName == "CS_Resize_Proportional") return new CS_Resize_Proportional(task);
			if (algorithmName == "CS_Resize_Smaller") return new CS_Resize_Smaller(task);
			if (algorithmName == "CS_Retina_Basics_CPP") return new CS_Retina_Basics_CPP(task);
			if (algorithmName == "CS_Retina_Depth") return new CS_Retina_Depth(task);
			if (algorithmName == "CS_ROI_Accumulate") return new CS_ROI_Accumulate(task);
			if (algorithmName == "CS_ROI_AccumulateOld") return new CS_ROI_AccumulateOld(task);
			if (algorithmName == "CS_ROI_Basics") return new CS_ROI_Basics(task);
			if (algorithmName == "CS_ROI_FindNonZeroNoSingle") return new CS_ROI_FindNonZeroNoSingle(task);
			if (algorithmName == "CS_Rotate_Basics") return new CS_Rotate_Basics(task);
			if (algorithmName == "CS_Rotate_BasicsQT") return new CS_Rotate_BasicsQT(task);
			if (algorithmName == "CS_Rotate_Box") return new CS_Rotate_Box(task);
			if (algorithmName == "CS_Rotate_Example") return new CS_Rotate_Example(task);
			if (algorithmName == "CS_Rotate_Horizon") return new CS_Rotate_Horizon(task);
			if (algorithmName == "CS_Rotate_Poly") return new CS_Rotate_Poly(task);
			if (algorithmName == "CS_Rotate_PolyQT") return new CS_Rotate_PolyQT(task);
			if (algorithmName == "CS_Salience_Basics_CPP") return new CS_Salience_Basics_CPP(task);
			if (algorithmName == "CS_Salience_Basics_MT") return new CS_Salience_Basics_MT(task);
			if (algorithmName == "CS_Sides_Basics") return new CS_Sides_Basics(task);
			if (algorithmName == "CS_Sides_ColorC") return new CS_Sides_ColorC(task);
			if (algorithmName == "CS_Sides_Corner") return new CS_Sides_Corner(task);
			if (algorithmName == "CS_Sides_Profile") return new CS_Sides_Profile(task);
			if (algorithmName == "CS_Sieve_Basics") return new CS_Sieve_Basics(task);
			if (algorithmName == "CS_Sieve_Image") return new CS_Sieve_Image(task);
			if (algorithmName == "CS_SLR_Basics") return new CS_SLR_Basics(task);
			if (algorithmName == "CS_SLR_Data") return new CS_SLR_Data(task);
			...
			if (algorithmName == "CS_SLR_SurfaceH") return new CS_SLR_SurfaceH(task);
			if (algorithmName == "CS_SLR_TrendCompare") return new CS_SLR_TrendCompare(task);
			if (algorithmName == "CS_SLR_TrendImages") return new CS_SLR_TrendImages(task);
			if (algorithmName == "CS_SLR_Trends") return new CS_SLR_Trends(task);
			if (algorithmName == "CS_Smoothing_Exterior") return new CS_Smoothing_Exterior(task);
			if (algorithmName == "CS_Smoothing_Interior") return new CS_Smoothing_Interior(task);
			if (algorithmName == "CS_Solve_ByArray") return new CS_Solve_ByArray(task);
			if (algorithmName == "CS_Solve_ByMat") return new CS_Solve_ByMat(task);
			if (algorithmName == "CS_Sort_1Channel") return new CS_Sort_1Channel(task);
			if (algorithmName == "CS_Sort_3Channel") return new CS_Sort_3Channel(task);
			if (algorithmName == "CS_Sort_Basics") return new CS_Sort_Basics(task);
			if (algorithmName == "CS_Sort_FeatureLess") return new CS_Sort_FeatureLess(task);
			if (algorithmName == "CS_Sort_GrayScale") return new CS_Sort_GrayScale(task);
			if (algorithmName == "CS_Sort_GrayScale1") return new CS_Sort_GrayScale1(task);
			if (algorithmName == "CS_Sort_Integer") return new CS_Sort_Integer(task);
			if (algorithmName == "CS_Sort_MLPrepTest_CPP") return new CS_Sort_MLPrepTest_CPP(task);
			if (algorithmName == "CS_Sort_RectAndMask") return new CS_Sort_RectAndMask(task);
			if (algorithmName == "CS_Spectrum_Basics") return new CS_Spectrum_Basics(task);
			if (algorithmName == "CS_Spectrum_Breakdown") return new CS_Spectrum_Breakdown(task);
			if (algorithmName == "CS_Spectrum_CellZoom") return new CS_Spectrum_CellZoom(task);
			if (algorithmName == "CS_Spectrum_Cloud") return new CS_Spectrum_Cloud(task);
			if (algorithmName == "CS_Spectrum_Gray") return new CS_Spectrum_Gray(task);
			if (algorithmName == "CS_Spectrum_GrayAndCloud") return new CS_Spectrum_GrayAndCloud(task);
			if (algorithmName == "CS_Spectrum_Mask") return new CS_Spectrum_Mask(task);
			if (algorithmName == "CS_Spectrum_RedCloud") return new CS_Spectrum_RedCloud(task);
			if (algorithmName == "CS_Spectrum_RGB") return new CS_Spectrum_RGB(task);
			if (algorithmName == "CS_Spectrum_X") return new CS_Spectrum_X(task);
			if (algorithmName == "CS_Spectrum_Y") return new CS_Spectrum_Y(task);
			if (algorithmName == "CS_Spectrum_Z") return new CS_Spectrum_Z(task);
			if (algorithmName == "CS_Stabilizer_Basics") return new CS_Stabilizer_Basics(task);
			if (algorithmName == "CS_Stabilizer_BasicsRandomInput") return new CS_Stabilizer_BasicsRandomInput(task);
			if (algorithmName == "CS_Stabilizer_BasicsTest") return new CS_Stabilizer_BasicsTest(task);
			if (algorithmName == "CS_Stabilizer_CornerPoints") return new CS_Stabilizer_CornerPoints(task);
			if (algorithmName == "CS_Stabilizer_OpticalFlow") return new CS_Stabilizer_OpticalFlow(task);
			if (algorithmName == "CS_Stabilizer_VerticalIMU") return new CS_Stabilizer_VerticalIMU(task);
			if (algorithmName == "CS_Stable_Basics") return new CS_Stable_Basics(task);
			if (algorithmName == "CS_Stable_BasicsCount") return new CS_Stable_BasicsCount(task);
			if (algorithmName == "CS_Stable_FAST") return new CS_Stable_FAST(task);
			if (algorithmName == "CS_Stable_GoodFeatures") return new CS_Stable_GoodFeatures(task);
			if (algorithmName == "CS_Stable_Lines") return new CS_Stable_Lines(task);
			if (algorithmName == "CS_Stitch_Basics") return new CS_Stitch_Basics(task);
			if (algorithmName == "CS_Structured_Cloud") return new CS_Structured_Cloud(task);
			if (algorithmName == "CS_Structured_Cloud2") return new CS_Structured_Cloud2(task);
			if (algorithmName == "CS_Structured_CountSide") return new CS_Structured_CountSide(task);
			if (algorithmName == "CS_Structured_CountSideSum") return new CS_Structured_CountSideSum(task);
			if (algorithmName == "CS_Structured_CountTop") return new CS_Structured_CountTop(task);
			if (algorithmName == "CS_Structured_Crosshairs") return new CS_Structured_Crosshairs(task);
			if (algorithmName == "CS_Structured_Depth") return new CS_Structured_Depth(task);
			if (algorithmName == "CS_Structured_FeatureLines") return new CS_Structured_FeatureLines(task);
			if (algorithmName == "CS_Structured_FloorCeiling") return new CS_Structured_FloorCeiling(task);
			if (algorithmName == "CS_Structured_LinearizeFloor") return new CS_Structured_LinearizeFloor(task);
			if (algorithmName == "CS_Structured_MouseSlice") return new CS_Structured_MouseSlice(task);
			if (algorithmName == "CS_Structured_MultiSlice") return new CS_Structured_MultiSlice(task);
			if (algorithmName == "CS_Structured_MultiSliceH") return new CS_Structured_MultiSliceH(task);
			if (algorithmName == "CS_Structured_MultiSliceLines") return new CS_Structured_MultiSliceLines(task);
			if (algorithmName == "CS_Structured_MultiSlicePolygon") return new CS_Structured_MultiSlicePolygon(task);
			if (algorithmName == "CS_Structured_MultiSliceV") return new CS_Structured_MultiSliceV(task);
			if (algorithmName == "CS_Structured_Rebuild") return new CS_Structured_Rebuild(task);
			if (algorithmName == "CS_Structured_ROI") return new CS_Structured_ROI(task);
			if (algorithmName == "CS_Structured_SliceEither") return new CS_Structured_SliceEither(task);
			if (algorithmName == "CS_Structured_SliceH") return new CS_Structured_SliceH(task);
			if (algorithmName == "CS_Structured_SliceV") return new CS_Structured_SliceV(task);
			if (algorithmName == "CS_Structured_SliceXPlot") return new CS_Structured_SliceXPlot(task);
			if (algorithmName == "CS_Structured_SliceYPlot") return new CS_Structured_SliceYPlot(task);
			if (algorithmName == "CS_Structured_SurveyH") return new CS_Structured_SurveyH(task);
			if (algorithmName == "CS_Structured_SurveyV") return new CS_Structured_SurveyV(task);
			if (algorithmName == "CS_Structured_Tiles") return new CS_Structured_Tiles(task);
			if (algorithmName == "CS_Structured_TransformH") return new CS_Structured_TransformH(task);
			if (algorithmName == "CS_Structured_TransformV") return new CS_Structured_TransformV(task);
			if (algorithmName == "CS_SuperPixel_Basics") return new CS_SuperPixel_Basics(task);
			if (algorithmName == "CS_SuperPixel_Basics_CPP") return new CS_SuperPixel_Basics_CPP(task);
			if (algorithmName == "CS_SuperPixel_BinarizedImage") return new CS_SuperPixel_BinarizedImage(task);
			if (algorithmName == "CS_SuperPixel_Depth") return new CS_SuperPixel_Depth(task);
			if (algorithmName == "CS_SuperPixel_WithCanny") return new CS_SuperPixel_WithCanny(task);
			if (algorithmName == "CS_SuperPixel_WithLineDetector") return new CS_SuperPixel_WithLineDetector(task);
			if (algorithmName == "CS_SuperRes_Basics") return new CS_SuperRes_Basics(task);
			if (algorithmName == "CS_SuperRes_Input") return new CS_SuperRes_Input(task);
			if (algorithmName == "CS_SuperRes_SubPixelZoom") return new CS_SuperRes_SubPixelZoom(task);
			if (algorithmName == "CS_SVD_Example") return new CS_SVD_Example(task);
			if (algorithmName == "CS_SVD_Example2") return new CS_SVD_Example2(task);
			if (algorithmName == "CS_SVD_Gaussian") return new CS_SVD_Gaussian(task);
			if (algorithmName == "CS_SVM_Basics") return new CS_SVM_Basics(task);
			if (algorithmName == "CS_SVM_ReuseBasics") return new CS_SVM_ReuseBasics(task);
			if (algorithmName == "CS_SVM_ReuseRandom") return new CS_SVM_ReuseRandom(task);
			if (algorithmName == "CS_SVM_SampleData") return new CS_SVM_SampleData(task);
			if (algorithmName == "CS_SVM_TestCase") return new CS_SVM_TestCase(task);
			if (algorithmName == "CS_Swarm_Basics") return new CS_Swarm_Basics(task);
			if (algorithmName == "CS_Swarm_Flood") return new CS_Swarm_Flood(task);
			if (algorithmName == "CS_Swarm_Flood2") return new CS_Swarm_Flood2(task);
			if (algorithmName == "CS_Swarm_Flood3") return new CS_Swarm_Flood3(task);
			if (algorithmName == "CS_Swarm_LeftRight") return new CS_Swarm_LeftRight(task);
			if (algorithmName == "CS_Swarm_LeftRightFeatures") return new CS_Swarm_LeftRightFeatures(task);
			if (algorithmName == "CS_Swarm_Percentage") return new CS_Swarm_Percentage(task);
			if (algorithmName == "CS_Tessallate_Basics") return new CS_Tessallate_Basics(task);
			if (algorithmName == "CS_Tessallate_Bricks") return new CS_Tessallate_Bricks(task);
			if (algorithmName == "CS_Tessallate_QuadHulls") return new CS_Tessallate_QuadHulls(task);
			if (algorithmName == "CS_Tessallate_QuadMinMax") return new CS_Tessallate_QuadMinMax(task);
			if (algorithmName == "CS_Tessallate_QuadSimple") return new CS_Tessallate_QuadSimple(task);
			if (algorithmName == "CS_Tessallate_Triangles") return new CS_Tessallate_Triangles(task);
			if (algorithmName == "CS_Texture_Basics") return new CS_Texture_Basics(task);
			if (algorithmName == "CS_Texture_Flow") return new CS_Texture_Flow(task);
			if (algorithmName == "CS_Texture_Flow_Depth") return new CS_Texture_Flow_Depth(task);
			if (algorithmName == "CS_Texture_Flow_Reduction") return new CS_Texture_Flow_Reduction(task);
			if (algorithmName == "CS_Thickness_Basics") return new CS_Thickness_Basics(task);
			if (algorithmName == "CS_Threading_Test") return new CS_Threading_Test(task);
			if (algorithmName == "CS_Threading_Test1") return new CS_Threading_Test1(task);
