...
Module UI_Generator
    ...
    Sub Main(args As String())
        ...
        Try
            ...
            Dim hiddenDir As New DirectoryInfo(HomeDir.FullName + "Main_UI\ZListOfAlgorithms\")
            If hiddenDir.Exists = False Then hiddenDir.Create()
            Dim mainInfo As New FileInfo(HomeDir.FullName + "Main_UI\hidden\ZAlgorithmList.vb")
            ...
            sw.WriteLine("Public Class ZalgorithmList")
