...
Module UI_GeneratorMain
    Sub Main()
        ...
        Dim CS_CPPCLR_Inputs = {New FileInfo(HomeDir.FullName + "CPP_Classes/CPP_Classes.cpp").FullName,
                                New FileInfo(HomeDir.FullName + "CS_Classes/CS_AI_Generated.cs").FullName,
                ...
                While nextFile.Peek() <> -1
                    ...
                    If line.Length > 1 Then
                        If line.Substring(0, 2) <> "//" Then
                            CodeLineCount += 1
                            If LCase(line).StartsWith("public class ") Or line.Contains("public CPP_Parent") Or
                                line.Contains("public ref class") Then
