...
Module UI_GeneratorMain
    Sub Main()
        ...
        While readProj.EndOfStream = False
            ...
            If Trim(line).StartsWith("<Compile Include=") Then
                If InStr(line, ".vb""") Then
                    ...
                    If line.Contains("cppAlgorithms.vb") = False And line.Contains("My Project") = False Then fileNames.Add(VBcodeDir.FullName + line)
                End If
            End If
        End While
        readProj.Close()
        ...
        Dim listInfo As New FileInfo(VBcodeDir.FullName + "../UI_Generator/cppAlgorithms.vb")
        ...
        sw.WriteLine("Public Class cppAlgorithms")
        ...
        Dim textInfo As New FileInfo(VBcodeDir.FullName + "/../Data/cppAlgorithms.txt")
