...
Module UI_GeneratorMain
    Sub Main()
        ...
        sw.WriteLine("Public Function createCSAlgorithm( algorithmName as string) As CS_Parent")
        'sw.WriteLine("If algorithmName = ""AddWeighted_Basics_CS"" Then Return New AddWeighted_Basics_CS")
        sw.WriteLine("Return New AddWeighted_Basics_CS")
