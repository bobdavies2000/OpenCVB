...
Module UI_Generator
    ...
    Sub Main(args As String())
        ...
        Dim srcList As New List(Of String)({HomeDir.FullName + "CPP_Native/CPP_NativeClasses.h", ' all the native C++ code
        ...
        Try
            ...
            Dim swNet8 = New StreamWriter(HomeDir.FullName + "Main\AlgorithmList.vb")
            swNet8.WriteLine("' this file is automatically generated in a pre-build step.  Any manual modifications will be lost.")
            swNet8.WriteLine("Imports VBClasses")
            ...
            swNet8.WriteLine("Public Class algorithmList")

            sw.WriteLine(vbTab + "Public Function createAlgorithm(algorithmName as string) as Object")
            swNet8.WriteLine(vbTab + "Public Function createAlgorithm(algorithmName as string) as Object")
