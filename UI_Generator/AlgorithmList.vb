...
CPP_AddWeighted_Basics
CPP_Motion_Core
CPP_Histogram_Kalman
CPP_Kalman_Basics
CPP_RedCloud_Core
CPP_FPoly_TopFeatures
CPP_Random_Enumerable
CPP_Bezier_Basics
CPP_Feature_Agast
CPP_Resize_Basics
CPP_Delaunay_Basics
CPP_Delaunay_GenerationsNoKNN
CPP_KNN_Basics
CPP_Random_Basics
CPP_KNN_Lossy
CPP_Delaunay_Generations
CPP_Stable_Basics
CPP_Feature_Basics
CPP_Remap_Basics
CPP_Edge_Canny
...
CPP_IMU_GMatrix
CPP_IMU_GMatrix_QT
CPP_Depth_PointCloud_IMU
CPP_Binarize_Simple
CPP_Plot_Histogram
CPP_Histogram_Basics
CPP_BackProject_Basics
CPP_Rectangle_Basics
CPP_Rectangle_Rotated
CPP_Contour_Largest
CPP_Diff_Basics
CPP_ApproxPoly_FindandDraw
CPP_ApproxPoly_Basics
CPP_Hull_Basics
CPP_ApproxPoly_Hull
CPP_Edge_Segments
CPP_Motion_Basics
CPP_Edge_MotionAccum
CPP_Edge_MotionFrames
CPP_EdgePreserving_Basics
CPP_EdgeDraw_Basics
CPP_TEE_Basics
CPP_RedCloud_Hulls
CPP_Distance_Basics
CPP_FeatureLess_Basics
CPP_FeatureLess_Edge
CPP_RedCloud_FeatureLess2
CPP_Stable_BasicsCount
End Enum
...
if algorithmName = "CPP_AddWeighted_Basics" Then return new CPP_Basics(functionNames.CPP_AddWeighted_Basics)
if algorithmName = "CPP_ApproxPoly_Basics" Then return new CPP_Basics(functionNames.CPP_ApproxPoly_Basics)
if algorithmName = "CPP_ApproxPoly_FindandDraw" Then return new CPP_Basics(functionNames.CPP_ApproxPoly_FindandDraw)
if algorithmName = "CPP_ApproxPoly_Hull" Then return new CPP_Basics(functionNames.CPP_ApproxPoly_Hull)
if algorithmName = "CPP_BackProject_Basics" Then return new CPP_Basics(functionNames.CPP_BackProject_Basics)
if algorithmName = "CPP_Bezier_Basics" Then return new CPP_Basics(functionNames.CPP_Bezier_Basics)
if algorithmName = "CPP_Binarize_Simple" Then return new CPP_Basics(functionNames.CPP_Binarize_Simple)
if algorithmName = "CPP_Contour_Largest" Then return new CPP_Basics(functionNames.CPP_Contour_Largest)
if algorithmName = "CPP_Delaunay_Basics" Then return new CPP_Basics(functionNames.CPP_Delaunay_Basics)
if algorithmName = "CPP_Delaunay_Generations" Then return new CPP_Basics(functionNames.CPP_Delaunay_Generations)
if algorithmName = "CPP_Delaunay_GenerationsNoKNN" Then return new CPP_Basics(functionNames.CPP_Delaunay_GenerationsNoKNN)
if algorithmName = "CPP_Depth_Colorizer" Then return new CPP_Basics(functionNames.CPP_Depth_Colorizer)
if algorithmName = "CPP_Depth_PointCloud" Then return new CPP_Basics(functionNames.CPP_Depth_PointCloud)
if algorithmName = "CPP_Depth_PointCloud_IMU" Then return new CPP_Basics(functionNames.CPP_Depth_PointCloud_IMU)
if algorithmName = "CPP_Diff_Basics" Then return new CPP_Basics(functionNames.CPP_Diff_Basics)
if algorithmName = "CPP_Distance_Basics" Then return new CPP_Basics(functionNames.CPP_Distance_Basics)
if algorithmName = "CPP_Edge_Canny" Then return new CPP_Basics(functionNames.CPP_Edge_Canny)
if algorithmName = "CPP_Edge_MotionAccum" Then return new CPP_Basics(functionNames.CPP_Edge_MotionAccum)
if algorithmName = "CPP_Edge_MotionFrames" Then return new CPP_Basics(functionNames.CPP_Edge_MotionFrames)
if algorithmName = "CPP_Edge_Scharr" Then return new CPP_Basics(functionNames.CPP_Edge_Scharr)
if algorithmName = "CPP_Edge_Segments" Then return new CPP_Basics(functionNames.CPP_Edge_Segments)
if algorithmName = "CPP_Edge_Sobel" Then return new CPP_Basics(functionNames.CPP_Edge_Sobel)
if algorithmName = "CPP_EdgeDraw_Basics" Then return new CPP_Basics(functionNames.CPP_EdgeDraw_Basics)
if algorithmName = "CPP_EdgePreserving_Basics" Then return new CPP_Basics(functionNames.CPP_EdgePreserving_Basics)
if algorithmName = "CPP_Feature_Agast" Then return new CPP_Basics(functionNames.CPP_Feature_Agast)
if algorithmName = "CPP_Feature_Basics" Then return new CPP_Basics(functionNames.CPP_Feature_Basics)
if algorithmName = "CPP_FeatureLess_Basics" Then return new CPP_Basics(functionNames.CPP_FeatureLess_Basics)
if algorithmName = "CPP_FeatureLess_Edge" Then return new CPP_Basics(functionNames.CPP_FeatureLess_Edge)
if algorithmName = "CPP_FPoly_TopFeatures" Then return new CPP_Basics(functionNames.CPP_FPoly_TopFeatures)
if algorithmName = "CPP_Grid_Basics" Then return new CPP_Basics(functionNames.CPP_Grid_Basics)
if algorithmName = "CPP_Histogram_Basics" Then return new CPP_Basics(functionNames.CPP_Histogram_Basics)
if algorithmName = "CPP_Histogram_Kalman" Then return new CPP_Basics(functionNames.CPP_Histogram_Kalman)
if algorithmName = "CPP_Hull_Basics" Then return new CPP_Basics(functionNames.CPP_Hull_Basics)
if algorithmName = "CPP_IMU_GMatrix" Then return new CPP_Basics(functionNames.CPP_IMU_GMatrix)
if algorithmName = "CPP_IMU_GMatrix_QT" Then return new CPP_Basics(functionNames.CPP_IMU_GMatrix_QT)
if algorithmName = "CPP_Kalman_Basics" Then return new CPP_Basics(functionNames.CPP_Kalman_Basics)
if algorithmName = "CPP_KNN_Basics" Then return new CPP_Basics(functionNames.CPP_KNN_Basics)
if algorithmName = "CPP_KNN_Lossy" Then return new CPP_Basics(functionNames.CPP_KNN_Lossy)
if algorithmName = "CPP_Mat_4to1" Then return new CPP_Basics(functionNames.CPP_Mat_4to1)
if algorithmName = "CPP_Motion_Basics" Then return new CPP_Basics(functionNames.CPP_Motion_Basics)
if algorithmName = "CPP_Motion_Core" Then return new CPP_Basics(functionNames.CPP_Motion_Core)
if algorithmName = "CPP_Plot_Histogram" Then return new CPP_Basics(functionNames.CPP_Plot_Histogram)
if algorithmName = "CPP_Random_Basics" Then return new CPP_Basics(functionNames.CPP_Random_Basics)
if algorithmName = "CPP_Random_Enumerable" Then return new CPP_Basics(functionNames.CPP_Random_Enumerable)
if algorithmName = "CPP_Rectangle_Basics" Then return new CPP_Basics(functionNames.CPP_Rectangle_Basics)
if algorithmName = "CPP_Rectangle_Rotated" Then return new CPP_Basics(functionNames.CPP_Rectangle_Rotated)
if algorithmName = "CPP_RedCloud_Core" Then return new CPP_Basics(functionNames.CPP_RedCloud_Core)
if algorithmName = "CPP_RedCloud_FeatureLess2" Then return new CPP_Basics(functionNames.CPP_RedCloud_FeatureLess2)
if algorithmName = "CPP_RedCloud_Flood" Then return new CPP_Basics(functionNames.CPP_RedCloud_Flood)
if algorithmName = "CPP_RedCloud_Hulls" Then return new CPP_Basics(functionNames.CPP_RedCloud_Hulls)
if algorithmName = "CPP_Remap_Basics" Then return new CPP_Basics(functionNames.CPP_Remap_Basics)
if algorithmName = "CPP_Resize_Basics" Then return new CPP_Basics(functionNames.CPP_Resize_Basics)
if algorithmName = "CPP_Stable_Basics" Then return new CPP_Basics(functionNames.CPP_Stable_Basics)
if algorithmName = "CPP_Stable_BasicsCount" Then return new CPP_Basics(functionNames.CPP_Stable_BasicsCount)
if algorithmName = "CPP_TEE_Basics" Then return new CPP_Basics(functionNames.CPP_TEE_Basics)
