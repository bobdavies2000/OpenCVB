...
if algorithmName = "Duster_Kalman" Then return new Duster_Kalman
if algorithmName = "Duster_Mask" Then return new Duster_Mask
...
if algorithmName = "OpenGL_DusterKalman" Then return new OpenGL_DusterKalman
