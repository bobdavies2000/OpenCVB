...
if algorithmName = "KMeans_SimulatedCloud" Then return new KMeans_SimulatedCloud
if algorithmName = "KMeans_SimulatedColor" Then return new KMeans_SimulatedColor
