...
if algorithmName = "Binarize_TiersCM" Then return new Binarize_TiersCM
...
if algorithmName = "Neighbor_Mask" Then return new Neighbor_Mask
if algorithmName = "Neighbor_MaskTest" Then return new Neighbor_MaskTest
