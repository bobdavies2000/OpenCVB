...
if algorithmName = "Edge_DepthLaplacian" Then return new Edge_DepthLaplacian
if algorithmName = "Edge_DepthSobel" Then return new Edge_DepthSobel
...
if algorithmName = "Options_DepthSobel" Then return new Options_DepthSobel
