...
if algorithmName = "CPP_AddWeighted_Basics" Then return new CPP_Basics(functionNames.CPP_AddWeighted_Basics_)
if algorithmName = "CPP_ApproxPoly_Basics" Then return new CPP_Basics(functionNames.CPP_ApproxPoly_Basics_)
...
if algorithmName = "CPP_Delaunay_Generations" Then return new CPP_Basics(functionNames.CPP_Delaunay_Generations_)
if algorithmName = "CPP_Delaunay_GenerationsNoKNN" Then return new CPP_Basics(functionNames.CPP_Delaunay_GenerationsNoKNN_)
if algorithmName = "CPP_Depth_Colorizer" Then return new CPP_Basics(functionNames.CPP_Depth_Colorizer_)
if algorithmName = "CPP_Depth_PointCloud" Then return new CPP_Basics(functionNames.CPP_Depth_PointCloud_)
if algorithmName = "CPP_Depth_PointCloud_IMU" Then return new CPP_Basics(functionNames.CPP_Depth_PointCloud_IMU_)
if algorithmName = "CPP_Diff_Basics" Then return new CPP_Basics(functionNames.CPP_Diff_Basics_)
if algorithmName = "CPP_Distance_Basics" Then return new CPP_Basics(functionNames.CPP_Distance_Basics_)
if algorithmName = "CPP_Edge_Canny" Then return new CPP_Basics(functionNames.CPP_Edge_Canny_)
if algorithmName = "CPP_Edge_MotionAccum" Then return new CPP_Basics(functionNames.CPP_Edge_MotionAccum_)
if algorithmName = "CPP_Edge_MotionFrames" Then return new CPP_Basics(functionNames.CPP_Edge_MotionFrames_)
if algorithmName = "CPP_Edge_Scharr" Then return new CPP_Basics(functionNames.CPP_Edge_Scharr_)
if algorithmName = "CPP_Edge_Segments" Then return new CPP_Basics(functionNames.CPP_Edge_Segments_)
if algorithmName = "CPP_Edge_Sobel" Then return new CPP_Basics(functionNames.CPP_Edge_Sobel_)
if algorithmName = "CPP_EdgeDraw_Basics" Then return new CPP_Basics(functionNames.CPP_EdgeDraw_Basics_)
if algorithmName = "CPP_EdgePreserving_Basics" Then return new CPP_Basics(functionNames.CPP_EdgePreserving_Basics_)
if algorithmName = "CPP_Feature_Agast" Then return new CPP_Basics(functionNames.CPP_Feature_Agast_)
...
if algorithmName = "CPP_Histogram_Kalman" Then return new CPP_Basics(functionNames.CPP_Histogram_Kalman_)
...
if algorithmName = "CPP_Motion_Basics" Then return new CPP_Basics(functionNames.CPP_Motion_Basics_)
if algorithmName = "CPP_Plot_Histogram" Then return new CPP_Basics(functionNames.CPP_Plot_Histogram_)
if algorithmName = "CPP_Random_Basics" Then return new CPP_Basics(functionNames.CPP_Random_Basics_)
...
if algorithmName = "CPP_Stable_BasicsCount" Then return new CPP_Basics(functionNames.CPP_Stable_BasicsCount_)
if algorithmName = "CPP_TEE_Basics" Then return new CPP_Basics(functionNames.CPP_TEE_Basics_)
