...
if algorithmName = "Area_MinRect_CPP" Then return new CPP_Basics(cppFunctionNames._Area_MinRect_CPP)
if algorithmName = "BackProject_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._BackProject_Basics_CPP)
if algorithmName = "Bezier_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Bezier_Basics_CPP)
if algorithmName = "BGSubtract_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._BGSubtract_Basics_CPP)
if algorithmName = "Bin4Way_Regions_CPP" Then return new CPP_Basics(cppFunctionNames._Bin4Way_Regions_CPP)
if algorithmName = "Bin4Way_RegionsCombine_CPP" Then return new CPP_Basics(cppFunctionNames._Bin4Way_RegionsCombine_CPP)
if algorithmName = "Binarize_Simple_CPP" Then return new CPP_Basics(cppFunctionNames._Binarize_Simple_CPP)
if algorithmName = "Blur_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Blur_Basics_CPP)
if algorithmName = "Color_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Color_Basics_CPP)
if algorithmName = "Contour_Largest_CPP" Then return new CPP_Basics(cppFunctionNames._Contour_Largest_CPP)
if algorithmName = "Convex_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Convex_Basics_CPP)
if algorithmName = "Delaunay_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Delaunay_Basics_CPP)
if algorithmName = "Delaunay_Generations_CPP" Then return new CPP_Basics(cppFunctionNames._Delaunay_Generations_CPP)
if algorithmName = "Delaunay_GenerationsNoKNN_CPP" Then return new CPP_Basics(cppFunctionNames._Delaunay_GenerationsNoKNN_CPP)
if algorithmName = "Depth_Colorizer_CPP" Then return new CPP_Basics(cppFunctionNames._Depth_Colorizer_CPP)
if algorithmName = "Depth_PointCloud_CPP" Then return new CPP_Basics(cppFunctionNames._Depth_PointCloud_CPP)
...
if algorithmName = "Edge_Scharr_CPP" Then return new CPP_Basics(cppFunctionNames._Edge_Scharr_CPP)
if algorithmName = "Edge_Segments_CPP" Then return new CPP_Basics(cppFunctionNames._Edge_Segments_CPP)
...
if algorithmName = "FeatureLess_Edge_CPP" Then return new CPP_Basics(cppFunctionNames._FeatureLess_Edge_CPP)
if algorithmName = "FeatureLess_History_CPP" Then return new CPP_Basics(cppFunctionNames._FeatureLess_History_CPP)
...
if algorithmName = "Hull_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Hull_Basics_CPP)
if algorithmName = "IMU_GMatrix_CPP" Then return new CPP_Basics(cppFunctionNames._IMU_GMatrix_CPP)
if algorithmName = "IMU_GMatrix_QT_CPP" Then return new CPP_Basics(cppFunctionNames._IMU_GMatrix_QT_CPP)
if algorithmName = "Kalman_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Kalman_Basics_CPP)
if algorithmName = "KNN_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._KNN_Basics_CPP)
if algorithmName = "KNN_Core_CPP" Then return new CPP_Basics(cppFunctionNames._KNN_Core_CPP)
...
if algorithmName = "Motion_Simple_CPP" Then return new CPP_Basics(cppFunctionNames._Motion_Simple_CPP)
if algorithmName = "Palette_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Palette_Basics_CPP)
if algorithmName = "Palette_Random_CPP" Then return new CPP_Basics(cppFunctionNames._Palette_Random_CPP)
if algorithmName = "Plot_Histogram_CPP" Then return new CPP_Basics(cppFunctionNames._Plot_Histogram_CPP)
if algorithmName = "Plot_Histogram2D_CPP" Then return new CPP_Basics(cppFunctionNames._Plot_Histogram2D_CPP)
if algorithmName = "Random_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Random_Basics_CPP)
if algorithmName = "Random_Enumerable_CPP" Then return new CPP_Basics(cppFunctionNames._Random_Enumerable_CPP)
if algorithmName = "Rectangle_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Rectangle_Basics_CPP)
if algorithmName = "Rectangle_Rotated_CPP" Then return new CPP_Basics(cppFunctionNames._Rectangle_Rotated_CPP)
if algorithmName = "RedCloud_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._RedCloud_Basics_CPP)
if algorithmName = "RedCloud_BasicsNative_CPP" Then return new CPP_Basics(cppFunctionNames._RedCloud_BasicsNative_CPP)
if algorithmName = "RedCloud_Flood_CPP" Then return new CPP_Basics(cppFunctionNames._RedCloud_Flood_CPP)
if algorithmName = "RedCloud_Reduce_CPP" Then return new CPP_Basics(cppFunctionNames._RedCloud_Reduce_CPP)
if algorithmName = "RedColor_FeatureLess_CPP" Then return new CPP_Basics(cppFunctionNames._RedColor_FeatureLess_CPP)
if algorithmName = "RedColor_FeatureLessCore_CPP" Then return new CPP_Basics(cppFunctionNames._RedColor_FeatureLessCore_CPP)
if algorithmName = "Remap_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Remap_Basics_CPP)
if algorithmName = "Resize_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Resize_Basics_CPP)
if algorithmName = "Resize_Preserve_CPP" Then return new CPP_Basics(cppFunctionNames._Resize_Preserve_CPP)
if algorithmName = "Stable_Basics_CPP" Then return new CPP_Basics(cppFunctionNames._Stable_Basics_CPP)
if algorithmName = "Stable_BasicsCount_CPP" Then return new CPP_Basics(cppFunctionNames._Stable_BasicsCount_CPP)
	...
	if algorithmName = "Denoise_Unreliable" Then return new Denoise_Unreliable
	...
	if algorithmName = "FeatureLess_Edge_CPP_VB" Then return new FeatureLess_Edge_CPP_VB
	...
	if algorithmName = "Reliable_BGR" Then return new Reliable_BGR
