...
if algorithmName = "Histogram3D_DepthNew" Then return new Histogram3D_DepthNew
if algorithmName = "Histogram3D_DepthSplit" Then return new Histogram3D_DepthSplit
if algorithmName = "Histogram3D_TopXRGBColors" Then return new Histogram3D_TopXRGBColors
if algorithmName = "Histogram3D_UniqueRGBPixels" Then return new Histogram3D_UniqueRGBPixels
