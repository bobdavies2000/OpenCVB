...
if algorithmName = "FeatureMatch_Entropy" Then return new FeatureMatch_Entropy
if algorithmName = "FeatureMatch_Entropy1" Then return new FeatureMatch_Entropy1
if algorithmName = "FeatureMatch_Entropy2" Then return new FeatureMatch_Entropy2
if algorithmName = "FeatureMatch_GridPoints" Then return new FeatureMatch_GridPoints
...
if algorithmName = "FeatureMatch_Validate" Then return new FeatureMatch_Validate
if algorithmName = "FeatureMatch_Validate1" Then return new FeatureMatch_Validate1
if algorithmName = "FeatureMatch_Validate2" Then return new FeatureMatch_Validate2
if algorithmName = "FeatureMatch_Validate3" Then return new FeatureMatch_Validate3
...
if algorithmName = "Gravity_Core" Then return new Gravity_Core
...
if algorithmName = "Histogram_Grayscale" Then return new Histogram_Grayscale
...
if algorithmName = "Quartile_BasicsColors" Then return new Quartile_BasicsColors
if algorithmName = "Quartile_Canny" Then return new Quartile_Canny
if algorithmName = "Quartile_Regions" Then return new Quartile_Regions
if algorithmName = "Quartile_Regions1" Then return new Quartile_Regions1
if algorithmName = "Quartile_RegionsLeftRight" Then return new Quartile_RegionsLeftRight
if algorithmName = "Quartile_Sobel" Then return new Quartile_Sobel
if algorithmName = "Quartile_SplitGaps" Then return new Quartile_SplitGaps
if algorithmName = "Quartile_SplitMean" Then return new Quartile_SplitMean
if algorithmName = "Quartile_SplitMean1" Then return new Quartile_SplitMean1
if algorithmName = "Quartile_SplitMean2" Then return new Quartile_SplitMean2
if algorithmName = "Quartile_SplitValley" Then return new Quartile_SplitValley
if algorithmName = "Quartile_Unstable" Then return new Quartile_Unstable
if algorithmName = "Quartile_Unstable1" Then return new Quartile_Unstable1
if algorithmName = "Quartile_UnstableEdges" Then return new Quartile_UnstableEdges
if algorithmName = "Quartile_UnstablePixels" Then return new Quartile_UnstablePixels
if algorithmName = "Quartile_UnstablePixels1" Then return new Quartile_UnstablePixels1
