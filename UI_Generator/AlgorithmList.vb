...
if algorithmName = "Neighbor_Core" Then return new Neighbor_Core
if algorithmName = "Neighbor_CoreTest" Then return new Neighbor_CoreTest
if algorithmName = "Neighbor_Intersects" Then return new Neighbor_Intersects
if algorithmName = "Neighbor_IntersectsImageEdge" Then return new Neighbor_IntersectsImageEdge
if algorithmName = "Neighbor_Precise" Then return new Neighbor_Precise
