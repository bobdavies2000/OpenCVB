...
if algorithmName = "CameraMotion_FeatureTracker" Then return new CameraMotion_FeatureTracker
if algorithmName = "CameraMotion_SceneMotion1" Then return new CameraMotion_SceneMotion1
...
if algorithmName = "Cell_BasicsNew" Then return new Cell_BasicsNew
...
if algorithmName = "Histogram_DepthNew" Then return new Histogram_DepthNew
...
if algorithmName = "RedCloud_TightNew" Then return new RedCloud_TightNew
