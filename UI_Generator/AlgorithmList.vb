...
if algorithmName = "AddWeighted_Basics_CC" Then return new CPP_Basics(cppFunctionNames._AddWeighted_Basics_CC)
if algorithmName = "AddWeighted_DepthAccumulate_CC" Then return new CPP_Basics(cppFunctionNames._AddWeighted_DepthAccumulate_CC)
if algorithmName = "ApproxPoly_Basics_CC" Then return new CPP_Basics(cppFunctionNames._ApproxPoly_Basics_CC)
if algorithmName = "ApproxPoly_FindandDraw_CC" Then return new CPP_Basics(cppFunctionNames._ApproxPoly_FindandDraw_CC)
if algorithmName = "ApproxPoly_Hull_CC" Then return new CPP_Basics(cppFunctionNames._ApproxPoly_Hull_CC)
if algorithmName = "Area_MinRect_CC" Then return new CPP_Basics(cppFunctionNames._Area_MinRect_CC)
if algorithmName = "BackProject_Basics_CC" Then return new CPP_Basics(cppFunctionNames._BackProject_Basics_CC)
if algorithmName = "Bezier_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Bezier_Basics_CC)
if algorithmName = "BGSubtract_Basics_CC" Then return new CPP_Basics(cppFunctionNames._BGSubtract_Basics_CC)
if algorithmName = "Bin4Way_Regions_CC" Then return new CPP_Basics(cppFunctionNames._Bin4Way_Regions_CC)
if algorithmName = "Bin4Way_RegionsCombine_CC" Then return new CPP_Basics(cppFunctionNames._Bin4Way_RegionsCombine_CC)
if algorithmName = "Binarize_Simple_CC" Then return new CPP_Basics(cppFunctionNames._Binarize_Simple_CC)
if algorithmName = "Blur_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Blur_Basics_CC)
if algorithmName = "Color_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Color_Basics_CC)
if algorithmName = "Contour_Largest_CC" Then return new CPP_Basics(cppFunctionNames._Contour_Largest_CC)
if algorithmName = "Convex_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Convex_Basics_CC)
if algorithmName = "Delaunay_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Delaunay_Basics_CC)
if algorithmName = "Delaunay_Generations_CC" Then return new CPP_Basics(cppFunctionNames._Delaunay_Generations_CC)
if algorithmName = "Delaunay_GenerationsNoKNN_CC" Then return new CPP_Basics(cppFunctionNames._Delaunay_GenerationsNoKNN_CC)
if algorithmName = "Depth_Colorizer_CC" Then return new CPP_Basics(cppFunctionNames._Depth_Colorizer_CC)
if algorithmName = "Depth_PointCloud_CC" Then return new CPP_Basics(cppFunctionNames._Depth_PointCloud_CC)
if algorithmName = "Depth_PointCloud_IMU_CC" Then return new CPP_Basics(cppFunctionNames._Depth_PointCloud_IMU_CC)
if algorithmName = "Diff_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Diff_Basics_CC)
if algorithmName = "Distance_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Distance_Basics_CC)
if algorithmName = "Edge_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Edge_Basics_CC)
if algorithmName = "Edge_Canny_CC" Then return new CPP_Basics(cppFunctionNames._Edge_Canny_CC)
if algorithmName = "Edge_MotionFrames_CC" Then return new CPP_Basics(cppFunctionNames._Edge_MotionFrames_CC)
if algorithmName = "Edge_Preserving_CC" Then return new CPP_Basics(cppFunctionNames._Edge_Preserving_CC)
if algorithmName = "Edge_Scharr_CC" Then return new CPP_Basics(cppFunctionNames._Edge_Scharr_CC)
if algorithmName = "Edge_Segments_CC" Then return new CPP_Basics(cppFunctionNames._Edge_Segments_CC)
if algorithmName = "Edge_Sobel_CC" Then return new CPP_Basics(cppFunctionNames._Edge_Sobel_CC)
if algorithmName = "EdgeDraw_Basics_CC" Then return new CPP_Basics(cppFunctionNames._EdgeDraw_Basics_CC)
if algorithmName = "Feature_Agast_CC" Then return new CPP_Basics(cppFunctionNames._Feature_Agast_CC)
if algorithmName = "Feature_AKaze_CC" Then return new CPP_Basics(cppFunctionNames._Feature_AKaze_CC)
if algorithmName = "Feature_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Feature_Basics_CC)
if algorithmName = "Feature_StableSorted_CC" Then return new CPP_Basics(cppFunctionNames._Feature_StableSorted_CC)
if algorithmName = "FeatureLess_Basics_CC" Then return new CPP_Basics(cppFunctionNames._FeatureLess_Basics_CC)
if algorithmName = "FeatureLess_Edge_CC" Then return new CPP_Basics(cppFunctionNames._FeatureLess_Edge_CC)
if algorithmName = "FeatureLess_History_CC" Then return new CPP_Basics(cppFunctionNames._FeatureLess_History_CC)
if algorithmName = "FPoly_TopFeatures_CC" Then return new CPP_Basics(cppFunctionNames._FPoly_TopFeatures_CC)
if algorithmName = "Grid_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Grid_Basics_CC)
if algorithmName = "Hist_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Hist_Basics_CC)
if algorithmName = "Hist_DepthSimple_CC" Then return new CPP_Basics(cppFunctionNames._Hist_DepthSimple_CC)
if algorithmName = "Hist_Kalman_CC" Then return new CPP_Basics(cppFunctionNames._Hist_Kalman_CC)
if algorithmName = "Hist_RedOptions_CC" Then return new CPP_Basics(cppFunctionNames._Hist_RedOptions_CC)
if algorithmName = "History_Basics_CC" Then return new CPP_Basics(cppFunctionNames._History_Basics_CC)
if algorithmName = "Hull_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Hull_Basics_CC)
if algorithmName = "IMU_GMatrix_CC" Then return new CPP_Basics(cppFunctionNames._IMU_GMatrix_CC)
if algorithmName = "IMU_GMatrix_QT_CC" Then return new CPP_Basics(cppFunctionNames._IMU_GMatrix_QT_CC)
if algorithmName = "Kalman_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Kalman_Basics_CC)
if algorithmName = "KNN_Basics_CC" Then return new CPP_Basics(cppFunctionNames._KNN_Basics_CC)
if algorithmName = "KNN_Core_CC" Then return new CPP_Basics(cppFunctionNames._KNN_Core_CC)
if algorithmName = "Line_BasicsOld_CC" Then return new CPP_Basics(cppFunctionNames._Line_BasicsOld_CC)
if algorithmName = "Mat_4Click_CC" Then return new CPP_Basics(cppFunctionNames._Mat_4Click_CC)
if algorithmName = "Mat_4to1_CC" Then return new CPP_Basics(cppFunctionNames._Mat_4to1_CC)
if algorithmName = "Mesh_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Mesh_Basics_CC)
if algorithmName = "Mesh_Features_CC" Then return new CPP_Basics(cppFunctionNames._Mesh_Features_CC)
if algorithmName = "Motion_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Motion_Basics_CC)
if algorithmName = "Motion_Simple_CC" Then return new CPP_Basics(cppFunctionNames._Motion_Simple_CC)
if algorithmName = "Palette_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Palette_Basics_CC)
if algorithmName = "Palette_Random_CC" Then return new CPP_Basics(cppFunctionNames._Palette_Random_CC)
if algorithmName = "Plot_Histogram_CC" Then return new CPP_Basics(cppFunctionNames._Plot_Histogram_CC)
if algorithmName = "Plot_Histogram2D_CC" Then return new CPP_Basics(cppFunctionNames._Plot_Histogram2D_CC)
if algorithmName = "Random_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Random_Basics_CC)
if algorithmName = "Random_Enumerable_CC" Then return new CPP_Basics(cppFunctionNames._Random_Enumerable_CC)
if algorithmName = "Rectangle_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Rectangle_Basics_CC)
if algorithmName = "Rectangle_Rotated_CC" Then return new CPP_Basics(cppFunctionNames._Rectangle_Rotated_CC)
if algorithmName = "RedCloud_Basics_CC" Then return new CPP_Basics(cppFunctionNames._RedCloud_Basics_CC)
if algorithmName = "RedCloud_BasicsNative_CC" Then return new CPP_Basics(cppFunctionNames._RedCloud_BasicsNative_CC)
if algorithmName = "RedCloud_Flood_CC" Then return new CPP_Basics(cppFunctionNames._RedCloud_Flood_CC)
if algorithmName = "RedCloud_Reduce_CC" Then return new CPP_Basics(cppFunctionNames._RedCloud_Reduce_CC)
if algorithmName = "RedColor_FeatureLess_CC" Then return new CPP_Basics(cppFunctionNames._RedColor_FeatureLess_CC)
if algorithmName = "RedColor_FeatureLessCore_CC" Then return new CPP_Basics(cppFunctionNames._RedColor_FeatureLessCore_CC)
if algorithmName = "Remap_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Remap_Basics_CC)
if algorithmName = "Resize_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Resize_Basics_CC)
if algorithmName = "Resize_Preserve_CC" Then return new CPP_Basics(cppFunctionNames._Resize_Preserve_CC)
if algorithmName = "Stable_Basics_CC" Then return new CPP_Basics(cppFunctionNames._Stable_Basics_CC)
if algorithmName = "Stable_BasicsCount_CC" Then return new CPP_Basics(cppFunctionNames._Stable_BasicsCount_CC)
