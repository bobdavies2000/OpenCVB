...
if algorithmName = "Aruco_Basics" Then return new Aruco_Basics
if algorithmName = "Aruco_Test" Then return new Aruco_Test
...
if algorithmName = "Binarize_KmeansRedColor" Then return new Binarize_KmeansRedColor
...
if algorithmName = "Blur_Bitmap" Then return new Blur_Bitmap
...
if algorithmName = "CellAuto_All256" Then return new CellAuto_All256
if algorithmName = "CellAuto_Basics" Then return new CellAuto_Basics
if algorithmName = "CellAuto_Basics_MT" Then return new CellAuto_Basics_MT
if algorithmName = "CellAuto_Life" Then return new CellAuto_Life
if algorithmName = "CellAuto_LifeColor" Then return new CellAuto_LifeColor
if algorithmName = "CellAuto_LifePopulation" Then return new CellAuto_LifePopulation
if algorithmName = "CellAuto_MultiPoint" Then return new CellAuto_MultiPoint
if algorithmName = "Classify_Basics" Then return new Classify_Basics
if algorithmName = "Classify_BipolarSigmoid_CS" Then return new Classify_BipolarSigmoid_CS
if algorithmName = "Classify_DecisionTree_CS" Then return new Classify_DecisionTree_CS
if algorithmName = "Classify_KernelMethod_CS" Then return new Classify_KernelMethod_CS
if algorithmName = "Classify_LogisticRegression_CS" Then return new Classify_LogisticRegression_CS
if algorithmName = "Classify_MultiClass_CS" Then return new Classify_MultiClass_CS
if algorithmName = "Classify_MultiLabel_CS" Then return new Classify_MultiLabel_CS
if algorithmName = "Classify_NaiveBayes" Then return new Classify_NaiveBayes
if algorithmName = "Classify_NaiveBayes_CS" Then return new Classify_NaiveBayes_CS
if algorithmName = "Classify_SVMLinear" Then return new Classify_SVMLinear
if algorithmName = "Classify_SVMLinear_CS" Then return new Classify_SVMLinear_CS
if algorithmName = "Classify_Test1" Then return new Classify_Test1
if algorithmName = "Classify_Test2" Then return new Classify_Test2
if algorithmName = "Classify_Test3" Then return new Classify_Test3
if algorithmName = "Classify_Test4" Then return new Classify_Test4
if algorithmName = "Classify_YinYangData" Then return new Classify_YinYangData
...
if algorithmName = "CPP_AddWeighted_Basics" Then return new CPP_Basics(functionNames.AddWeighted_Basics)
if algorithmName = "CPP_ApproxPoly_Basics" Then return new CPP_Basics(functionNames.ApproxPoly_Basics)
if algorithmName = "CPP_ApproxPoly_FindandDraw" Then return new CPP_Basics(functionNames.ApproxPoly_FindandDraw)
if algorithmName = "CPP_ApproxPoly_Hull" Then return new CPP_Basics(functionNames.ApproxPoly_Hull)
if algorithmName = "CPP_BackProject_Basics" Then return new CPP_Basics(functionNames.BackProject_Basics)
if algorithmName = "CPP_Binarize_Simple" Then return new CPP_Basics(functionNames.Binarize_Simple)
if algorithmName = "CPP_Contour_Largest" Then return new CPP_Basics(functionNames.Contour_Largest)
if algorithmName = "CPP_Delaunay_Basics" Then return new CPP_Basics(functionNames.Delaunay_Basics)
if algorithmName = "CPP_Delaunay_Generations" Then return new CPP_Basics(functionNames.Delaunay_Generations)
if algorithmName = "CPP_Delaunay_GenerationsNoKNN" Then return new CPP_Basics(functionNames.Delaunay_GenerationsNoKNN)
if algorithmName = "CPP_Depth_Colorizer" Then return new CPP_Basics(functionNames.Depth_Colorizer)
if algorithmName = "CPP_Depth_PointCloud" Then return new CPP_Basics(functionNames.Depth_PointCloud)
if algorithmName = "CPP_Depth_PointCloud_IMU" Then return new CPP_Basics(functionNames.Depth_PointCloud_IMU)
if algorithmName = "CPP_Diff_Basics" Then return new CPP_Basics(functionNames.Diff_Basics)
if algorithmName = "CPP_Distance_Basics" Then return new CPP_Basics(functionNames.Distance_Basics)
if algorithmName = "CPP_Edge_Canny" Then return new CPP_Basics(functionNames.Edge_Canny)
if algorithmName = "CPP_Edge_MotionAccum" Then return new CPP_Basics(functionNames.Edge_MotionAccum)
if algorithmName = "CPP_Edge_MotionFrames" Then return new CPP_Basics(functionNames.Edge_MotionFrames)
if algorithmName = "CPP_Edge_Scharr" Then return new CPP_Basics(functionNames.Edge_Scharr)
if algorithmName = "CPP_Edge_Segments" Then return new CPP_Basics(functionNames.Edge_Segments)
if algorithmName = "CPP_Edge_Sobel" Then return new CPP_Basics(functionNames.Edge_Sobel)
if algorithmName = "CPP_EdgeDraw_Basics" Then return new CPP_Basics(functionNames.EdgeDraw_Basics)
if algorithmName = "CPP_EdgePreserving_Basics" Then return new CPP_Basics(functionNames.EdgePreserving_Basics)
if algorithmName = "CPP_Feature_Agast" Then return new CPP_Basics(functionNames.Feature_Agast)
if algorithmName = "CPP_Feature_Basics" Then return new CPP_Basics(functionNames.Feature_Basics)
if algorithmName = "CPP_FeatureLess_Basics" Then return new CPP_Basics(functionNames.FeatureLess_Basics)
if algorithmName = "CPP_FeatureLess_Edge" Then return new CPP_Basics(functionNames.FeatureLess_Edge)
if algorithmName = "CPP_FPoly_TopFeatures" Then return new CPP_Basics(functionNames.FPoly_TopFeatures)
if algorithmName = "CPP_Grid_Basics" Then return new CPP_Basics(functionNames.Grid_Basics)
if algorithmName = "CPP_Histogram_Basics" Then return new CPP_Basics(functionNames.Histogram_Basics)
if algorithmName = "CPP_Hull_Basics" Then return new CPP_Basics(functionNames.Hull_Basics)
if algorithmName = "CPP_IMU_GMatrix" Then return new CPP_Basics(functionNames.IMU_GMatrix)
if algorithmName = "CPP_IMU_GMatrix_QT" Then return new CPP_Basics(functionNames.IMU_GMatrix_QT)
if algorithmName = "CPP_KNN_Basics" Then return new CPP_Basics(functionNames.KNN_Basics)
if algorithmName = "CPP_KNN_Lossy" Then return new CPP_Basics(functionNames.KNN_Lossy)
if algorithmName = "CPP_Mat_4to1" Then return new CPP_Basics(functionNames.Mat_4to1)
if algorithmName = "CPP_Motion_Basics" Then return new CPP_Basics(functionNames.Motion_Basics)
if algorithmName = "CPP_Plot_Histogram" Then return new CPP_Basics(functionNames.Plot_Histogram)
if algorithmName = "CPP_Random_Basics" Then return new CPP_Basics(functionNames.Random_Basics)
if algorithmName = "CPP_Rectangle_Basics" Then return new CPP_Basics(functionNames.Rectangle_Basics)
if algorithmName = "CPP_Rectangle_Rotated" Then return new CPP_Basics(functionNames.Rectangle_Rotated)
if algorithmName = "CPP_RedCloud_FeatureLess2" Then return new CPP_Basics(functionNames.RedCloud_FeatureLess2)
if algorithmName = "CPP_RedCloud_Flood" Then return new CPP_Basics(functionNames.RedCloud_Flood)
if algorithmName = "CPP_RedCloud_Hulls" Then return new CPP_Basics(functionNames.RedCloud_Hulls)
if algorithmName = "CPP_RedCloud_PrepData" Then return new CPP_Basics(functionNames.RedCloud_PrepData)
if algorithmName = "CPP_Remap_Basics" Then return new CPP_Basics(functionNames.Remap_Basics)
if algorithmName = "CPP_Resize_Basics" Then return new CPP_Basics(functionNames.Resize_Basics)
if algorithmName = "CPP_Stable_Basics" Then return new CPP_Basics(functionNames.Stable_Basics)
if algorithmName = "CPP_Stable_BasicsCount" Then return new CPP_Basics(functionNames.Stable_BasicsCount)
if algorithmName = "CPP_TEE_Basics" Then return new CPP_Basics(functionNames.TEE_Basics)
if algorithmName = "Crypto_Hash" Then return new Crypto_Hash
if algorithmName = "CSV_Basics" Then return new CSV_Basics
if algorithmName = "CSV_Excel" Then return new CSV_Excel
...
if algorithmName = "Dlib_FaceDetectHOG_CS" Then return new Dlib_FaceDetectHOG_CS
if algorithmName = "Dlib_GaussianBlur_CS" Then return new Dlib_GaussianBlur_CS
if algorithmName = "Dlib_iBug300WDownload" Then return new Dlib_iBug300WDownload
if algorithmName = "Dlib_Sobel_CS" Then return new Dlib_Sobel_CS
...
if algorithmName = "Edge_Depth" Then return new Edge_Depth
if algorithmName = "Edge_DepthAndColor" Then return new Edge_DepthAndColor
if algorithmName = "Edge_DepthDilated" Then return new Edge_DepthDilated
...
if algorithmName = "FeatureLess_Rects" Then return new FeatureLess_Rects
...
if algorithmName = "Filter_AccordSuite" Then return new Filter_AccordSuite
...
if algorithmName = "Flood_DepthAdd" Then return new Flood_DepthAdd
if algorithmName = "Flood_FLessAndColor" Then return new Flood_FLessAndColor
if algorithmName = "Flood_Hulls_CPP" Then return new Flood_Hulls_CPP
if algorithmName = "Flood_LastXImages" Then return new Flood_LastXImages
if algorithmName = "Flood_Left" Then return new Flood_Left
if algorithmName = "Flood_MotionRect" Then return new Flood_MotionRect
if algorithmName = "Flood_Objects" Then return new Flood_Objects
if algorithmName = "Flood_Palette" Then return new Flood_Palette
if algorithmName = "Flood_Point" Then return new Flood_Point
if algorithmName = "Flood_PointList" Then return new Flood_PointList
if algorithmName = "Flood_RedColor" Then return new Flood_RedColor
if algorithmName = "Flood_Right" Then return new Flood_Right
...
if algorithmName = "Fourier_MathNet" Then return new Fourier_MathNet
...
if algorithmName = "GuidedBP_BuildCells" Then return new GuidedBP_BuildCells
if algorithmName = "GuidedBP_CellHistograms" Then return new GuidedBP_CellHistograms
if algorithmName = "GuidedBP_CellRanges" Then return new GuidedBP_CellRanges
if algorithmName = "GuidedBP_Cells" Then return new GuidedBP_Cells
if algorithmName = "GuidedBP_Delaunay" Then return new GuidedBP_Delaunay
if algorithmName = "GuidedBP_DelaunayStats" Then return new GuidedBP_DelaunayStats
if algorithmName = "GuidedBP_Depth" Then return new GuidedBP_Depth
if algorithmName = "GuidedBP_DepthOriginal" Then return new GuidedBP_DepthOriginal
if algorithmName = "GuidedBP_Duplicates" Then return new GuidedBP_Duplicates
if algorithmName = "GuidedBP_FloodCells" Then return new GuidedBP_FloodCells
...
if algorithmName = "GuidedBP_HotPointsMap" Then return new GuidedBP_HotPointsMap
if algorithmName = "GuidedBP_Hulls" Then return new GuidedBP_Hulls
if algorithmName = "GuidedBP_kCellStats" Then return new GuidedBP_kCellStats
...
if algorithmName = "GuidedBP_Map" Then return new GuidedBP_Map
...
if algorithmName = "GuidedBP_RedColor" Then return new GuidedBP_RedColor
if algorithmName = "GuidedBP_RedColorCloud" Then return new GuidedBP_RedColorCloud
...
if algorithmName = "Histogram_GotchFixed_CPP" Then return new Histogram_GotchFixed_CPP
...
if algorithmName = "Histogram2D_DepthOld" Then return new Histogram2D_DepthOld
if algorithmName = "Histogram2D_HSV" Then return new Histogram2D_HSV
if algorithmName = "Histogram2D_PointCloud" Then return new Histogram2D_PointCloud
...
if algorithmName = "Histogram3D_Basics" Then return new Histogram3D_Basics
if algorithmName = "Histogram3D_BP" Then return new Histogram3D_BP
if algorithmName = "Histogram3D_Depth" Then return new Histogram3D_Depth
if algorithmName = "Histogram3D_Depth1Slider" Then return new Histogram3D_Depth1Slider
if algorithmName = "Histogram3D_Depth3Slider" Then return new Histogram3D_Depth3Slider
if algorithmName = "Histogram3D_DepthSplit" Then return new Histogram3D_DepthSplit
if algorithmName = "Histogram3D_TopXColors" Then return new Histogram3D_TopXColors
if algorithmName = "Histogram3D_UniquePixels" Then return new Histogram3D_UniquePixels
if algorithmName = "Histogram3D_VB" Then return new Histogram3D_VB
...
if algorithmName = "HistValley_LeftRight" Then return new HistValley_LeftRight
if algorithmName = "HistValley_Lines" Then return new HistValley_Lines
...
if algorithmName = "Hough_Bitmap" Then return new Hough_Bitmap
...
if algorithmName = "KMeans_Accord" Then return new KMeans_Accord
if algorithmName = "KMeans_AccordYinYang" Then return new KMeans_AccordYinYang
if algorithmName = "KMeans_Basics" Then return new KMeans_Basics
if algorithmName = "KMeans_BasicsFast" Then return new KMeans_BasicsFast
...
if algorithmName = "KMeans_Direct" Then return new KMeans_Direct
if algorithmName = "KMeans_FloodFill" Then return new KMeans_FloodFill
...
if algorithmName = "KMeans_PlaneClusters" Then return new KMeans_PlaneClusters
...
if algorithmName = "LeftRight_FloodFill" Then return new LeftRight_FloodFill
...
if algorithmName = "LUT_FloodFill" Then return new LUT_FloodFill
...
if algorithmName = "Mat_2Dlib" Then return new Mat_2Dlib
...
if algorithmName = "Mat_Dlib2Mat" Then return new Mat_Dlib2Mat
...
if algorithmName = "MatchCell_Basics" Then return new MatchCell_Basics
if algorithmName = "MatchCell_PrepareData" Then return new MatchCell_PrepareData
if algorithmName = "MatchCell_Shape" Then return new MatchCell_Shape
...
if algorithmName = "MSER_Contours" Then return new MSER_Contours
if algorithmName = "MSER_Core" Then return new MSER_Core
if algorithmName = "MSER_CPPStyle" Then return new MSER_CPPStyle
...
if algorithmName = "MSER_ROInew" Then return new MSER_ROInew
...
if algorithmName = "OpenGL_RedCloudStable" Then return new OpenGL_RedCloudStable
...
if algorithmName = "Options_Histogram2D" Then return new Options_Histogram2D
...
if algorithmName = "Options_MSEROld" Then return new Options_MSEROld
...
if algorithmName = "PCA_Plane" Then return new PCA_Plane
...
if algorithmName = "Projection_FeatureLess" Then return new Projection_FeatureLess
...
if algorithmName = "Random_60sTV" Then return new Random_60sTV
if algorithmName = "Random_60sTVFaster" Then return new Random_60sTVFaster
if algorithmName = "Random_60sTVFastSimple" Then return new Random_60sTVFastSimple
...
if algorithmName = "RedCloud_BothColorAndCloud" Then return new RedCloud_BothColorAndCloud
...
if algorithmName = "RedCloud_ColorOnly" Then return new RedCloud_ColorOnly
if algorithmName = "RedCloud_CombineColor" Then return new RedCloud_CombineColor
if algorithmName = "RedCloud_Corners_CPP" Then return new RedCloud_Corners_CPP
if algorithmName = "RedCloud_CPP" Then return new RedCloud_CPP
if algorithmName = "RedCloud_DepthOnly" Then return new RedCloud_DepthOnly
...
if algorithmName = "RedCloud_MotionTest" Then return new RedCloud_MotionTest
if algorithmName = "RedCloud_NeighborRect" Then return new RedCloud_NeighborRect
if algorithmName = "RedCloud_Neighbors_CPP" Then return new RedCloud_Neighbors_CPP
...
if algorithmName = "RedCloud_ViewLeft" Then return new RedCloud_ViewLeft
if algorithmName = "RedCloud_ViewRight" Then return new RedCloud_ViewRight
if algorithmName = "RedCloudY_CellsAtDepth" Then return new RedCloudY_CellsAtDepth
if algorithmName = "RedCloudY_Color" Then return new RedCloudY_Color
if algorithmName = "RedCloudY_DepthMinMax" Then return new RedCloudY_DepthMinMax
if algorithmName = "RedCloudY_DistancePoint" Then return new RedCloudY_DistancePoint
...
if algorithmName = "RedCloudY_NeighborsOld" Then return new RedCloudY_NeighborsOld
if algorithmName = "RedCloudY_PlaneFromContour" Then return new RedCloudY_PlaneFromContour
if algorithmName = "RedCloudY_PlaneFromMask" Then return new RedCloudY_PlaneFromMask
if algorithmName = "RedCloudY_PointTracker" Then return new RedCloudY_PointTracker
if algorithmName = "RedCloudY_ShapeCorrelation" Then return new RedCloudY_ShapeCorrelation
if algorithmName = "RedCloudY_SliceH" Then return new RedCloudY_SliceH
if algorithmName = "RedCloudY_SliceV" Then return new RedCloudY_SliceV
if algorithmName = "RedCloudY_StructuredH" Then return new RedCloudY_StructuredH
...
if algorithmName = "Reduction_Depth" Then return new Reduction_Depth
...
if algorithmName = "Reduction_RGB" Then return new Reduction_RGB
if algorithmName = "Reduction_XYZ" Then return new Reduction_XYZ
if algorithmName = "ReductionCloud_Basics" Then return new ReductionCloud_Basics
if algorithmName = "ReductionCloud_Binarize" Then return new ReductionCloud_Binarize
if algorithmName = "ReductionCloud_BProject3D" Then return new ReductionCloud_BProject3D
if algorithmName = "ReductionCloud_ByDepth" Then return new ReductionCloud_ByDepth
if algorithmName = "ReductionCloud_ByIndex" Then return new ReductionCloud_ByIndex
if algorithmName = "ReductionCloud_CComp" Then return new ReductionCloud_CComp
if algorithmName = "ReductionCloud_CCompBinarized" Then return new ReductionCloud_CCompBinarized
if algorithmName = "ReductionCloud_CellStats" Then return new ReductionCloud_CellStats
if algorithmName = "ReductionCloud_ContourCorners" Then return new ReductionCloud_ContourCorners
if algorithmName = "ReductionCloud_Core" Then return new ReductionCloud_Core
if algorithmName = "ReductionCloud_Diff" Then return new ReductionCloud_Diff
if algorithmName = "ReductionCloud_Features" Then return new ReductionCloud_Features
if algorithmName = "ReductionCloud_HistValley" Then return new ReductionCloud_HistValley
if algorithmName = "ReductionCloud_Hulls" Then return new ReductionCloud_Hulls
if algorithmName = "ReductionCloud_KMeans" Then return new ReductionCloud_KMeans
if algorithmName = "ReductionCloud_KNNCenters" Then return new ReductionCloud_KNNCenters
if algorithmName = "ReductionCloud_LineID" Then return new ReductionCloud_LineID
if algorithmName = "ReductionCloud_Match" Then return new ReductionCloud_Match
if algorithmName = "ReductionCloud_NoDepth" Then return new ReductionCloud_NoDepth
if algorithmName = "ReductionCloud_Plane3D" Then return new ReductionCloud_Plane3D
if algorithmName = "ReductionCloud_ProjectCell" Then return new ReductionCloud_ProjectCell
if algorithmName = "ReductionCloud_Track5D" Then return new ReductionCloud_Track5D
if algorithmName = "ReductionCloud_Track8D" Then return new ReductionCloud_Track8D
if algorithmName = "ReductionCloud_UnstableCells" Then return new ReductionCloud_UnstableCells
if algorithmName = "ReductionCloud_UnstableCells1" Then return new ReductionCloud_UnstableCells1
...
if algorithmName = "ShapeDetect_Basics" Then return new ShapeDetect_Basics
if algorithmName = "ShapeDetect_Example" Then return new ShapeDetect_Example
if algorithmName = "ShapeDetect_Example2" Then return new ShapeDetect_Example2
...
if algorithmName = "SOM_Basics" Then return new SOM_Basics
...
if algorithmName = "Sort_Blur" Then return new Sort_Blur
if algorithmName = "Sort_FeatureLess" Then return new Sort_FeatureLess
if algorithmName = "Sort_Inrange" Then return new Sort_Inrange
...
if algorithmName = "Sort_Reduction" Then return new Sort_Reduction
...
if algorithmName = "Trace_OpenCV_CPP" Then return new Trace_OpenCV_CPP
...
if algorithmName = "Wavelet_Basics" Then return new Wavelet_Basics
if algorithmName = "Wavelet_Edges" Then return new Wavelet_Edges
