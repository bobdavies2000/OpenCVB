...
if algorithmName = "Flood_Neighbors" Then return new Flood_Neighbors
...
if algorithmName = "RedCloud_GenCellsNew1" Then return new RedCloud_GenCellsNew1
if algorithmName = "RedCloud_GenCellsNew2" Then return new RedCloud_GenCellsNew2
