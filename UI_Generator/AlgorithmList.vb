...
if algorithmName = "Foreground_RedMinNew" Then return new Foreground_RedMinNew
...
if algorithmName = "Hist3D_DepthFore" Then return new Hist3D_DepthFore
if algorithmName = "Hist3D_DepthMask" Then return new Hist3D_DepthMask
