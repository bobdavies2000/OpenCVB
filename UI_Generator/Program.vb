...
Module Program
    Sub Main(args As String())
        Dim cvbPrefix As String = "VB"
        Dim parentName = "TaskParent"
        If args.Length > 0 Then
            cvbPrefix = "CVB"
            parentName = "TaskCVBParent"
        End If
        ...
        Using mutex As New Mutex(True, mutexName, createdNew)
            ...
            Dim vbClassesPath As String = Path.GetFullPath(Path.Combine(appPath, "..\..\..\..\..\" + cvbPrefix + "Classes"))
            ...
            For Each vbFile As String In vbFiles
                ...
                For Each line As String In lines
                    ...
                    If line.Contains(": Inherits " + parentName) Then
            ...
            sb.AppendLine("Imports " + cvbPrefix + "Classes")

            sb.AppendLine("Public Class algorithmList")

            sb.AppendLine(vbTab + "Public Function createAlgorithm(algorithmName as string) As " + parentName)
            ...
            Dim mainPathCVB As String = Path.GetFullPath(Path.Combine(appPath, "..\..\..\..\..\CVB"))
            Dim algorithmListCVB As String = Path.Combine(mainPathCVB, "AlgorithmList.vb")

            If cvbPrefix = "CVB" Then
                File.WriteAllText(algorithmListCVB, sb.ToString())
            Else
            ...
            Console.WriteLine()
            Console.WriteLine()
            Console.WriteLine($"Found {vbClasses.Count} classes that inherit from " + parentName + ":")
            Console.WriteLine($"Found {xoClasses.Count} XO_ classes that inherit from " + parentName + ":")
