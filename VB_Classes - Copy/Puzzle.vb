...
Public Class Puzzle_Solver : Inherits TaskParent
    ...
    Public Sub RunAlg(src As cvb.Mat)
        ...
        If task.optionsChanged Or options.startPuzzle Then
            ...
            dst2 = puzzle.dst2
            dst3.SetTo(0)
            grayMat = puzzle.image.CvtColor(cvb.ColorConversionCodes.BGR2GRAY)
            puzzleIndex = 0
        End If
        ...
        If puzzle.scrambled.Count > puzzle.unscrambled.Count Then
            ...
            match.Run(grayMat)
            Dim bestRect = ValidateRect(New cvb.Rect(match.matchCenter.X, match.matchCenter.Y, rect.Width, rect.Height))
