...
def goodFeaturesToTrack_Demo(val):
    ...
    for i in range(corners.shape[0]):
        rand1 = (rng.randint(0,256), rng.randint(0,256), rng.randint(0,256))
        cv.circle(copy, (corners[i,0,0], corners[i,0,1]), radius, rand1, cv.FILLED)
...
parser.add_argument('--input', help='Path to input image.', default='../opencv/Samples/Data/pic3.png')
